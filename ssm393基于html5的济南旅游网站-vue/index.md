...
# [ssm393基于html5的济南旅游网站+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm393/blog.001.png)
...
![](/images/0300ssm/ssm393/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0300ssm/ssm393/blog.006.png)
...
![](/images/0300ssm/ssm393/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是用户实体E-R图

![](/images/0300ssm/ssm393/blog.008.png)

图4.8 用户实体E-R图

（3）下图就是旅游资讯信息实体E-R图

![](/images/0300ssm/ssm393/blog.009.png)
...
![](/images/0300ssm/ssm393/blog.011.png)

图5.1 用户信息管理页面
## 5.2 旅游资讯管理
管理员可以对旅游资讯信息进行删除，查询和修改操作。下图就是旅游资讯管理页面。

![](/images/0300ssm/ssm393/blog.012.png)

图5.2旅游资讯信息管理页面
## 5.3 景区介绍管理
管理员可以对景区介绍进行添加，查询，修改，删除操作。下图就是景区介绍管理页面。

![](/images/0300ssm/ssm393/blog.013.png)
...
![](/images/0300ssm/ssm393/blog.014.png)
