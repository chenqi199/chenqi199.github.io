...
# [ssm295基于html5的演唱会购票系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm295/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm295/blog.002.png)
...
![](/images/0200ssm/ssm295/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm295/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm295/blog.005.png)
...
![](/images/0200ssm/ssm295/blog.006.png)

图4.12  管理员信息实体属性图

（2）演唱会实体属性图如图4.13所示：

![](/images/0200ssm/ssm295/blog.007.png)

图4.13  演唱会实体属性图

（3）分类实体属性图如图4.14所示：

![](/images/0200ssm/ssm295/blog.008.png)
...
![](/images/0200ssm/ssm295/blog.010.png)

图5.1 演唱会信息管理界面
### 5.1.2 订单信息管理
系统管理员可以对订单信息查询，删除操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm295/blog.011.png)

图5.3 订单信息界面
### 5.1.3 用户信息管理
系统管理员可以对用户信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm295/blog.012.png)
...
![](/images/0200ssm/ssm295/blog.013.png)

图5.5 演唱会信息界面
### 5.2.2 演唱会预定
用户登录后，首页点击演唱会，可以查看演唱会信息并且可以购买操作。界面如下图所示：

![](/images/0200ssm/ssm295/blog.014.png)

图5.6 演唱会预定界面
### 5.2.3 下单支付
用户登录后预定演唱会可以选择确认下单，然后点击支付进行下一步操作。界面如下图所示：

![](/images/0200ssm/ssm295/blog.015.png)
