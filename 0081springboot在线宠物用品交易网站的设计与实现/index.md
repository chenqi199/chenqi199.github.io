...
# [0081springboot在线宠物用品交易网站的设计与实现](https://github.com/GraduationProject-springboot/0081springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0081springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0081springboot/blog.002.png)
...
![](/images/0000stringboot/0081springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0000stringboot/0081springboot/blog.004.png)
...
![](/images/0000stringboot/0081springboot/blog.005.png)

图4.12  管理员信息实体属性图

（2）客服信息实体属性图如图4.13所示：

![](/images/0000stringboot/0081springboot/blog.006.png)

图4.13  客服信息实体属性图

（3）商品资讯信息实体属性图如图4.14所示：

![](/images/0000stringboot/0081springboot/blog.007.png)
...
![](/images/0000stringboot/0081springboot/blog.010.png)

图5.1 用户信息管理界面
### 5.1.2 商品分类管理
系统管理员可以查看对商品分类信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0000stringboot/0081springboot/blog.011.png)

图5.2 商品分类信息管理界面
### 5.1.3 品牌信息管理
系统管理员可以对品牌信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0000stringboot/0081springboot/blog.012.png)

图5.3 品牌信息管理界面
### 5.1.4 商品信息管理
系统管理员可以对商品信息进行添加修改删除操作。界面如下图所示：

![](/images/0000stringboot/0081springboot/blog.013.png)
...
![](/images/0000stringboot/0081springboot/blog.014.png)

图5.5 商品信息界面
### 5.2.2 我的收藏
用户可以查看自己的收藏，也可以不收藏。界面如下图所示：

![](/images/0000stringboot/0081springboot/blog.015.png)
...
![](/images/0000stringboot/0081springboot/blog.016.png)
