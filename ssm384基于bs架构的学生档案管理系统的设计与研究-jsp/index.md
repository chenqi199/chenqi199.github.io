...
# [ssm384基于BS架构的学生档案管理系统的设计与研究+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm384/blog.001.png)
...
![](/images/0300ssm/ssm384/blog.002.png)
...
![](/images/0300ssm/ssm384/blog.007.png)
...
![](/images/0300ssm/ssm384/blog.008.png)
...
1
![](/images/0300ssm/ssm384/blog.009.png)
...
![1620732923(1)](/images/0300ssm/ssm384/blog.010.png "1620732923(1)")

图5.1 用户信息管理页面
### 5.2 班级年级管理
如图5.2显示的就是班级年级管理页面，此页面提供给管理员的功能有：查看已发布的班级年级数据，修改班级年级，班级年级作废，即可删除。

![1620732942(1)](/images/0300ssm/ssm384/blog.011.png "1620732942(1)")

图5.2 班级年级管理页面
### 5.3教育经历管理
如图5.3显示的就是教育经历管理页面，此页面提供给管理员的功能有：根据教育经历进行条件查询，还可以对教育经历进行新增、修改、查询操作等等。

![](/images/0300ssm/ssm384/blog.012.png)
...
![](/images/0300ssm/ssm384/blog.013.png)
