...
[4.2数据库设计 [10](#_Toc18550)](#_Toc18550)

[4.2.1概念设计 [10](#_Toc28510)](#_Toc28510)

[4.2.2逻辑设计 [11](#_Toc17580)](#_Toc17580)

[4.3本章小结 [14](#本章小结-3)](#本章小结-3)

[5系统实现 [16](#系统实现)](#系统实现)

[5.1管理员功能模块实现 [16](#管理员功能模块实现)](#管理员功能模块实现)

[5.1.1管理员登录 [16](#管理员登录)](#管理员登录)

[5.1.2药方管理 [16](#药方管理)](#药方管理)

[5.1.3文章管理 [16](#文章管理)](#文章管理)

[5.1.4文章类型管理 [17](#文章类型管理)](#文章类型管理)

[5.3系统测试 [17](#系统测试)](#系统测试)

[5.3.1测试概述 [17](#测试概述)](#测试概述)

[5.3.2测试结果 [18](#测试结果)](#测试结果)

[5.3本章小结 [18](#本章小结-4)](#本章小结-4)

[6总结与展望 [19](#总结与展望)](#总结与展望)
...
![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\用户.jpg](media/image1.jpeg){width="5.555555555555555in"
height="2.986111111111111in"}\
图4.1 用户实体属性图

（2）下图是文章留言实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\文章留言.jpg](media/image2.jpeg){width="3.75in"
height="2.0833333333333335in"}\
图4.2 文章留言实体属性图

（3）下图是药方收藏实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\药方收藏.jpg](media/image3.jpeg){width="3.75in"
height="2.0833333333333335in"}\
图4.3 药方收藏实体属性图

（4）下图是药食两用药材收藏实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\药食两用药材收藏.jpg](media/image4.jpeg){width="3.75in"
height="2.0833333333333335in"}\
图4.4 药食两用药材收藏实体属性图

（5）下图是文章收藏实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\文章收藏.jpg](media/image5.jpeg){width="3.75in"
height="2.0833333333333335in"}\
图4.5 文章收藏实体属性图

（6）下图是单页数据实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\单页数据.jpg](media/image6.jpeg){width="2.9166666666666665in"
height="1.5277777777777777in"}\
图4.6 单页数据实体属性图

（7）下图是中医翻译实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\中医翻译.jpg](media/image7.jpeg){width="3.75in"
height="2.0833333333333335in"}\
图4.7 中医翻译实体属性图

（8）下图是文章实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\文章.jpg](media/image8.jpeg){width="5.555555555555555in"
height="2.986111111111111in"}\
图4.8 文章实体属性图

（9）下图是药方实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\药方.jpg](media/image9.jpeg){width="5.555555555555555in"
height="2.986111111111111in"}\
图4.9 药方实体属性图

（10）下图是药食两用药材实体和其具备的属性。

![C:\\Users\\Administrator\\Desktop\\img\\jingfangyaoshiliangyongfuwupingtai\\药食两用药材.jpg](media/image10.jpeg){width="5.555555555555555in"
height="2.986111111111111in"}\
图4.10 药食两用药材实体属性图
...
![](media/image11.png){width="5.754166666666666in"
...
![](media/image13.png){width="5.7625in" height="2.8631944444444444in"}
...
本章通过展示系统相关的功能模块运行图，介绍系统主要功能模块的操作流程。系统使用者角色主要分为管理员和用户，管理员角色功能设计主要包括药方等模块。通过运行系统功能模块，展示操作界面，让用户更好的了解和使用本系统。最后，根据以上相关的系统测试内容显示，本系统的测试结果比较顺利，系统性能比较稳定，基本上没有出现问题。

# **6总结与展望**

本文从用户对经方药食两用服务平台的实际需求出发，设计本系统总体功能，然后结合使用Java语言、MySQL数据库、AJAX技术等相关技术，详细的编码实现本系统，最后通过功能测试，测试和完善系统功能。
...
经过很长时间的的努力，本人基本上完成了对经方药食两用服务平台的开发，本人的论文也是在所开发的系统为基础上得以撰写成功。在此，我要感谢所有帮助我的老师和同学们，使得我在毕业设计过程中，学习到了许多超出理论范畴的实践知识和经验，同时也提高了我的专业能力和水平。
...
### 0225springboot经方药食两用服务平台 项目图片
![图片](/images/0225springbootimg_014.jpg)
![图片](/images/0225springbootimg_015.jpg)
![图片](/images/0225springbootimg_001.jpg)
![图片](/images/0225springbootimg_003.jpg)
![图片](/images/0225springbootimg_002.jpg)
![图片](/images/0225springbootimg_012.jpg)
![图片](/images/0225springbootimg_006.jpg)
![图片](/images/0225springbootimg_007.jpg)
![图片](/images/0225springbootimg_013.jpg)
![图片](/images/0225springbootimg_005.jpg)
![图片](/images/0225springbootimg_011.jpg)
![图片](/images/0225springbootimg_010.jpg)
![图片](/images/0225springbootimg_004.jpg)
![图片](/images/0225springbootimg_009.jpg)
![图片](/images/0225springbootimg_008.jpg)
