...
# [ssm237基于SSM框架的校园招聘系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm237/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm237/blog.002.png)
...
![](/images/0200ssm/ssm237/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm237/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的企业用户功能结构图如下图所示：

![](/images/0200ssm/ssm237/blog.005.png)

图4-3 企业用户功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm237/blog.006.png)
...
![](/images/0200ssm/ssm237/blog.007.png)

图4.5简历投递信息实体属性图

（2）求职信息实体属性图如图4.6所示：

![](/images/0200ssm/ssm237/blog.008.png)

图4.6求职信息实体属性图

（3）岗位分类信息实体属性图如图4.7所示：

![](/images/0200ssm/ssm237/blog.009.png)
...
![](/images/0200ssm/ssm237/blog.010.png)

图5.1 企业信息管理界面
### 5.1.2 招聘信息管理
系统管理员可以对招聘信息进行添加，修改，删除操作，以及可以对企业发布的招聘信息进行审核。具体界面如图5.2所示。

![](/images/0200ssm/ssm237/blog.011.png)
...
![](/images/0200ssm/ssm237/blog.012.png)
...
![](/images/0200ssm/ssm237/blog.013.png)
...
![](/images/0200ssm/ssm237/blog.014.png)

图5.5投递简历界面
### 5.3.2 我的收藏管理
用户登录后可以在我的收藏管理里面删除自己收藏的信息，也可以查看自己收藏的信息。界面如下图所示：

![](/images/0200ssm/ssm237/blog.015.png)
