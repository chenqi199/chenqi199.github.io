...
# [0086springboot植物健康系统](https://github.com/GraduationProject-springboot/0086springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0086springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0086springboot/blog.002.png)
...
![](/images/0000stringboot/0086springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0000stringboot/0086springboot/blog.004.png)
...
![](/images/0000stringboot/0086springboot/blog.005.png)

图4.12  管理员信息实体属性图

（2）材料类目信息实体属性图如图4.13所示：

![](/images/0000stringboot/0086springboot/blog.006.png)

图4.13  材料类目信息实体属性图

（3）健康资讯信息实体属性图如图4.14所示：

![](/images/0000stringboot/0086springboot/blog.007.png)
...
![](/images/0000stringboot/0086springboot/blog.010.png)

图5.1 系统首页界面
## 5.2 咨询专家
可以在咨询专家栏目发布消息。具体界面如图5.2所示。

![](/images/0000stringboot/0086springboot/blog.011.png)

图5.2 咨询专家界面
## 5.3 普通植物检查登记
普通员工可以对普通植物检查登记信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0000stringboot/0086springboot/blog.012.png)

图5.3 普通植物检查登记信息管理界面
## 5.4 珍贵植物检查登记
普通员工可以对珍贵植物检查登记进行添加修改删除操作。界面如下图所示：

![](/images/0000stringboot/0086springboot/blog.013.png)
...
![](/images/0000stringboot/0086springboot/blog.014.png)

图5.5 植物救治用料登记信息界面
## 5.6 植物救治材料管理
普通员工可以对植物救治材料进行添加修改删除操作。界面如下图所示：

![](/images/0000stringboot/0086springboot/blog.015.png)
...
![](/images/0000stringboot/0086springboot/blog.016.png)
