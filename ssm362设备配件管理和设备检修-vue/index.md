...
# [ssm362设备配件管理和设备检修+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm362/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm362/blog.002.png)
...
![](/images/0300ssm/ssm362/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm362/blog.004.png)
...
![](/images/0300ssm/ssm362/blog.005.png)

图4.12  使用计划信息实体属性图

（2）维修员信息实体属性图如图4.13所示：

![](/images/0300ssm/ssm362/blog.006.png)

图4.13  维修员信息实体属性图

（3）管理员信息实体属性图如图4.14所示：

![](/images/0300ssm/ssm362/blog.007.png)
...
![](/images/0300ssm/ssm362/blog.008.png)

图5.1 维修员管理界面
## 5.2 设备信息管理
管理员可以对设备信息进行添加修改删除操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm362/blog.009.png)

图5.2 设备信息界面
## 5.3 使用计划管理
管理员可以对使用计划信息修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm362/blog.010.png)

图5.3 使用计划信息界面
## 5.4 检修提醒管理
维修员可以在检修提醒里面查看检修提醒消息。界面如下图所示：

![](/images/0300ssm/ssm362/blog.011.png)
...
![](/images/0300ssm/ssm362/blog.012.png)
