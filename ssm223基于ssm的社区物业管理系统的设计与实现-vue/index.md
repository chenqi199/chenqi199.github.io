...
# [ssm223基于SSM的社区物业管理系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0200ssm/ssm223/blog.001.png)
...
![](/images/0200ssm/ssm223/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0200ssm/ssm223/blog.006.png)
...
![](/images/0200ssm/ssm223/blog.007.png)

图4.7 报修实体E-R图

（2）下图就是楼盘实体E-R图

![](/images/0200ssm/ssm223/blog.008.png)

图4.8 楼盘实体E-R图

（3）下图就是楼盘类型实体E-R图

![](/images/0200ssm/ssm223/blog.009.png)
...
![](/images/0200ssm/ssm223/blog.010.png)

图5.1 用户信息管理页面
## 5.2 楼盘信息管理
管理员管理楼盘信息，可以添加，修改，删除楼盘信息信息。下图就是楼盘信息管理页面。

![](/images/0200ssm/ssm223/blog.011.png)

图5.2楼盘信息管理页面
## 5.3 投诉信息管理
管理员管理投诉信息，可以添加，修改，删除投诉信息信息。下图就是投诉信息管理页面。

![](/images/0200ssm/ssm223/blog.012.png)

图5.3 投诉信息管理页面
## 5.4报修信息管理
管理员管理报修信息，可以添加，修改，删除报修信息信息。下图就是报修信息管理页面。

![](/images/0200ssm/ssm223/blog.013.png)

图5.4 报修信息管理页面
## 5.5业主信息管理
管理员管理业主信息，可以添加，修改，删除业主信息信息。下图就是业主信息管理页面。

![](/images/0200ssm/ssm223/blog.014.png)
