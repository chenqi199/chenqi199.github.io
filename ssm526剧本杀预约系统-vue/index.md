...
# [ssm526剧本杀预约系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm526/blog.005.png)

图3.5 管理员用例图

图3.6即为用户用例图，用户权限操作的功能包括预约剧本杀，使用剧本杀预约订单，查看公告，查看论坛帖子。

![](/images/0500ssm/ssm526/blog.006.png)
...
![](/images/0500ssm/ssm526/blog.007.png)

图4.1 管理员功能结构

图4.2即为设计的用户功能结构，用户权限操作的功能包括预约剧本杀，使用剧本杀预约订单，查看公告，查看论坛帖子。

![](/images/0500ssm/ssm526/blog.008.png)
...
![](/images/0500ssm/ssm526/blog.009.png)

图4.4 剧本杀实体属性图

（2）图4.5即为用户这个实体所拥有的属性值。

![](/images/0500ssm/ssm526/blog.010.png)

图4.5 用户实体属性图

（3）图4.6即为剧本杀订单这个实体所拥有的属性值。

![](/images/0500ssm/ssm526/blog.011.png)

图4.6 剧本杀订单实体属性图

4. 图4.7即为管理员这个实体所拥有的属性值。

![](/images/0500ssm/ssm526/blog.012.png)

图4.7 管理员实体属性图

4. 图4.8即为上面介绍的实体中存在的联系。

![](/images/0500ssm/ssm526/blog.013.png)
