...
# [ssm564基于echarts的基金交易网站的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm564/blog.001.png)
...
![](/images/0500ssm/ssm564/blog.008.png)

图4.4基金实体属性图

（2）用户包括的属性有密码，姓名，性别，手机号，电子邮箱，头像等。其属性图如下。

![](/images/0500ssm/ssm564/blog.009.png)

图4.5 用户实体属性图

（3）交易记录包括的属性有交易份数，总金额，类型等。其属性图如下。

![](/images/0500ssm/ssm564/blog.010.png)

图4.6 交易记录实体属性图

（4）管理员包括的属性有用户名，角色，新增时间，密码等。其属性图如下。

![](/images/0500ssm/ssm564/blog.011.png)

图4.7 管理员实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0500ssm/ssm564/blog.012.png)
