...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1eMbYemE1U&bvid=BV1eMbYemE1U&cid=500001617126896&p=29)
...
![](media/image6.jpeg){width="6.279166666666667in"
...
表4.6项目表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    4     xiangmu_uuid_number          String             项目编号          是

    5         xiangmu_name             String             项目名称          是

    6        xiangmu_photo             String             项目照片          是

    7       xiangmu_address            String             项目地点          是

    8     xiangmu_kaishi_time           Date            项目开始时间        是

    9     xiangmu_jieshu_time           Date            项目结束时间        是

    10       xiangmu_types            Integer             项目类型          是

    11    xiangmu_dengji_types        Integer             项目等级          是

    12      xiangmu_content            String             项目介绍          是

    13        insert_time               Date              录入时间          是

    14    xiangmu_yesno_types         Integer             审核状态          是

    15     xiangmu_yesno_text          String             审核意见          是

    16    xiangmu_shenhe_time           Date              审核时间          是
...
表4.8专家表
  ...
  ------ -------------------- -------------------- ------------------- --------
   序号          列名               数据类型              说明          允许空
    ...
    6       zhuanjia_email           String             专家邮箱          是
...
项目申报系统在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的项目申报系统符合用户需求，它在用户电脑上运行使用带给用户的便利是显而易见的。

# 结 论

项目申报系统的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。从项目申报系统的前台页面实现，到项目申报系统的后台代码的编辑，我用到的软件包括了数据库软件Mysql，Java开发工具IDEA，办公软件Office，浏览器软件Fireworks，图像处理软件Photoshop等，这也是我第一次使用Java语言，开发的这个比较简单的项目申报系统。

项目申报系统开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
项目申报系统现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0527springboot项目申报系统的设计与实现--论文pf 项目图片
![图片](/images/0527springbootimg_001.jpg)
![图片](/images/0527springbootimg_003.jpg)
![图片](/images/0527springbootimg_002.jpg)
![图片](/images/0527springbootimg_006.jpg)
![图片](/images/0527springbootimg_007.jpg)
![图片](/images/0527springbootimg_005.jpg)
![图片](/images/0527springbootimg_004.jpg)
