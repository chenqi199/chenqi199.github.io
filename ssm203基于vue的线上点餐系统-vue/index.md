...
# [ssm203基于vue的线上点餐系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm203/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm203/blog.002.png)
...
![](/images/0200ssm/ssm203/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
设计的管理员主要是为用户提供的一些信息进行服务的。设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm203/blog.004.png)

图4-2管理员功能结构图

用户主要是订餐购买这些情景，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm203/blog.005.png)
...
![](/images/0200ssm/ssm203/blog.006.png)

图4.12  菜品信息实体属性图

（2）美食资讯实体属性图如图4.13所示：

![](/images/0200ssm/ssm203/blog.007.png)

图4.13  美食资讯实体属性图

（3）菜品类别信息实体属性图如图4.14所示：

![](/images/0200ssm/ssm203/blog.008.png)
...
![](/images/0200ssm/ssm203/blog.010.png)

图5.1 菜品信息界面
### 5.1.2 用户信息管理
管理员可以对用户进行查询修改，删除操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm203/blog.011.png)

图5.3 用户信息管理界面
### 5.1.3 订单信息管理
系统管理员可以对订单进行查询，审核以及查看评价信息，。界面如下图所示：

![](/images/0200ssm/ssm203/blog.012.png)

图5.4 订单信息管理界面
### 5.1.4 菜品类别管理
系统管理员可以对菜品类别进行添加修改删除操作。界面如下图所示：

![](/images/0200ssm/ssm203/blog.013.png)
