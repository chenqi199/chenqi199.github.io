...
# [0050springboot医院管理系统](https://github.com/GraduationProject-springboot/0050springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0050springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0050springboot/blog.002.png)
...
![](/images/0000stringboot/0050springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0000stringboot/0050springboot/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的医生功能结构图如下图所示：

![](/images/0000stringboot/0050springboot/blog.005.png)

图4-3 用户功能结构图

本系统是基于B/S架构的网站系统，设计的护士功能结构图如下图所示：

![](/images/0000stringboot/0050springboot/blog.006.png)
...
![](/images/0000stringboot/0050springboot/blog.007.png)

图4.12  科室信息实体属性图

（2）护士实体属性图如图4.13所示：

![](/images/0000stringboot/0050springboot/blog.008.png)

图4.13  护士实体属性图

（3）病床实体属性图如图4.14所示：

![](/images/0000stringboot/0050springboot/blog.009.png)
...
![](/images/0000stringboot/0050springboot/blog.011.png)

图5.1 病床信息管理界面
### 5.1.2 药房信息管理
医生可以对药房信息进行添加，修改，删除操作。具体界面如图5.2所示。

![](/images/0000stringboot/0050springboot/blog.012.png)
...
![](/images/0000stringboot/0050springboot/blog.013.png)
...
![](/images/0000stringboot/0050springboot/blog.014.png)
...
![](/images/0000stringboot/0050springboot/blog.015.png)

图5.6 病床类别界面
### 5.3.2 科室信息管理
管理员登录后可以对科室信息进行添加，修改，查询以及删除操作。界面如下图所示：

![](/images/0000stringboot/0050springboot/blog.016.png)
