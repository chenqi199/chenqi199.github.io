...
# [ssm289在线交友系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm289/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm289/blog.002.png)
...
![](/images/0200ssm/ssm289/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0200ssm/ssm289/blog.004.png)
...
![](/images/0200ssm/ssm289/blog.005.png)

图4.12 每日推荐信息实体属性图

（2）公告实体属性图如图4.13所示：

![](/images/0200ssm/ssm289/blog.006.png)

图4.13  公告实体属性图

（3）管理员实体属性图如图4.14所示：

![](/images/0200ssm/ssm289/blog.007.png)
...
![](/images/0200ssm/ssm289/blog.009.png)

图5.1 用户管理界面
### 5.1.2 用户信息管理
系统管理员可以对用户信息添加修改，以及查询，删除操作，也可以生成推荐。具体界面如图5.2所示。

![](/images/0200ssm/ssm289/blog.010.png)

图5.3 用户信息界面
### 5.1.3 轮播图管理
系统管理员可以对轮播图进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm289/blog.011.png)
...
![](/images/0200ssm/ssm289/blog.012.png)

图5.5 系统首页界面
### 5.2.2 每日推荐
用户登录后，点击每日推荐可以看到每日推荐的用户信息。界面如下图所示：

![](/images/0200ssm/ssm289/blog.013.png)

图5.6 每日推荐界面
### 5.2.3 用户信息
用户登录后可以在用户信息里面添加用户信息，可以写一些对于交友有帮助的信息。界面如下图所示：

![](/images/0200ssm/ssm289/blog.014.png)
