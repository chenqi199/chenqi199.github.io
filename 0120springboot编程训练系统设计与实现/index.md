...
## 3.4系统流程和逻辑
![](/images/0100stringboot/0120springboot/blog.001.png)

图3-3登录流程图

![](/images/0100stringboot/0120springboot/blog.002.png)
...
![](/images/0100stringboot/0120springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0100stringboot/0120springboot/blog.004.png)
...
![](/images/0100stringboot/0120springboot/blog.005.png)

图4.12  试卷信息实体属性图

（2）留言板信息实体属性图如图4.13所示：

![](/images/0100stringboot/0120springboot/blog.006.png)

图4.13  留言板信息实体属性图

（3）训练通知信息实体属性图如图4.14所示：

![](/images/0100stringboot/0120springboot/blog.007.png)
...
![](/images/0100stringboot/0120springboot/blog.010.png)

图5.1 用户信息管理界面
### 5.1.2 题库资源管理
系统管理员可以对题库资源信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0100stringboot/0120springboot/blog.011.png)

图5.2 题库资源信息管理界面
### 5.1.3 试题信息管理
系统管理员可以对试题信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0100stringboot/0120springboot/blog.012.png)

图5.3 试题信息管理界面
### 5.1.4 试卷信息管理
系统管理员可以对试卷信息进行添加修改删除操作。界面如下图所示：

![](/images/0100stringboot/0120springboot/blog.013.png)
...
![](/images/0100stringboot/0120springboot/blog.014.png)

图5.5 题库资源界面
### 5.2.2 用户交流
用户可以在用户交流的地方进行留言。界面如下图所示：

![](/images/0100stringboot/0120springboot/blog.015.png)
...
![](/images/0100stringboot/0120springboot/blog.016.png)
