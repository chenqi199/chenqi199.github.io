...
# [0118springboot基于工程教育认证的计算机课程管理平台](https://github.com/GraduationProject-springboot/0118springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610721604&p=18)
...
Boot框架，MYSQL数据库设计开发，充分保证系统的稳定性。系统具有界面清晰、操作简单，功能齐全的特点，使得基于工程教育认证的计算机课程管理平台管理工作系统化、规范化。本系统的使用使管理人员从繁重的工作中解脱出来，实现无纸化办公，能够有效的提高基于工程教育认证的计算机课程管理平台管理效率。

**关键词：**基于工程教育认证的计算机课程管理平台；Spring
Boot框架；MYSQL数据库
...
whole development process of computer course management platform based
on engineering education certification. By analyzing the shortcomings of
the computer course management platform based on engineering education
certification, this paper creates a scheme of computer course management
platform based on engineering education certification. This paper
introduces the system analysis part of computer course management
platform based on engineering education certification, including
feasibility analysis, etc. the system design part mainly introduces the
system function design and database design.

This computer course management platform based on engineering education
certification has the functions of personal center, notice management,
student management, teacher management, course information management
and student course management. So it has certain practicability.
...
operation and complete functions, which makes the management of computer
course management platform based on engineering education certification
systematic and standardized. The use of this system makes managers free
from heavy work and realize paperless office, which can effectively
improve the management efficiency of computer course management platform
based on engineering education certification.

**Keywords:** Computer course management platform based on engineering
education certification; Spring boot framework; Mysql database

目录

[1系统概述 1](#系统概述)

[1.1 研究背景 1](#__RefHeading___Toc27439)

[1.2研究目的 1](#__RefHeading___Toc4433)
...
[3.3系统界面分析 6](#__RefHeading___Toc5040)
...
[5.1.1 教师信息管理 13](#教师信息管理)

[5.1.2 通知公告管理 14](#通知公告管理)

[5.1.3 学生信息管理 14](#学生信息管理)

[5.1.4 课程信息管理 15](#课程信息管理)

[5.2 学生模块的实现 15](#学生模块的实现)

[5.2.1 课程信息 15](#课程信息)

[5.3 教师模块的实现 16](#教师模块的实现)

[5.3.1 课程信息管理 16](#课程信息管理-1)
...
[]{#__RefHeading___Toc27439 .anchor}1.1 研究背景
...
[]{#__RefHeading___Toc4433 .anchor}1.2研究目的
...
[]{#__RefHeading___Toc5040 .anchor}3.3系统界面分析
...
![](media/image9.png){width="6.374305555555556in"
...
![](media/image13.png){width="6.365277777777778in"
...
经过对上述测试结果分析，本系统符合用户需求。所有基本功能点实现，操作简单，操作流程简单合理，产品运行性能良好，是一款值得推广的基于工程教育认证的计算机课程管理平台。
...
首先我要感谢此次指导我的老师，是他的及时纠正我在设计当中出现的问题，使得我的设计高质量完成。指导老师在我本次基于工程教育认证的计算机课程管理平台的开发过程中，为程序、框架的设计、代码等方面以及论文设计提供了很多宝贵的意见，并且为我推荐了许多相关的资料，他的指导和建议使我受益匪浅，通过老师的耐心辅导和指点，我的论文顺利完成，在此，我表示深刻的感谢。
...
### 0118springboot基于工程教育认证的计算机课程管理平台 项目图片
