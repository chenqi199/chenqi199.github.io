...
# [ssm282学生学情预警系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm282/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm282/blog.002.png)
...
![](/images/0200ssm/ssm282/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0200ssm/ssm282/blog.004.png)
...
![](/images/0200ssm/ssm282/blog.005.png)

图4.12 学生信息实体属性图

（2） 管理员实体属性图如图4.13所示：

![](/images/0200ssm/ssm282/blog.006.png)

图4.13  管理员实体属性图

（3）系统公告实体属性图如图4.14所示：

![](/images/0200ssm/ssm282/blog.007.png)
...
![](/images/0200ssm/ssm282/blog.009.png)

图5.1 学生信息管理界面
## 5.2 教师信息管理
系统管理员可以管理教师信息，可以对教师信息进行添加，修改，删除，查询操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm282/blog.010.png)

图5.2 教师信息管理界面
## 5.3 成绩数据管理
系统管理员可以对成绩数据进行删除和导出，以及查询操作。界面如下图所示：

![](/images/0200ssm/ssm282/blog.011.png)
...
![](/images/0200ssm/ssm282/blog.012.png)

图5.4 成绩预警界面
## 5.5 学生成绩预警 
学生登录可以发现自己成绩预警。界面如下图所示：

![](/images/0200ssm/ssm282/blog.013.png)
