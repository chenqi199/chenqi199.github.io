...
# [ssm396社区团购系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm396/blog.001.png)
...
![](/images/0300ssm/ssm396/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0300ssm/ssm396/blog.006.png)
...
![](/images/0300ssm/ssm396/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是留言板实体E-R图

![](/images/0300ssm/ssm396/blog.008.png)

图4.8 留言板实体E-R图

（3）下图就是商品分类信息实体E-R图

![](/images/0300ssm/ssm396/blog.009.png)
...
![](/images/0300ssm/ssm396/blog.010.png)

图5.1 用户信息管理页面
## 5.2 商家信息管理
管理员可以对商家信息进行添加，查询和修改操作。下图就是商家信息管理页面。

![](/images/0300ssm/ssm396/blog.011.png)

图5.2商家信息管理页面
## 5.3 商品分类管理
管理员可以对商品分类信息进行添加，修改，删除操作。下图就是商品分类信息管理页面。

![](/images/0300ssm/ssm396/blog.012.png)

图5.3 商品分类信息管理页面
## 5.4 商品团购管理
商家可以对商品团购信息进行添加，修改删除操作。下图就是商品团购信息管理页面。

![](/images/0300ssm/ssm396/blog.013.png)

图5.4 商品团购信息管理页面
## 5.5 商品团购
用户登录以后可以对商品团购信息进行购买和评论。下图就是商品团购信息页面。

![](/images/0300ssm/ssm396/blog.014.png)
...
![](/images/0300ssm/ssm396/blog.015.png)

图5.6 购物车页面
## 5.7 我的订单
用户可以在个人中心查看我的订单。下图就是我的订单页面。

![](/images/0300ssm/ssm396/blog.016.png)
