...
# [ssm316基于ssm的游戏销售系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm316/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm316/blog.002.png)
...
![](/images/0300ssm/ssm316/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm316/blog.004.png)
...
![](/images/0300ssm/ssm316/blog.005.png)

图4.12 系统公告信息实体属性图

（2）游戏分类实体属性图如图4.13所示：

![](/images/0300ssm/ssm316/blog.006.png)

图4.13   游戏分类实体属性图

（3）管理员实体属性图如图4.14所示：

![](/images/0300ssm/ssm316/blog.007.png)
...
![](/images/0300ssm/ssm316/blog.009.png)

图5.1 用户信息管理界面
### 5.1.2 游戏分类管理
系统管理员可以对游戏分类进行管理操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm316/blog.010.png)
...
![](/images/0300ssm/ssm316/blog.011.png)
...
![](/images/0300ssm/ssm316/blog.012.png)

图5.4 游戏购买界面
### 5.2.2 购物车
用户在购物车里选择数量，也可以删除，还可以去支付。界面如下图所示：

![](/images/0300ssm/ssm316/blog.013.png)

图5.5 购物车界面
### 5.2.3 我的订单
用户登录后可以在个人中心查看我的订单。界面如下图所示：

![](/images/0300ssm/ssm316/blog.014.png)
