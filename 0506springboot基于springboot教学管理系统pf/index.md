...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1eMbYemE1U?p=8)
...
![](/images/0500stringboot/0506springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0500stringboot/0506springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0500stringboot/0506springboot/blog.003.png)
...
![结构设计图](/images/0500stringboot/0506springboot/blog.004.jpeg "结构设计图")
...
|6|kecheng\_clicknum|Integer|课程热度|是|
...
|3|qiandao\_name|String|签到标题|是|
|4|insert\_time|Date|签到时间|是|
...
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|学生|是|
|3|xuejixinxi\_xuenian|String|学年|是|
|4|xuejixinxi\_xueqi|Date|学期|是|
|5|xuejixinxi\_dizhi|String|年级|是|
|6|xuejixinxi\_xueyuan|String|学院|是|
|7|xuejixinxi\_zhuanye|String|专业|是|
|8|xuejixinxi\_xuezhi|String|学制|是|
|9|xuejixinxi\_banji|String|班级|是|
|10|xuejixinxi\_xueli|String|学历层次|是|
|11|zhuang\_types|Integer|学籍状态|是|
|12|create\_time|Date|创建时间|是|
表4.13学生表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zuoye\_uuid\_number|String|作业编号|是|
|3|zuoye\_name|String|作业名称|是|
|4|zuoye\_file|String|作业文件|是|
|5|zuoye\_types|Integer|作业类型|是|
|6|jiaoshi\_id|Integer|教师|是|
|7|zuoye\_content|String|作业详情|是|
|8|zuoye\_delete|Integer|逻辑删除|是|
...
![](/images/0500stringboot/0506springboot/blog.007.png)
...
![](/images/0500stringboot/0506springboot/blog.008.png)
