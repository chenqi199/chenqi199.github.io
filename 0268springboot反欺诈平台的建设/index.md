...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fanzhashipin\_name|String|视频标题|是|
|3|fanzhashipin\_types|Integer|视频类型|是|
|4|fanzhashipin\_photo|String|项目封面|是|
|5|zan\_number|Integer|赞|是|
|6|cai\_number|Integer|踩|是|
|7|fanzhashipin\_content|String|项目详情|是|
|8|fanzhashipin\_delete|Integer|假删|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fanzhashipin\_id|Integer|视频|是|
|3|yonghu\_id|Integer|用户|是|
|4|fanzhashipin\_collection\_types|Integer|类型|是|
...
|2|fanzhashipin\_id|Integer|视频|是|
|3|yonghu\_id|Integer|用户|是|
|4|fanzhashipin\_liuyan\_text|String|留言内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|news\_name|String|案例分析标题|是|
|3|news\_types|Integer|案例分析类型|是|
|4|news\_photo|String|案例分析图片|是|
|5|insert\_time|Date|案例分析时间|是|
|6|news\_content|String|案例分析详情|是|
