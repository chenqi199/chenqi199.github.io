...
# [ssm789基于Java的校园二手物品交易平台的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0700ssm/ssm789/blog.001.png)
...
![](/images/0700ssm/ssm789/blog.009.png)

图5.1 用户管理页面
### 5.1.2 商品类型管理
管理员可以对商品类型信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm789/blog.010.png)

图5.2 商品类型管理页面
### 5.1.3 公告信息管理
管理员可以对公告信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm789/blog.011.png)

图5.3 公告信息管理页面
### 5.1.4 商家管理
管理员可以对商家信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm789/blog.012.png)

图5.4 商家信息管理页面
### 5.1.5 轮播图管理
管理员可以对轮播图信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm789/blog.013.png)
...
![](/images/0700ssm/ssm789/blog.014.png)

图5.6 商品信息页面
### 5.2.2 购物车
用户可以把商品信息都添加到购物车里，可以在购物车里删除和增加数量，用户不登录是看不到自己的购物车的。

![](/images/0700ssm/ssm789/blog.015.png)

图5.7 购物车页面
### 5.2.3 我的收藏
我的收藏里面可以看到自己收藏过的商品信息，可以去点击收藏的信息去取消收藏。

![](/images/0700ssm/ssm789/blog.016.png)
...
![](/images/0700ssm/ssm789/blog.017.png)

图5.9 商品管理页面
### 5.3.2 商品留言管理
商家可以查看和搜索以及回复自己发布的商品信息里面的留言。

![](/images/0700ssm/ssm789/blog.018.png)

图5.10 购物车页面
### 5.3.3 商品订单管理
商家可以查看自己发布商品的商品订单信息，还可以搜索商品订单信息

![](/images/0700ssm/ssm789/blog.019.png)
