...
# [ssm388校内互助交易平台+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm388/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm388/blog.002.png)
...
![](/images/0300ssm/ssm388/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0300ssm/ssm388/blog.004.png)

图4-1管理员功能结构图

本系统是基于B/S架构的网站系统，设计的发布者功能结构图如下图所示：

![](/images/0300ssm/ssm388/blog.005.png)

图4-2 用户功能结构图

本系统是基于B/S架构的网站系统，设计的学生功能结构图如下图所示：

![](/images/0300ssm/ssm388/blog.006.png)
...
![](/images/0300ssm/ssm388/blog.007.png)

图4.12  资源信息实体属性图

（2）管理员实体属性图如图4.13所示：

![](/images/0300ssm/ssm388/blog.008.png)

图4.13  管理员实体属性图

（3）资源分类实体属性图如图4.14所示：

![](/images/0300ssm/ssm388/blog.009.png)
...
![](/images/0300ssm/ssm388/blog.010.png)

图5.1 学生信息管理界面
### 5.1.2 发布者信息管理
系统管理员可以对发布者信息进行添加修改，删除操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm388/blog.011.png)

图5.2 发布者信息界面
### 5.1.3 任务分类管理
系统管理员可以对任务分类信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0300ssm/ssm388/blog.012.png)
...
![](/images/0300ssm/ssm388/blog.013.png)

图5.4 资源信息界面
### 5.2.2 任务信息管理
发布者可以发布属于自己的任务信息，发布了之后管理员需要审核。界面如下图所示：

![](/images/0300ssm/ssm388/blog.014.png)
