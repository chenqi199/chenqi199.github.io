...
# [ssm692学籍管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm692/blog.008.png)

图4.4 学生实体属性图

（2）把课程具备的属性通过属性图进行展示，绘制的属性图见图4.5。

![](/images/0600ssm/ssm692/blog.009.png)

图4.5 课程实体属性图

（3）把成绩具备的属性通过属性图进行展示，绘制的属性图见图4.6。

![](/images/0600ssm/ssm692/blog.010.png)

图4.6 成绩实体属性图

（4）把管理员具备的属性通过属性图进行展示，绘制的属性图见图4.7。

![](/images/0600ssm/ssm692/blog.011.png)

图4.7 管理员实体属性图

（5）上述实体间关系见图4.8。

![](/images/0600ssm/ssm692/blog.012.png)
...
![打开新的 phpMyAdmin 窗口](blog.013.png "打开新的 phpMyAdmin 窗口")表4.1 成绩信息表
