# 0326springboot医院急诊系统


# [0326springboot医院急诊系统](https://github.com/GraduationProject-springboot/0326springboot)
...
# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于医院急诊系统信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立医院急诊系统，来规范医院急诊系统信息管理流程，让管理工作可以系统化和程序化，同时，医院急诊系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
医院急诊系统可以对医院急诊系统信息进行集中管理，可以真正避免传统管理的缺陷。医院急诊系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，医院急诊系统都可以轻松应对。所以，医院急诊系统的运用是让医院急诊系统信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管医院急诊系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作医院急诊系统时可以最大化运用医院急诊系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发医院急诊系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发医院急诊系统。此外，医院急诊系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成医院急诊系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于医院急诊系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
![](/images/0300stringboot/0326springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0300stringboot/0326springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0300stringboot/0326springboot/blog.003.png)

图3.3 查询信息流程图
## 3.3系统性能分析
分析医院急诊系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![](/images/0300stringboot/0326springboot/blog.004.png)
...
![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户.jpg](/images/0300stringboot/0326springboot/blog.005.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户.jpg")
图4.1 用户实体属性图

（2）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\公告信息.jpg](/images/0300stringboot/0326springboot/blog.006.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\公告信息.jpg")
图4.2 公告信息实体属性图

（3）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\字典表.jpg](/images/0300stringboot/0326springboot/blog.007.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\字典表.jpg")
图4.3 字典表实体属性图

（4）下图是病例信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病例信息.jpg](/images/0300stringboot/0326springboot/blog.008.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病例信息.jpg")
图4.4 病例信息实体属性图

（5）下图是病房信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病房信息.jpg](/images/0300stringboot/0326springboot/blog.009.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病房信息.jpg")
图4.5 病房信息实体属性图

（6）下图是医生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\医生.jpg](/images/0300stringboot/0326springboot/blog.010.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\医生.jpg")
图4.6 医生实体属性图

（7）下图是病房预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病房预约.jpg](/images/0300stringboot/0326springboot/blog.011.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\病房预约.jpg")
图4.7 病房预约实体属性图

（8）下图是用户健康码实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户健康码.jpg](/images/0300stringboot/0326springboot/blog.012.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户健康码.jpg")
图4.8 用户健康码实体属性图

（9）下图是急诊预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\急诊预约.jpg](/images/0300stringboot/0326springboot/blog.013.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\急诊预约.jpg")
图4.9 急诊预约实体属性图

（10）下图是论坛信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\论坛信息.jpg](/images/0300stringboot/0326springboot/blog.014.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\论坛信息.jpg")
图4.10 论坛信息实体属性图

（11）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户表.jpg](/images/0300stringboot/0326springboot/blog.015.jpeg "C:\Users\Administrator\Desktop\img\yiyuanjizhenxitong\用户表.jpg")
图4.11 用户表实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|bingfang\_uuid\_number|String|病房编号|是|
|3|bingfang\_name|String|病房名称|是|
|4|bingfang\_photo|String|病房图片|是|
|5|bingfang\_new\_money|BigDecimal|病房价格|是|
|6|bingfang\_kucun\_number|Integer|病房数量|是|
|7|bingfang\_types|Integer|病房类型|是|
|8|bingfang\_content|String|病房详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|bingfang\_id|Integer|病房|是|
|3|yonghu\_id|Integer|用户|是|
|4|bingfang\_order\_time|Date|预约时间|是|
|5|bingfang\_order\_text|String|备注|是|
...
|11|yisheng\_new\_money|BigDecimal|预约价格|是|
...
|3|yonghu\_id|Integer|用户|是|
|4|yisheng\_order\_uuin\_number|String|就诊识别码|是|
|5|yisheng\_order\_time|Date|预约时间|是|
|6|yisheng\_order\_types|Integer|时间类型|是|
|7|yisheng\_order\_text|String|患者症状|是|
|8|yisheng\_order\_status\_types|Integer|预约状态|是|
|9|yisheng\_order\_yesno\_types|Integer|预约审核|是|
|10|yisheng\_order\_yesno\_text|String|审核结果|是|
|11|create\_time|Date|创建时间|是|
表4.9用户表
...
|3|yonghujiankangma\_photo|String|健康码|是|
...
![](/images/0300stringboot/0326springboot/blog.016.png)

图5.1 用户信息管理页面
### 5.2 医生信息管理
如图5.2显示的就是医生信息管理页面，此页面提供给管理员的功能有：查看已发布的医生信息数据，修改医生信息，医生信息作废，即可删除，还进行了对医生信息名称的模糊查询 医生信息信息的类型![](/images/0300stringboot/0326springboot/blog.017.png)查询等等一些条件。
...
![](/images/0300stringboot/0326springboot/blog.018.png)
...
![](/images/0300stringboot/0326springboot/blog.019.png)
