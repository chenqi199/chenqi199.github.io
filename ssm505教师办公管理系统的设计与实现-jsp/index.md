...
# [ssm505教师办公管理系统的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![22f9](/images/0500ssm/ssm505/blog.001.jpeg "22f9")
...
![](/images/0500ssm/ssm505/blog.002.png)
...
![](/images/0500ssm/ssm505/blog.003.png)
...
![](/images/0500ssm/ssm505/blog.008.png)

图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图。

![](/images/0500ssm/ssm505/blog.009.png)
...
![](/images/0500ssm/ssm505/blog.010.png)

图4.4 管理员实体属性图

（2）系所实体属性图见图4.5。

![](/images/0500ssm/ssm505/blog.011.png)

图4.5 系所实体属性图

（3）领导实体属性图见图4.6。

![](/images/0500ssm/ssm505/blog.012.png)
...
![](/images/0500ssm/ssm505/blog.013.png)

图5.1 系所管理页面
## 5.2 教师管理
如图5.2显示的就是教师管理页面，管理员可以对教师信息进行添加，修改，删除，查询操作。

![](/images/0500ssm/ssm505/blog.014.png)

图5.2 教师管理页面
## 5.3 领导管理
如图5.3显示的就是领导管理页面，管理员可以对领导信息进行添加，修改，删除，查询操作。

![](/images/0500ssm/ssm505/blog.015.png)

图5.3 领导管理页面
## 5.4 通知公告管理
如图5.4显示的就是通知公告管理页面，领导可以给专门的教师进行通知。

![](/images/0500ssm/ssm505/blog.016.png)

图5.4 通知公告管理页面
## 5.5 回复反馈管理
如图5.4显示的就是回复反馈管理页面，教师可以对领导的通知进行回复反馈。

![](/images/0500ssm/ssm505/blog.017.png)

图5.5 回复反馈管理页面
## 5.6 文件中心管理
如图5.4显示的就是文件中心管理页面，教师主要对文件中心进行添加，删除，修改，查询操作。

![](/images/0500ssm/ssm505/blog.018.png)
