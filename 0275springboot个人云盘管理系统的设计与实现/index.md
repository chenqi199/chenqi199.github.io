...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1EbH&bvid=BV1jqaLe1EbH&cid=500001610885397&p=41)
...
表4.4论坛表
  ...
  ------ ------------------- -------------------- ------------------- --------
   序号         列名               数据类型              说明          允许空
    ...
    4       zhiyuanzhe_id          Integer            zhiyuanzhe         是
...
表4.6视频信息表
  ...
  ------ ----------------- -------------------- ------------------- --------
   序号        列名              数据类型              说明          允许空
    ...
    3      shipin_types          Integer             视频类别          是

    4      shipin_photo           String             视频图片          是
    ...
    8       insert_time            Date              发布日期          是

    9     shipin_content          String             视频详情          是
...
表4.7书籍信息表
  ...
  ------ ---------------- -------------------- ------------------- --------
   序号        列名             数据类型              说明          允许空
    ...
    2       shuji_name           String             书籍标题          是

    3      shuji_types          Integer             书籍类别          是

    4      shuji_photo           String             书籍图片          是

    5       shuji_file           String             书籍下载          是

    6       yonghu_id           Integer               用户            是

    7     shuji_clicknum        Integer             点击次数          是

    8      insert_time            Date              发布日期          是

    9     shuji_content          String             书籍详情          是
...
如图5.2显示的就是博客信息管理页面，此页面提供给管理员的功能有：查看已发布的博客信息数据，修改博客信息，博客信息作废，即可删除，还进行了对博客信息名称的模糊查询
博客信息信息的类型查询等等一些条件。
...
个人云盘管理系统的目标用户最终面向的是系统的功能，所以检验本系统的功能也是一项重要任务，只有该系统的功能都能保证正常使用，才会吸引更多的用户来使用。
...
通过测试，可以发现个人云盘管理系统具备完善的功能，同时具备易操作性和易维护性的特点，在系统安全性上也有比较健全的数据保护机制。至此，个人云盘管理系统可以投入使用。

# 结 论

之前在课本上学习过软件开发的知识，包括开发流程的了解，开发技术的学习，还有如何进行系统需求分析与设计，老师也选取了比较有代表性的管理系统在课堂上进行讲解，并在课后布置作业让我们练习，期间老师也让我们也对系统实现与测试进行了了解。所以面对本次个人云盘管理系统的开发制作，我的脑海里还是有比较清晰的思路。在系统制作中，以及配套文档的编写中，我都是按照软件开发流程一步步开展我的工作。
...
从文档的角度来讲，在完成个人云盘管理系统制作后，对其制作过程需要进行描述，包括如何进行的需求分析，如何完成系统的设计，以及实现的系统功能的运行效果等都要进行描述。这期间我也花费了将近一个月时间来完成，为了达到学院要求的文档排版标准，我也多次在导师建议下，学习办公软件的使用，还有排版技巧。功夫不负有心人，我编写的文档在面临多次编写修改后终于完成了。
...
1.  卢鸿,朱隆尹.个人云盘管理系统查询系统优化设计及应用\[J\].南昌大学学报(理科版),2016,36(04):402-404.

    \[2\]高岳,张腾.基于基站定位的个人云盘管理系统查询系统设计\[J\].无线互联科技,2015(03):32-35.

\[3\]钱佳加,唐海江,夏莎莎,姚宇杰,张祥杰.个人云盘管理系统查询系统的设计与实现\[J\].现代商业,2015(17):67-68.
...
### 0275springboot个人云盘管理系统的设计与实现 项目图片
![图片](/images/0275springbootimg_001.jpg)
![图片](/images/0275springbootimg_003.jpg)
![图片](/images/0275springbootimg_002.jpg)
![图片](/images/0275springbootimg_006.jpg)
![图片](/images/0275springbootimg_007.jpg)
![图片](/images/0275springbootimg_005.jpg)
![图片](/images/0275springbootimg_004.jpg)
![图片](/images/0275springbootimg_008.jpg)
