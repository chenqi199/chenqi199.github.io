...
# [0004springboot学生心理咨询评估系统](https://github.com/GraduationProject-springboot/0004springboot)
...
![](/images/0000stringboot/0004springboot/blog.001.png)
...
![](/images/0000stringboot/0004springboot/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0000stringboot/0004springboot/blog.006.png)
...
![](/images/0000stringboot/0004springboot/blog.007.png)

图4.7 试卷实体E-R图

（2）下图就是管理员实体E-R图

![](/images/0000stringboot/0004springboot/blog.008.png)

图4.8 管理员实体E-R图

（3）下图就是用户实体E-R图

![](/images/0000stringboot/0004springboot/blog.009.png)
...
![](/images/0000stringboot/0004springboot/blog.011.png)

图5.1 用户信息管理页面
## 5.2 试卷信息管理
管理员管理试卷信息，可以添加，修改，删除试卷信息信息。下图就是试卷信息管理页面。

![](/images/0000stringboot/0004springboot/blog.012.png)

图5.2试卷信息管理页面
## 5.3 试题信息管理
管理员管理试题信息，可以添加，修改，删除试题信息信息。下图就是试题信息管理页面。

![](/images/0000stringboot/0004springboot/blog.013.png)

图5.3 试题信息管理页面
## 5.4试卷列表管理
用户登录后可以在试卷列表找到试卷参考考试。下图就是试卷列表管理页面。

![](/images/0000stringboot/0004springboot/blog.014.png)

图5.4 试卷列表管理页面
## 5.5考试记录管理
用户可以查看自己的考试记录。下图就是考试记录管理页面。

![](/images/0000stringboot/0004springboot/blog.015.png)
