...
# [ssm141餐厅点菜管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0100ssm/ssm141/blog.001.png)
...
![](/images/0100ssm/ssm141/blog.002.png)

图3.2 注册流程图

访问者操作系统，前提是需要验证身份，而登录功能的设置就是把本系统的用户引导进入后台操作区，把不是本系统的用户拒之门外。其流程见下图。

![](/images/0100ssm/ssm141/blog.003.png)
...
![](/images/0100ssm/ssm141/blog.008.png)

图4.4 订单实体属性图

（2）设计的用户实体，其具备的属性见下图。

![](/images/0100ssm/ssm141/blog.009.png)

图4.5 用户实体属性图

（3）设计的购物车实体，其具备的属性见下图。

![](/images/0100ssm/ssm141/blog.010.png)

图4.6 购物车实体属性图

（4）设计的菜品实体，其具备的属性见下图。

![](/images/0100ssm/ssm141/blog.011.png)

图4.7 菜品实体属性图

（5）设计的各实体间关系见下图。

![](/images/0100ssm/ssm141/blog.012.png)
