...
# [ssm704学术团队管理系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0700ssm/ssm704/blog.001.png)
...
![](/images/0700ssm/ssm704/blog.002.png)
...
![](/images/0700ssm/ssm704/blog.007.png)

图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图。

![](/images/0700ssm/ssm704/blog.008.png)
...
![](/images/0700ssm/ssm704/blog.009.png)

图4.4 管理员实体属性图

（2）学生实体属性图见图4.5。

![](/images/0700ssm/ssm704/blog.010.png)

图4.5 学生实体属性图

（3）导师实体属性图见图4.6。

![](/images/0700ssm/ssm704/blog.011.png)
...
![](/images/0700ssm/ssm704/blog.018.png)

图5.7 学生签退管理页面
## 5.8 确认收到管理
如图5.4显示的就是确认收到页面，管理员可以对教师提交的确认收到信息进行查询，查看和删除。

![](/images/0700ssm/ssm704/blog.019.png)
