...
# [ssm089理发店会员管理系统的设计和实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0000ssm/ssm089/blog.001.png)
...
![](/images/0000ssm/ssm089/blog.002.png)

图3.2 注册流程图

访问者操作系统，前提是需要验证身份，而登录功能的设置就是把本系统的用户引导进入后台操作区，把不是本系统的用户拒之门外。其流程见下图。

![](/images/0000ssm/ssm089/blog.003.png)
...
![](/images/0000ssm/ssm089/blog.004.png)

图3.4 管理员用例图

理发店会员管理系统设置了用户权限，其用例图见下图。用户预约美发，查看并评论商铺，优惠活动以及用户分享信息。

![](/images/0000ssm/ssm089/blog.005.png)
...
![](/images/0000ssm/ssm089/blog.006.png)

图4.1 管理员功能结构图

设计的用户的详细功能见下图，用户预约美发，查看并评论商铺，优惠活动以及用户分享信息。

![](/images/0000ssm/ssm089/blog.007.png)
...
![](/images/0000ssm/ssm089/blog.008.png)

图4.4 商铺实体属性图

（2）设计的美发实体，其具备的属性见下图。

![](/images/0000ssm/ssm089/blog.009.png)

图4.5 美发实体属性图

（3）设计的用户实体，其具备的属性见下图。

![](/images/0000ssm/ssm089/blog.010.png)

图4.6 用户实体属性图

（4）设计的留言实体，其具备的属性见下图。

![](/images/0000ssm/ssm089/blog.011.png)

图4.7 留言实体属性图

（5）设计的各实体间关系见下图。

![](/images/0000ssm/ssm089/blog.012.png)
...
![](/images/0000ssm/ssm089/blog.017.png)

图5.5 商铺信息页面
### 5.2.2 美发信息
用户权限中的美发信息，其运行效果见下图。用户收藏美发信息，评论美发信息，预约美发。

![](/images/0000ssm/ssm089/blog.018.png)

图5.6 美发信息页面
### 5.2.3 用户分享
用户权限中的用户分享，其运行效果见下图。用户查看别人发布的分享信息，可以收藏分享信息，评论分享信息。

![](/images/0000ssm/ssm089/blog.019.png)

图5.7 用户分享页面
### 5.2.4 优惠活动
用户权限中的优惠活动，其运行效果见下图。用户查看优惠活动详细信息，评论优惠活动。

![](/images/0000ssm/ssm089/blog.020.png)
