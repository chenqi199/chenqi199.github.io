...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1ULbQeREgz?p=67)
...
![](/images/0400stringboot/0467springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0400stringboot/0467springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0400stringboot/0467springboot/blog.003.png)
...
![结构设计图](/images/0400stringboot/0467springboot/blog.004.jpeg "结构设计图")
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学生.jpg](/images/0400stringboot/0467springboot/blog.005.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\学生.jpg")
学生实体属性图

（2）下图是公告信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告信息.jpg](/images/0400stringboot/0467springboot/blog.006.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\公告信息.jpg")
公告信息实体属性图

（3）下图是选题审核实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\选题审核.jpg](/images/0400stringboot/0467springboot/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\选题审核.jpg")
选题审核实体属性图

（4）下图是项目申报实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\项目申报.jpg](/images/0400stringboot/0467springboot/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\项目申报.jpg")
项目申报实体属性图

（5）下图是指导教师实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\指导教师.jpg](/images/0400stringboot/0467springboot/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\指导教师.jpg")
指导教师实体属性图

（6）下图是项目进度实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\项目进度.jpg](/images/0400stringboot/0467springboot/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\项目进度.jpg")
项目进度实体属性图
...
|6|jiaoshi\_delete|Integer|逻辑删除|是|
|7|jiaoshi\_time|Date|入职时间|是|
...
|5|xiangmu\_jingfei|BigDecimal|项目经费|是|
|6|xiangmu\_file|String|项目文件|是|
|7|jiaoshi\_id|Integer|教师|是|
|8|xiangmu\_chuangxin|String|项目创新点|是|
|9|xiangmu\_text|String|项目实施方案|是|
|10|xiangmu\_content|String|项目详情|是|
|11|xiangmu\_yesno\_types|Integer|申报状态|是|
|12|xiangmu\_yesno\_text|String|申报结果|是|
|13|xiangmu\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xuantishenhe\_id|Integer|选题审核|是|
|3|xiangmujindu\_file|String|项目文件|是|
|4|xiangmujindu\_content|String|项目详情|是|
|5|xiangmujindu\_yesno\_types|Integer|进度审核|是|
|6|xiangmujindu\_yesno\_text|String|审核结果|是|
|7|xiangmujindu\_delete|Integer|逻辑删除|是|
...
|4|xuantishenhe\_yesno\_types|Integer|选题申请|是|
|5|xuantishenhe\_yesno\_text|String|申请结果|是|
|6|xuantishenhe\_delete|Integer|逻辑删除|是|
...
![](/images/0400stringboot/0467springboot/blog.013.png)
...
![](/images/0400stringboot/0467springboot/blog.014.png)
