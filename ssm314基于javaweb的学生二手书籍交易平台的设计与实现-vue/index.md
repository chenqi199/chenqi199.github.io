...
# [ssm314基于javaweb的学生二手书籍交易平台的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm314/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm314/blog.002.png)
...
![](/images/0300ssm/ssm314/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm314/blog.004.png)
...
![](/images/0300ssm/ssm314/blog.005.png)

图4.12 卖家信息实体属性图

（2）留言板实体属性图如图4.13所示：

![](/images/0300ssm/ssm314/blog.006.png)

图4.13   留言板实体属性图

（3）书籍分类实体属性图如图4.14所示：

![](/images/0300ssm/ssm314/blog.007.png)
...
![](/images/0300ssm/ssm314/blog.009.png)

图5.1 留言反馈管理界面
## 5.2 我的订单管理
用户登录可以在个人中心查看我的订单信息。具体界面如图5.2所示。

![](/images/0300ssm/ssm314/blog.010.png)

图5.2 我的订单管理界面
## 5.3 订单发货
卖家可以在已支付订单里面进行发货操作。界面如下图所示：

![](/images/0300ssm/ssm314/blog.011.png)
...
![](/images/0300ssm/ssm314/blog.012.png)

图5.4 我的收藏界面
## 5.5 书籍分类管理
管理员可以对书籍分类进行添加修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm314/blog.013.png)

图5.5 书籍分类管理界面
## 5.6 留言板管理
管理员可以对用户留言信息进行回复和删除操作。界面如下图所示：

![](/images/0300ssm/ssm314/blog.014.png)
