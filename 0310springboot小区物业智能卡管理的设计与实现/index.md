...
![](/images/0300stringboot/0310springboot/blog.001.png)

图3.1 操作流程图
### 3.2.2 登录流程
本系统的登录模块，其内部的流程见下图。主要对访问本系统的人员提供的验证信息进行逐个判断，系统面对录入错误的信息会给出提示，比如，提示账号不对，或提示密码不匹配等提示信息。总之，在登录页面填写的所有信息都符合要求，访问者就登录成功了。

![](/images/0300stringboot/0310springboot/blog.002.png)

图3.2 登录流程图
### 3.2.3 删除信息流程
本系统在经常性的使用后，会产生很多失去价值的信息，因此就需要及时清理数据，腾出系统的空间。对这些数据进行清理时，其对应的流程见下图。先选中要清理的数据，通过反复确认需要清理的数据，避免操作人员误删。已经删除的数据就不会出现在系统里面。

![](/images/0300stringboot/0310springboot/blog.003.png)

图3.3 删除信息流程图
### 3.2.4 添加信息流程
本系统主要用于显示信息，提供服务，其中，数据添加功能就是其中的服务之一，具体流程见下图。让操作者在信息添加的页面录入数据，待这些数据被提交检验合格后，就会在系统指定页面显示出来。

![](/images/0300stringboot/0310springboot/blog.004.png)
...
费用信息管理
## ![](/images/0300stringboot/0310springboot/blog.005.png)
4.3 数据库设计
...
![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\公告信息.jpg](/images/0300stringboot/0310springboot/blog.006.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\公告信息.jpg")
图4.1 公告信息实体属性图

（2）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\字典表.jpg](/images/0300stringboot/0310springboot/blog.007.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\字典表.jpg")
图4.2 字典表实体属性图

（3）下图是业主服务实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\业主服务.jpg](/images/0300stringboot/0310springboot/blog.008.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\业主服务.jpg")
图4.3 业主服务实体属性图

（4）下图是留言版实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\留言版.jpg](/images/0300stringboot/0310springboot/blog.009.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\留言版.jpg")
图4.4 留言版实体属性图

（5）下图是服务评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\服务评价.jpg](/images/0300stringboot/0310springboot/blog.010.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\服务评价.jpg")
图4.5 服务评价实体属性图

（6）下图是业主实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\业主.jpg](/images/0300stringboot/0310springboot/blog.011.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\业主.jpg")
图4.6 业主实体属性图

（7）下图是费用信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\费用信息.jpg](/images/0300stringboot/0310springboot/blog.012.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\费用信息.jpg")
图4.7 费用信息实体属性图

（8）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\用户表.jpg](/images/0300stringboot/0310springboot/blog.013.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\用户表.jpg")
图4.8 用户表实体属性图

（9）下图是停车登记实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\停车登记.jpg](/images/0300stringboot/0310springboot/blog.014.jpeg "C:\Users\Administrator\Desktop\img\xiaoquwuyezhinengka\停车登记.jpg")
图4.9 停车登记实体属性图
### 4.3.2 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|cheliangruku\_name|String|车辆单位|是|
|3|cheliangruku\_yanse|String|车辆颜色|是|
|4|cheliangruku\_types|Integer|车辆状态|是|
|5|churu\_types|Integer|出入类型|是|
|6|yonghu\_id|Integer|业主|是|
|7|cheliangruku\_time|Date|出入库时间|是|
|8|cheliangruku\_content|String|车辆详情|是|
|9|insert\_time|Date|记录时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|feiyong\_name|String|标题|是|
|3|feiyong\_types|Integer|费用类型|是|
|4|feiyong\_money|BigDecimal|涉及金额|是|
|5|yonghu\_id|Integer|业主|是|
|6|renyuan\_jieguo|String|收费结果|是|
|7|feiyong\_content|String|详情|是|
|8|create\_time|Date|创建时间|是|
表4.4留言版表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|业主|是|
|3|yezhufuwu\_name|String|服务标题|是|
|4|yezhufuwu\_types|Integer|服务类型|是|
|5|yezhufuwu\_content|String|详情|是|
|6|yezhufuwu\_yesno\_types|Integer|处理状态|是|
|7|yezhufuwu\_yesno\_text|String|处理结果|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yezhufuwu\_id|Integer|服务|是|
|3|yonghu\_id|Integer|用户|是|
|4|yezhufuwu\_commentback\_text|String|评价内容|是|
...
![](/images/0300stringboot/0310springboot/blog.017.png)
...
![](/images/0300stringboot/0310springboot/blog.018.png)
