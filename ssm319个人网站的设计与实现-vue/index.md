...
# [ssm319个人网站的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm319/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm319/blog.002.png)
...
![](/images/0300ssm/ssm319/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm319/blog.004.png)
...
![](/images/0300ssm/ssm319/blog.005.png)

图4.12 歌曲类型信息实体属性图

（2）博客实体属性图如图4.13所示：

![](/images/0300ssm/ssm319/blog.006.png)

图4.13   博客实体属性图

（3）留言板实体属性图如图4.14所示：

![](/images/0300ssm/ssm319/blog.007.png)
...
![](/images/0300ssm/ssm319/blog.010.png)

图5.1 用户注册界面
## 5.2 用户登录
用户需要登录才可以进行操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm319/blog.011.png)
...
![](/images/0300ssm/ssm319/blog.012.png)

图5.3 博客管理界面
## 5.4 相册管理
用户登录后可以对相册信息进行添加修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm319/blog.013.png)

图5.4 相册管理界面
## 5.5 音乐库
用户登录后可以对音乐库进行添加修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm319/blog.014.png)

图5.5 音乐库界面
## 5.6 下载列表
用户登录后可以对下载列表信息进行添加修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm319/blog.015.png)
