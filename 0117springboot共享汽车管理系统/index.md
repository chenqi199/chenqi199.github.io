...
## 3.4系统流程和逻辑
![](/images/0100stringboot/0117springboot/blog.001.png)

图3-3登录流程图

![](/images/0100stringboot/0117springboot/blog.002.png)
...
![](/images/0100stringboot/0117springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0100stringboot/0117springboot/blog.004.png)
...
![](/images/0100stringboot/0117springboot/blog.005.png)

图4.12  管理员信息实体属性图

（2）投放地区信息实体属性图如图4.13所示：

![](/images/0100stringboot/0117springboot/blog.006.png)

图4.13  投放地区信息实体属性图

（3）汽车信息实体属性图如图4.14所示：

![](/images/0100stringboot/0117springboot/blog.007.png)
...
![](/images/0100stringboot/0117springboot/blog.010.png)

图5.1 用户信息管理界面
### 5.1.2 投放地区管理
系统管理员可以对投放地区信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0100stringboot/0117springboot/blog.011.png)

图5.2 投放地区信息管理界面
### 5.1.3 汽车信息管理
系统管理员可以对汽车信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0100stringboot/0117springboot/blog.012.png)

图5.3 汽车信息管理界面
### 5.1.4 汽车入库管理
系统管理员可以对汽车入库进行添加修改删除操作。界面如下图所示：

![](/images/0100stringboot/0117springboot/blog.013.png)
...
![](/images/0100stringboot/0117springboot/blog.014.png)

图5.5 汽车投放界面
### 5.2.2 使用订单管理
用户可以在自己的使用订单里面进行支付操作。界面如下图所示：

![](/images/0100stringboot/0117springboot/blog.015.png)
...
![](/images/0100stringboot/0117springboot/blog.016.png)
