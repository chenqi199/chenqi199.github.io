...
# [ssm416医院管理系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0400ssm/ssm416/blog.001.png)
...
![](/images/0400ssm/ssm416/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0400ssm/ssm416/blog.006.png)
...
![](/images/0400ssm/ssm416/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是护士实体E-R图

![](/images/0400ssm/ssm416/blog.008.png)

图4.8 护士实体E-R图

（3）下图就是医生信息实体E-R图

![](/images/0400ssm/ssm416/blog.009.png)
...
![](/images/0400ssm/ssm416/blog.011.png)

图5.1 医生管理页面
## 5.2 护士管理
管理员可以对护士信息进行添加，删除，查询和修改操作。下图就是通讯录信息管理页面。

![](/images/0400ssm/ssm416/blog.012.png)

图5.2护士信息管理页面
## 5.3 病例管理
管理员可以对病例进行添加，查询，修改，删除操作。下图就是病例管理页面。

![](/images/0400ssm/ssm416/blog.013.png)

图5.3 病例管理页面
## 5.4 床位管理
管理员可以对床位进行添加，修改，删除操作。下图就是床位管理页面。

![](/images/0400ssm/ssm416/blog.014.png)

图5.4 床位管理页面
## 5.5 患者住院房屋管理
管理员可以对患者住院房屋进行添加，查询，修改，删除操作。下图就是患者住院房屋管理页面。

![](/images/0400ssm/ssm416/blog.015.png)
...
![](/images/0400ssm/ssm416/blog.016.png)
...
![](/images/0400ssm/ssm416/blog.017.png)
...
![](/images/0400ssm/ssm416/blog.018.png)
...
![](/images/0400ssm/ssm416/blog.019.png)
