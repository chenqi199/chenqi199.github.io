...
# [ssm603阅微文学网站的设计与开发+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm603/blog.001.png)

图3-1 程序操作流程图

程序处理数据会涉及到数据的录入环节，绘制的添加流程见下图。程序录入数据过程中，始终与数据库保持同步。

![](/images/0600ssm/ssm603/blog.002.png)

图3-2 信息添加流程图

程序里面的数据也会出现错误，因此就有相应的修改数据的功能，绘制的程序修改流程见下图。此过程也是跟后台数据库进行数据同步显示。

![](/images/0600ssm/ssm603/blog.003.png)

图3-3信息修改流程图

程序数据存放于数据仓库，有时也会涉及到数据删除，此过程对应的流程图见下图。数据信息被删除之后，数据库里面也就没有了该数据信息了。

![](/images/0600ssm/ssm603/blog.004.png)
...
![](/images/0600ssm/ssm603/blog.005.png)
...
删文学信息删除
![](/images/0600ssm/ssm603/blog.006.png)
...
![C:\Users\Administrator\Desktop\img\wenxuewang\用户.jpg](/images/0600ssm/ssm603/blog.007.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\用户.jpg")
图4.1 用户实体属性图

（2）下图是作者实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\作者.jpg](/images/0600ssm/ssm603/blog.008.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\作者.jpg")
图4.2 作者实体属性图

（3）下图是文学留言实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\文学留言.jpg](/images/0600ssm/ssm603/blog.009.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\文学留言.jpg")
图4.3 文学留言实体属性图

（4）下图是文学购买实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\文学购买.jpg](/images/0600ssm/ssm603/blog.010.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\文学购买.jpg")
图4.4 文学购买实体属性图

（5）下图是章节实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\章节.jpg](/images/0600ssm/ssm603/blog.011.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\章节.jpg")
图4.5 章节实体属性图

（6）下图是论坛实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\论坛.jpg](/images/0600ssm/ssm603/blog.012.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\论坛.jpg")
图4.6 论坛实体属性图

（7）下图是文学实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\文学.jpg](/images/0600ssm/ssm603/blog.013.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\文学.jpg")
图4.7 文学实体属性图

（8）下图是书架实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\书架.jpg](/images/0600ssm/ssm603/blog.014.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\书架.jpg")
图4.8 书架实体属性图

（9）下图是阅读记录管理实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\wenxuewang\阅读记录管理.jpg](/images/0600ssm/ssm603/blog.015.jpeg "C:\Users\Administrator\Desktop\img\wenxuewang\阅读记录管理.jpg")
图4.9 阅读记录管理实体属性图
...
![](/images/0600ssm/ssm603/blog.016.png)

![](/images/0600ssm/ssm603/blog.017.png)

图5-1 文学信息管理页面
### 5.1.2 书架信息管理
书架信息管理页面提供的功能操作有：新增书架，修改书架，删除书架操作。下图就是书架信息管理页面。

![](/images/0600ssm/ssm603/blog.018.png)

![](/images/0600ssm/ssm603/blog.019.png)

图5.3 书架信息管理页面
### 5.1.3文学信息类型管理
文学信息类型管理页面显示所有文学信息类型，在此页面既可以让管理员添加新的文学信息信息类型，也能对已有的文学信息类型信息执行编辑更新，失效的文学信息类型信息也能让管理员快速删除。下图就是文学信息类型管理页面。

![](/images/0600ssm/ssm603/blog.020.png)

![](/images/0600ssm/ssm603/blog.021.png)
