...
# [ssm194线上学习网站+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0100ssm/ssm194/blog.001.png)

图3-3登录流程图

![](/images/0100ssm/ssm194/blog.002.png)
...
![](/images/0100ssm/ssm194/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0100ssm/ssm194/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的教师功能结构图如下图所示：

![](/images/0100ssm/ssm194/blog.005.png)

图4-3 教师功能结构图

本系统是基于B/S架构的网站系统，设计的学生功能结构图如下图所示：

![](/images/0100ssm/ssm194/blog.006.png)
...
![](/images/0100ssm/ssm194/blog.007.png)

图4.5管理员信息实体属性图

（2）教师信息实体属性图如图4.6所示：

![](/images/0100ssm/ssm194/blog.008.png)

图4.6教师信息实体属性图

（3）学生信息实体属性图如图4.7所示：

![](/images/0100ssm/ssm194/blog.009.png)
...
![](/images/0100ssm/ssm194/blog.011.png)

图5.1 学生信息管理界面
### 5.1.2 教师信息管理
系统管理员可以教师信息进行添加，修改，删除操作。具体界面如图5.2所示。

![](/images/0100ssm/ssm194/blog.012.png)
...
![](/images/0100ssm/ssm194/blog.013.png)
...
![](/images/0100ssm/ssm194/blog.014.png)
...
![](/images/0100ssm/ssm194/blog.015.png)

图5.5 首页课程界面
### 5.3.2 试卷列表
学生登录后可以在首页试卷列表找到对应的试卷，并可以参考考试。界面如下图所示：

![](/images/0100ssm/ssm194/blog.016.png)
