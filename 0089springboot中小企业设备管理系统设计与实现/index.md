...
# [0089springboot中小企业设备管理系统设计与实现](https://github.com/GraduationProject-springboot/0089springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=90)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0089springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0089springboot/blog.002.png)
...
![](/images/0000stringboot/0089springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0000stringboot/0089springboot/blog.004.png)
...
![](/images/0000stringboot/0089springboot/blog.005.png)

图4.12  用户信息信息实体属性图

（2）设备类型信息实体属性图如图4.13所示：

![](/images/0000stringboot/0089springboot/blog.006.png)

图4.13  设备类型信息实体属性图

（3）管理员信息实体属性图如图4.14所示：

![](/images/0000stringboot/0089springboot/blog.007.png)
...
|peijianbianhao|varchar(200)|是|NULL|配件编号|
...
|zuoyongmiaoshu|longtext|是|NULL|作用描述|
|jiage|int(11)|是|NULL|价格|
...
|shebeileixing|varchar(200)|是|NULL|设备类型|
|anzhuangneirong|longtext|是|NULL|安装内容|
|diaoshijieguo|longtext|是|NULL|调试结果|
|anzhuangshijian|date|是|NULL|安装时间|
...
|shebeimingcheng|varchar(200)|是|NULL|设备名称|
|shebeileixing|varchar(200)|是|NULL|设备类型|
|sunhuaiqingkuang|longtext|是|NULL|损坏情况|
...
|shebeimingcheng|varchar(200)|是|NULL|设备名称|
|shebeileixing|varchar(200)|是|NULL|设备类型|
|dianjianxiangmu|varchar(200)|是|NULL|点检项目|
|dianjianneirong|longtext|是|NULL|点检内容|
|dianjianriqi|date|是|NULL|点检日期|
|gonghao|varchar(200)|是|NULL|工号|
|yuangongxingming|varchar(200)|是|NULL|员工姓名|
表4.6 设备改造
...
|shebeimingcheng|varchar(200)|是|NULL|设备名称|
|shebeileixing|varchar(200)|是|NULL|设备类型|
|gaizaoyuanyin|longtext|是|NULL|改造原因|
|gaizaoneirong|longtext|是|NULL|改造内容|
|yanshouqingkuang|longtext|是|NULL|验收情况|
|riqi|date|是|NULL|日期|
|gonghao|varchar(200)|是|NULL|工号|
|yuangongxingming|varchar(200)|是|NULL|员工姓名|
表4.7 设备购买
...
|shebeimingcheng|varchar(200)|是|NULL|设备名称|
|shebeileixing|varchar(200)|是|NULL|设备类型|
|runhuabuwei|varchar(200)|是|NULL|润滑部位|
|runhuayouzhonglei|varchar(200)|是|NULL|润滑油种类|
|jiayouliang|varchar(200)|是|NULL|加油量|
|runhuazhouqi|varchar(200)|是|NULL|润滑周期|
|gonghao|varchar(200)|是|NULL|工号|
|yuangongxingming|varchar(200)|是|NULL|员工姓名|
表4.10 设备信息
...
|shebeijianjie|longtext|是|NULL|设备简介|
|jiage|int(11)|是|NULL|价格|
|xiangqing|longtext|是|NULL|详情|
|dengjishijian|date|是|NULL|登记时间|
表4.11 事务报警
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|baojingxiangmu|varchar(200)|是|NULL|报警项目|
|baojingshijian|date|是|NULL|报警时间|
|baojingyuanyin|longtext|是|NULL|报警原因|
|chuliqingkuang|longtext|是|NULL|处理情况|
...
![](/images/0000stringboot/0089springboot/blog.009.png)

图5.1 用户信息管理界面
## 5.2 员工信息管理
管理员可以对员工信息进行添加修改删除操作。具体界面如图5.2所示。

![](/images/0000stringboot/0089springboot/blog.010.png)

图5.2 员工信息界面
## 5.3 设备信息管理
管理员可以对设备信息添加修改删除操作。界面如下图所示：

![](/images/0000stringboot/0089springboot/blog.011.png)

图5.3 设备信息界面
## 5.4 配件信息管理
管理员可以对配件信息进行添加修改删除。界面如下图所示：

![](/images/0000stringboot/0089springboot/blog.012.png)
...
![](/images/0000stringboot/0089springboot/blog.013.png)
