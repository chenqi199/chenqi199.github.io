...
# [ssm117网络教学平台的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0100ssm/ssm117/blog.002.png)
...
![](/images/0100ssm/ssm117/blog.003.png)
...
![](/images/0100ssm/ssm117/blog.006.png)

图3-4  用户注册流程图
### 3.4.2登录流程
登录模块主要满足了学生、教师以及管理员的权限登录，学生登录流程图如图3-5所示。

![](/images/0100ssm/ssm117/blog.007.png)

图 3-5 学生登录流程图
### 3.4.3添加信息流程
管理员、教师和学生登录后均可进行信息的添加操作，添加信息流程图如图3-6所示。

![](/images/0100ssm/ssm117/blog.008.png)
...
![](/images/0100ssm/ssm117/blog.011.png)
...
![](/images/0100ssm/ssm117/blog.012.png)
...
![](/images/0100ssm/ssm117/blog.013.png)
...
![](/images/0100ssm/ssm117/blog.014.png)

图4-6  试卷实体属性E-R图

（2）试题实体属性E-R图如图4-7所示。

![](/images/0100ssm/ssm117/blog.015.png)

图4-7 试题实体属性E-R图

（3）管理员实体属性E-R图如图4-8所示。

![](/images/0100ssm/ssm117/blog.016.png)

图4-8  管理员实体属性E-R图

（4）教师实体属性E-R图如图4-9所示。

![](/images/0100ssm/ssm117/blog.017.png)

图4-9   教师实体属性E-R图

（5）学生实体属性E-R图如图4-10所示。

![](/images/0100ssm/ssm117/blog.018.png)
...
![](/images/0100ssm/ssm117/blog.025.png)

图5-7 管理员登录界面图
### 5.2.2 学生管理界面
管理在学生管理界面可查看所有学生信息，并可对其进行修改和删除操作，学生管理界面展示如图5-8所示。

![](/images/0100ssm/ssm117/blog.026.png)

图5-8 学生管理界面图
### 5.2.3 教师管理界面
管理员可增删改查教师信息，教师管理界面展示如图5-9所示。

![](/images/0100ssm/ssm117/blog.027.png)

图5-9 教师管理界面图
### 5.2.4 教学资源管理界面
管理员可增删改查教学资源信息，教学资源管理界面如图5-10所示。

![](/images/0100ssm/ssm117/blog.028.png)
...
![](/images/0100ssm/ssm117/blog.029.png)

图5-11 个人信息界面图
### 5.3.2 课堂信息管理界面
教师可增删改查课堂信息，课堂信息管理界面展示如图5-12所示。

![](/images/0100ssm/ssm117/blog.030.png)

图5-12 课堂信息管理界面图
### 5.3.3 签到信息管理界面
教师可增删改查签到信息，签到信息管理界面展示如图5-13所示。

![](/images/0100ssm/ssm117/blog.031.png)

图5-13 签到信息管理界面图
### 5.3.4 试题管理界面
教师可增删改查试题信息，试题管理界面展示如图5-14所示。

![](/images/0100ssm/ssm117/blog.032.png)
