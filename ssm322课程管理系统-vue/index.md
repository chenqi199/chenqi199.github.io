...
# [ssm322课程管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm322/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm322/blog.002.png)
...
![](/images/0300ssm/ssm322/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm322/blog.004.png)
...
![](/images/0300ssm/ssm322/blog.005.png)

图4.12  学生信息实体属性图

（2）校园公告信息实体属性图如图4.13所示：

![](/images/0300ssm/ssm322/blog.006.png)

图4.13  校园公告信息实体属性图

（3）管理员信息信息实体属性图如图4.14所示：

![](/images/0300ssm/ssm322/blog.007.png)
...
![](/images/0300ssm/ssm322/blog.009.png)

图5.1 学生信息管理界面
### 5.1.2 教师信息管理
系统管理员可以查看对教师信息信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm322/blog.010.png)
...
![](/images/0300ssm/ssm322/blog.011.png)

图5.3 在线报名信息管理界面
### 5.2.1 老师课程管理
老师可以在老师课程管理里面查看属于自己的课程。界面如下图所示：

![](/images/0300ssm/ssm322/blog.012.png)
...
![](/images/0300ssm/ssm322/blog.013.png)

图5.5 学生请假界面
### 5.2.3 学生请假管理
学生登录后可以在学生请假管理查看自己的请假信息是否被审核通过和历史请假信息，并且可以删除操作。界面如下图所示：

![](/images/0300ssm/ssm322/blog.014.png)
