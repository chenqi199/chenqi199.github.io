...
# [0142springboot在线家具商城设计与实现--论文pf](https://github.com/GraduationProject-springboot/0142springboot)
...
![](/images/0100stringboot/0142springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0100stringboot/0142springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0100stringboot/0142springboot/blog.003.png)
...
![](/images/0100stringboot/0142springboot/blog.004.png)
...
![C:\Users\Administrator\Desktop\img\jiajushangcheng\用户.jpg](/images/0100stringboot/0142springboot/blog.005.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\用户.jpg")
图4.1 用户实体属性图

（2）下图是商品信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\商品信息.jpg](/images/0100stringboot/0142springboot/blog.006.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\商品信息.jpg")
图4.2 商品信息实体属性图

（3）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\字典表.jpg](/images/0100stringboot/0142springboot/blog.007.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\字典表.jpg")
图4.3 字典表实体属性图

（4）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\购物车.jpg](/images/0100stringboot/0142springboot/blog.008.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\购物车.jpg")
图4.4 购物车实体属性图

（5）下图是商品评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\商品评价.jpg](/images/0100stringboot/0142springboot/blog.009.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\商品评价.jpg")
图4.5 商品评价实体属性图

（6）下图是商品订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\商品订单.jpg](/images/0100stringboot/0142springboot/blog.010.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\商品订单.jpg")
图4.6 商品订单实体属性图

（7）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\用户表.jpg](/images/0100stringboot/0142springboot/blog.011.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\用户表.jpg")
图4.7 用户表实体属性图

（8）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\收货地址.jpg](/images/0100stringboot/0142springboot/blog.012.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\收货地址.jpg")
图4.8 收货地址实体属性图

（9）下图是新闻信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiajushangcheng\新闻信息.jpg](/images/0100stringboot/0142springboot/blog.013.jpeg "C:\Users\Administrator\Desktop\img\jiajushangcheng\新闻信息.jpg")
图4.9 新闻信息实体属性图
### 4.3.2 数据库物理设计
...
![](/images/0100stringboot/0142springboot/blog.014.png)

![](/images/0100stringboot/0142springboot/blog.015.png)

图5.1 用户信息管理页面
### 5.2 商品信息管理
如图5.2显示的就是商品信息管理页面，此页面提供给管理员的功能有：查看已发布的商品信息数据，修改商品信息，商品信息作废，即可删除，还进行了对商品信息名称的模糊查询 商品信息信息的类型查询等等一些条件。

![](/images/0100stringboot/0142springboot/blog.016.png)

![](/images/0100stringboot/0142springboot/blog.017.png)

图5.2 商品信息管理页面
### 5.3商品评论管理
如图5.3显示的就是商品评论管理页面，此页面提供给管理员的功能有：根据商品评论进行条件查询，还可以对商品评论进行新增、修改、查询操作等等。

![](/images/0100stringboot/0142springboot/blog.018.png)

![](/images/0100stringboot/0142springboot/blog.019.png)

图5.3 商品评论管理页面
### 5.1新闻信息管理
如图5.4显示的就是新闻信息管理页面，此页面提供给管理员的功能有：根据新闻信息进行新增、修改、查询操作等等。

![](/images/0100stringboot/0142springboot/blog.020.png)

![](/images/0100stringboot/0142springboot/blog.021.png)
