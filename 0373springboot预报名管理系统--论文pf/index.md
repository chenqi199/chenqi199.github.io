...
![](/images/0300stringboot/0373springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0300stringboot/0373springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0300stringboot/0373springboot/blog.003.png)
...
![结构设计图](/images/0300stringboot/0373springboot/blog.004.jpeg "结构设计图")
...
![](/images/0300stringboot/0373springboot/blog.005.png "IMG\_256")
论坛实体属性图

（2）下图是公共资料留言实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.006.png "IMG\_257")
公共资料留言实体属性图

（3）下图是报考活动留言实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.007.png "IMG\_258")
报考活动留言实体属性图

（4）下图是用户实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.008.png "IMG\_259")
用户实体属性图

（5）下图是报考活动收藏实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.009.png "IMG\_260")
报考活动收藏实体属性图

（6）下图是公告资讯实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.010.png "IMG\_261")
公告资讯实体属性图

（7）下图是活动报名实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.011.png "IMG\_262")
活动报名实体属性图

（8）下图是公共资料实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.012.png "IMG\_263")
公共资料实体属性图

（9）下图是公共资料收藏实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.013.png "IMG\_264")
公共资料收藏实体属性图

（10）下图是报考活动实体和其具备的属性。

![](/images/0300stringboot/0373springboot/blog.014.png "IMG\_265")
报考活动实体属性图
...
![](/images/0300stringboot/0373springboot/blog.017.png)

图5.3 报考活动管理页面
### 5.1公告信息管理
如图5.4显示的就是公告信息管理页面，此页面提供给管理员的功能有：根据公告信息进行新增、修改、查询操作等等。

![](/images/0300stringboot/0373springboot/blog.018.png)
