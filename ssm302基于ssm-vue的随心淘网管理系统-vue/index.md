...
# [ssm302基于SSM+Vue的随心淘网管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm302/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm302/blog.002.png)
...
![](/images/0300ssm/ssm302/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm302/blog.004.png)
...
![](/images/0300ssm/ssm302/blog.005.png)

图4.12 在线客服信息实体属性图

（2）通知公告实体属性图如图4.13所示：

![](/images/0300ssm/ssm302/blog.006.png)

图4.13   通知公告实体属性图

（3）商品分类实体属性图如图4.14所示：

![](/images/0300ssm/ssm302/blog.007.png)
...
![](/images/0300ssm/ssm302/blog.010.png)

图5.1 用户管理界面
### 5.1.2 会员信息管理
系统管理员可以对会员进行添加修改删除审核进行管理操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm302/blog.011.png)

图5.2 会员信息管理界面
### 5.1.3 商品信息管理
系统管理员可以对商品信息进行添加修改删除操作。界面如下图所示：

![](/images/0300ssm/ssm302/blog.012.png)
...
![](/images/0300ssm/ssm302/blog.013.png)

图5.4 首页界面
### 5.2.2 商品购买管理
用户登录可以对商品进行立即购买还是添加购物车操作。界面如下图所示：

![](/images/0300ssm/ssm302/blog.014.png)

图5.5 商品购买操作界面
### 5.2.3 我的订单
用户登录后可以在个人中心我的订单里面查看我的订单。界面如下图所示：

![](/images/0300ssm/ssm302/blog.015.png)
