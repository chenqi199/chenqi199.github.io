...
# [ssm039基于Java的菜匣子优选系统设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0000ssm/ssm039/blog.002.png)

图3-1 管理员用例图
### 3.4.2用户用例
用户注册登录后可进行主页、个人中心、我的收藏管理、订单管理，用户用例如图3-2所示。

![](/images/0000ssm/ssm039/blog.003.png)
...
![](/images/0000ssm/ssm039/blog.007.png)
...
![](/images/0000ssm/ssm039/blog.008.png)

图4-2 登录结构图

这些功能可以充分满足菜匣子优选生鲜电商系统的需求。此系统功能较为全面如下图系统功能结构如图4-4所示。

![](/images/0000ssm/ssm039/blog.009.png)
...
![](/images/0000ssm/ssm039/blog.010.png)

`    `图4.6商品信息E-R图

用户信息E-R图，如图4.7所示。

![](/images/0000ssm/ssm039/blog.011.png)
...
![](/images/0000ssm/ssm039/blog.012.png)

图5-6管理员登录页面

![](/images/0000ssm/ssm039/blog.013.png)
...
![](/images/0000ssm/ssm039/blog.021.png)
...
![](/images/0000ssm/ssm039/blog.022.png)
...
![](/images/0000ssm/ssm039/blog.023.png)

图5-17系统首页界面图

登录、注册，通过注册填写用户账号、用户姓名、密码、联系电话、电子邮箱等信息进行注册操作，如图5-18所示。

![](/images/0000ssm/ssm039/blog.024.png)

![](/images/0000ssm/ssm039/blog.025.png)
...
![](/images/0000ssm/ssm039/blog.026.png)

图5-20个人中心界面图

收货地址添加，在收货地址添加页面可以查看个人中心、我的订单、我的地址、我的收藏等如图5-21所示。

![](/images/0000ssm/ssm039/blog.027.png)
...
![](/images/0000ssm/ssm039/blog.028.png)
