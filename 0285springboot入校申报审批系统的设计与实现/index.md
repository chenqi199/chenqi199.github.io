...
![](/images/0200stringboot/0285springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0200stringboot/0285springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0200stringboot/0285springboot/blog.003.png)
...
![](/images/0200stringboot/0285springboot/blog.004.png)
...
![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\用户.jpg](/images/0200stringboot/0285springboot/blog.005.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\用户.jpg")
图4.1 用户实体属性图

（2）下图是入校检查实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\入校检查.jpg](/images/0200stringboot/0285springboot/blog.006.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\入校检查.jpg")
图4.2 入校检查实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\公告信息.jpg](/images/0200stringboot/0285springboot/blog.007.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\字典表.jpg](/images/0200stringboot/0285springboot/blog.008.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是入校申报实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\入校申报.jpg](/images/0200stringboot/0285springboot/blog.009.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\入校申报.jpg")
图4.5 入校申报实体属性图

（6）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\用户表.jpg](/images/0200stringboot/0285springboot/blog.010.jpeg "C:\Users\Administrator\Desktop\img\ruxiaoshenbaoshenpi\用户表.jpg")
图4.6 用户表实体属性图
### 4.3.2 数据库物理设计
...
![](/images/0200stringboot/0285springboot/blog.013.png)
...
![](/images/0200stringboot/0285springboot/blog.014.png)
