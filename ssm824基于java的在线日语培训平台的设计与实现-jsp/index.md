...
# [ssm824基于Java的在线日语培训平台的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0800ssm/ssm824/blog.005.png)

图3-5 管理员用例图

用户用例图的绘制结果见图3-6。用户登录进入本系统操作的功能包括购买课程，观看购买课程的视频，收藏课程，查看公告等。

![](/images/0800ssm/ssm824/blog.006.png)
...
![](/images/0800ssm/ssm824/blog.007.png)

图4-1 管理员功能结构图

用户功能结构图的绘制结果见图4-2。用户登录进入本系统操作的功能包括购买课程，观看购买课程的视频，收藏课程，查看公告等。

![](/images/0800ssm/ssm824/blog.008.png)
...
![](/images/0800ssm/ssm824/blog.009.png)

图4-3 课程留言实体属性图

（2）使用Visio这样的常用的实体属性图绘制工具来绘制课程实体属性图，绘制结果见图4-4。

![](/images/0800ssm/ssm824/blog.010.png)

图4-4 课程实体属性图

（3）使用Visio这样的常用的实体属性图绘制工具来绘制用户实体属性图，绘制结果见图4-5。

![](/images/0800ssm/ssm824/blog.011.png)

图4-5用户实体属性图

（4）使用Visio这样的常用的实体属性图绘制工具来绘制课程购买订单实体属性图，绘制结果见图4-6。

![](/images/0800ssm/ssm824/blog.012.png)

图4-6 课程购买订单实体属性图

（5）绘制的上述实体间存在的联系见图4-7。

![](/images/0800ssm/ssm824/blog.013.png)
