...
# [ssm516基于HTML和JS物资物流系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm516/blog.005.png)

图3-5 管理员用例图

司机用例图的绘制结果见图3-6。司机登录进入本系统操作的功能包括查看车辆，查看承运任务信息，查看公告，更改密码和个人信息。

![](/images/0500ssm/ssm516/blog.006.png)
...
![](/images/0500ssm/ssm516/blog.007.png)

图4-1 管理员功能结构图

司机功能结构图的绘制结果见图4-2。司机登录进入本系统操作的功能包括查看车辆，查看承运任务信息，查看公告，更改密码和个人信息。

![](/images/0500ssm/ssm516/blog.008.png)
...
![](/images/0500ssm/ssm516/blog.009.png)

图4-3 司机实体属性图

（2）使用Visio这样的常用的实体属性图绘制工具来绘制管理员实体属性图，绘制结果见图4-4。

![](/images/0500ssm/ssm516/blog.010.png)

图4-4 管理员实体属性图

（3）使用Visio这样的常用的实体属性图绘制工具来绘制承运任务实体属性图，绘制结果见图4-5。

![](/images/0500ssm/ssm516/blog.011.png)

图4-5 承运任务实体属性图

（4）使用Visio这样的常用的实体属性图绘制工具来绘制车辆实体属性图，绘制结果见图4-6。

![](/images/0500ssm/ssm516/blog.012.png)

图4-6 车辆实体属性图

（5）绘制的上述实体间存在的联系见图4-7。

![](/images/0500ssm/ssm516/blog.013.png)
