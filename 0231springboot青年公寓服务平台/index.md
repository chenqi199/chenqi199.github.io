...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1EbH&bvid=BV1jqaLe1EbH&cid=500001610879925&p=2)
...
[4.3 数据库设计 10](#__RefHeading___Toc25055)

[4.3.1 数据库设计 10](#__RefHeading___Toc14727)

[4.3.2 数据库E-R 图 10](#__RefHeading___Toc7730)
...
[5.1.2 房屋投诉信息管理 15](#房屋投诉信息管理)

[5.1.3 房屋投诉类型管理 16](#房屋投诉类型管理)
...
[6.4.2 添加房屋投诉类别测试 18](#添加房屋投诉类别测试)

[6.5测试结果 18](#测试结果)

[结 论 19](#结-论)

[参考文献 21](#__RefHeading___Toc4429)
...
B/S结构实际上就是Browser/Server（浏览器/服务器）的缩写，B/S结构是目前软件开发中的主流结构，大多数软件开发者都采用B/S这样的三层体系结构。采用B/S结构开发的青年公寓服务平台能够大大方便用户使用操作，用户随时随地都可以进行青年公寓服务平台的访问操作，只需要用户拥有一台会连上网络的计算机就行了，并且使用B/S
模式开发的青年公寓服务平台是基于浏览器的操作方式，在与用户进行交互以及程序的表现方式上面将会更加吸引人，这样的模式也给程序员开发程序降低了难度，程序开发成本也会相应缩减不少。我们在使用青年公寓服务平台期间，系统也会随着用户需求进行完善升级，使用B/S
模式开发的青年公寓服务平台就完全不需要担心，因为它的升级速度快，升级产生的成本费用很低，大多依赖于用户自己在网络上下载最新版本进行安装完成程序更新。下图为B/S结构图。
...
AB公司在很早之前就收购过一个关系型数据库，它是现在的Mysql数据库。所以青年公寓服务平台后台数据库使用的是MySQL进行数据库方面的开发工作的，MySQL它是微软开发的一款平台软件，这个软件可以给用户提供高效率的智能数据，并且数据信息还是很可靠，使用它进行数据存储可以满足大众企业管理各种各样的数据信息的需求。MySQL在MySQL版本里面它是最全面的，也是最强大的开发平台，
...
![](media/image6.jpeg){width="6.098611111111111in"
height="2.1951388888888888in"}\
图4.3 用户实体属性图

（4）下图是博客实体和其具备的属性。

![](media/image7.jpeg){width="6.098611111111111in"
height="2.1951388888888888in"}\
图4.4 博客实体属性图

（5）下图是博客留言实体和其具备的属性。

![](media/image8.jpeg){width="6.1in" height="2.4881944444444444in"}\
图4.5 博客留言实体属性图

（6）下图是预约看房实体和其具备的属性。

![](media/image9.jpeg){width="6.1in" height="2.3784722222222223in"}\
图4.6 预约看房实体属性图
...
![](media/image11.jpeg){width="6.100694444444445in"
height="2.301388888888889in"}\
图4.8 房屋投诉实体属性图

（9）下图是房屋收藏实体和其具备的属性。

![](media/image12.jpeg){width="6.1in" height="2.6534722222222222in"}\
图4.9 房屋收藏实体属性图

（10）下图是商家实体和其具备的属性。

![](media/image13.jpeg){width="6.100694444444445in"
height="2.301388888888889in"}\
图4.10 商家实体属性图
...
![](media/image14.png){width="6.097222222222222in"
...
![](media/image15.png){width="6.089583333333334in" height="3.125in"}
...
![](media/image16.png){width="6.095833333333333in"
...
青年公寓服务平台的测试选用的测试平台是IDEA平台环境，测试时首先需要用户打开MySQL数据库进行数据库文件的附加操作，然后打开IDEA，选择文件打开网站，把青年公寓服务平台的程序添加进入IDEA平台中，接着把文件部署到tomcat服务器里面，最后运行程序，这时用户可以操作系统里面的各个功能，看看程序有没有达到用户的要求。
...
\[13\]刘小华,化琼珍.青年公寓服务平台的构建\[J\].物流技术与应用,2015(03):100-101.

\[14\]王锋.青年公寓服务平台构建的研究\[J\].商场现代化,2016(24):35-36.

\[15\]王育才.青年公寓服务平台构建的分析\[J\].中国管理信息化,2017,20(22):54-55.
...
### 0231springboot青年公寓服务平台 项目图片
![图片](/images/0231springbootimg_014.jpg)
![图片](/images/0231springbootimg_001.jpg)
![图片](/images/0231springbootimg_003.jpg)
![图片](/images/0231springbootimg_002.jpg)
![图片](/images/0231springbootimg_012.jpg)
![图片](/images/0231springbootimg_006.jpg)
![图片](/images/0231springbootimg_007.jpg)
![图片](/images/0231springbootimg_013.jpg)
![图片](/images/0231springbootimg_005.jpg)
![图片](/images/0231springbootimg_011.jpg)
![图片](/images/0231springbootimg_010.jpg)
![图片](/images/0231springbootimg_004.jpg)
![图片](/images/0231springbootimg_009.jpg)
![图片](/images/0231springbootimg_008.jpg)
