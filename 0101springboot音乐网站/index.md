...
# [0101springboot音乐网站](https://github.com/GraduationProject-springboot/0101springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610719942&p=2)
...
Boot框架，MYSQL数据库设计开发，充分保证系统的稳定性。系统具有界面清晰、操作简单，功能齐全的特点，使得音乐网站管理工作系统化、规范化。本系统的使用使管理人员从繁重的工作中解脱出来，实现无纸化办公，能够有效的提高音乐网站管理效率。
...
process of music website development. By analyzing the deficiencies of
music website management, a program for computer management of music
websites was created. The article introduces the system analysis part of
the music website, including feasibility analysis, etc. The system
design part mainly introduces the system function design and database
design.

The administrator functions of this music website include personal
center, user management, song classification management, song
information management, administrator management, system management,
etc. Users can register and log in, listen to songs, and download songs.
...
operation and complete functions, which makes the management of music
websites systematized and standardized. The use of this system frees
managers from heavy work, realizes a paperless office, and can
effectively improve the efficiency of music website management.

**Keywords:**Music website; Spring Boot framework; MYSQL database

目录

[1系统概述 1](#系统概述)

[1.1 研究背景 1](#__RefHeading___Toc31167)

[1.2研究目的 1](#__RefHeading___Toc19841)
...
[3.3系统界面分析 6](#__RefHeading___Toc18544)
...
[5.1 管理员模块的实现 13](#管理员模块的实现)

[5.1.1 用户信息管理 13](#用户信息管理)

[5.1.2 歌曲分类管理 14](#歌曲分类管理)

[5.1.3 歌曲信息管理 14](#歌曲信息管理)

[5.1.4 轮播图管理 15](#轮播图管理)

[5.2 用户模块的实现 16](#用户模块的实现)
...
[]{#__RefHeading___Toc31167 .anchor}1.1 研究背景
...
[]{#__RefHeading___Toc19841 .anchor}1.2研究目的
...
通过对本音乐网站实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。

### 3.1.1技术可行性

本音乐网站采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
因此，音乐网站在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。

### 3.1.2经济可行性

本音乐网站采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。

### 3.1.3操作可行性

本音乐网站的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。
...
此音乐网站要严格控制管理权限，具体要求如下：

（1）要想对音乐网站进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
[]{#__RefHeading___Toc18544 .anchor}3.3系统界面分析
...
![](media/image9.png){width="6.373611111111111in"
...
![](media/image15.png){width="4.09375in" height="5.09375in"}
...
经过对上述测试结果分析，本系统符合用户需求。所有基本功能点实现，操作简单，操作流程简单合理，产品运行性能良好，是一款值得推广的音乐网站。
...
首先我要感谢此次指导我的老师，是他的及时纠正我在设计当中出现的问题，使得我的设计高质量完成。指导老师在我本次音乐网站的开发过程中，为程序、框架的设计、代码等方面以及论文设计提供了很多宝贵的意见，并且为我推荐了许多相关的资料，他的指导和建议使我受益匪浅，通过老师的耐心辅导和指点，我的论文顺利完成，在此，我表示深刻的感谢。
...
### 0101springboot音乐网站 项目图片
![图片](/images/0101springbootimg_001.jpg)
![图片](/images/0101springbootimg_003.jpg)
![图片](/images/0101springbootimg_002.jpg)
![图片](/images/0101springbootimg_012.jpg)
![图片](/images/0101springbootimg_006.jpg)
![图片](/images/0101springbootimg_007.jpg)
![图片](/images/0101springbootimg_013.jpg)
![图片](/images/0101springbootimg_005.jpg)
![图片](/images/0101springbootimg_011.jpg)
![图片](/images/0101springbootimg_010.jpg)
![图片](/images/0101springbootimg_004.jpg)
![图片](/images/0101springbootimg_009.jpg)
![图片](/images/0101springbootimg_008.jpg)
