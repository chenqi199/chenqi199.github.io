...
# [ssm287二手车交易网站设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0200ssm/ssm287/blog.001.png)
...
![](/images/0200ssm/ssm287/blog.002.png)

图3.2 注册流程图

访问者操作系统，前提是需要验证身份，而登录功能的设置就是把本系统的用户引导进入后台操作区，把不是本系统的用户拒之门外。其流程见下图。

![](/images/0200ssm/ssm287/blog.003.png)
...
![](/images/0200ssm/ssm287/blog.004.png)

图3.4 管理员用例图

二手车交易网站设置了用户权限，其用例图见下图。用户查看汽车资讯，收藏汽车，评论汽车，购买汽车，查看不同状态的订单。

![](/images/0200ssm/ssm287/blog.005.png)
...
![](/images/0200ssm/ssm287/blog.006.png)

图4.1 管理员功能结构图

设计的用户的详细功能见下图，用户查看汽车资讯，收藏汽车，评论汽车，购买汽车，查看不同状态的订单。

![](/images/0200ssm/ssm287/blog.007.png)
...
![](/images/0200ssm/ssm287/blog.008.png)

图4.4 订单实体属性图

（2）设计的汽车实体，其具备的属性见下图。

![](/images/0200ssm/ssm287/blog.009.png)

图4.5 汽车实体属性图

（3）设计的用户实体，其具备的属性见下图。

![](/images/0200ssm/ssm287/blog.010.png)

图4.6 用户实体属性图

（4）设计的购物车实体，其具备的属性见下图。

![](/images/0200ssm/ssm287/blog.011.png)

图4.7 购物车实体属性图

（5）设计的各实体间关系见下图。

![](/images/0200ssm/ssm287/blog.012.png)
