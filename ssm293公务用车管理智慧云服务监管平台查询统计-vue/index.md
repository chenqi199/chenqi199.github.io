...
# [ssm293公务用车管理智慧云服务监管平台查询统计+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm293/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm293/blog.002.png)
...
![](/images/0200ssm/ssm293/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0200ssm/ssm293/blog.004.png)
...
![](/images/0200ssm/ssm293/blog.005.png)

图4.12  公务用车信息实体属性图

（2）处置车辆信息实体属性图如图4.13所示：

![](/images/0200ssm/ssm293/blog.006.png)

图4.13 处置车辆信息实体属性图

（3）编制车辆实体属性图如图4.14所示：

![](/images/0200ssm/ssm293/blog.007.png)
...
![](/images/0200ssm/ssm293/blog.009.png)

图5.1 用户信息管理界面
## 5.2 公务用车
系统管理员可以管理公务用车信息，可以对公务用车信息进行添加，修改，删除查询操作，具体界面如图5.2所示。

![](/images/0200ssm/ssm293/blog.010.png)图5.2 公务用车信息管理界面
## 5.3 公务用车审批
系统管理员可以管理公务用车审批信息，对公务用车审批进行审批或者删除操作。界面如下图所示：

![](/images/0200ssm/ssm293/blog.011.png)
...
![](/images/0200ssm/ssm293/blog.012.png)

图5.4 编制车辆界面
## 5.5 处置车辆
系统管理员可以管理处置车辆信息，可以对处置车辆信息进行添加，修改，删除查询操作。界面如下图所示：

![](/images/0200ssm/ssm293/blog.013.png)
