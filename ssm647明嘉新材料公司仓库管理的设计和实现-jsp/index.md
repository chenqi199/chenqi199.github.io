...
# [ssm647明嘉新材料公司仓库管理的设计和实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm647/blog.003.png)
...
![](/images/0600ssm/ssm647/blog.004.png)

图4-2管理员信息E-R图

![](/images/0600ssm/ssm647/blog.005.png)

图4-3用户信息E-R图

![](/images/0600ssm/ssm647/blog.006.png)

图4-4字典信息E-R图

![](/images/0600ssm/ssm647/blog.007.png)

图4-5仓库信息E-R图

![](/images/0600ssm/ssm647/blog.008.png)

图4-6材料信息E-R图

![](/images/0600ssm/ssm647/blog.009.png)

图4-7公告信息E-R图


![](/images/0600ssm/ssm647/blog.010.png)
...
![](/images/0600ssm/ssm647/blog.015.png)

图5-5材料类型管理界面

![](/images/0600ssm/ssm647/blog.016.png)

图5-6仓库类型管理界面

![](/images/0600ssm/ssm647/blog.017.png)

图5-7公告类型管理界面

![](/images/0600ssm/ssm647/blog.018.png)

图5-8学历管理界面
## 5.5公告管理
通过设计的公告管理功能模块，管理用户可以对相关的公告信息进行管理，比如管理用户可以查看公告发布时间信息，删除已经失效的公告信息记录等操作，公告管理界面设计如图5-9所示。

![](/images/0600ssm/ssm647/blog.019.png)

图5-9公告管理界面
## 5.6用户管理
通过设计的用户管理功能模块，管理用户可以管理相关的用户信息资料，比如进行查看用户姓名，修改用户联系方式，删除已经注销的用户信息记录等操作，用户管理界面设计如图5-10所示。

![](/images/0600ssm/ssm647/blog.020.png)
