...
# [ssm747普通话培训信息管理系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0700ssm/ssm747/blog.001.png)
...
![](/images/0700ssm/ssm747/blog.002.png)
...
![](/images/0700ssm/ssm747/blog.007.png)

图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图。

![](/images/0700ssm/ssm747/blog.008.png)
...
![](/images/0700ssm/ssm747/blog.009.png)

图4.4 管理员实体属性图

（2）教师实体属性图见图4.5。

![](/images/0700ssm/ssm747/blog.010.png)

图4.5 教师实体属性图

（3）学生实体属性图见图4.6。

![](/images/0700ssm/ssm747/blog.011.png)
...
![](/images/0700ssm/ssm747/blog.012.png)

图5.1 教师管理页面
### 5.1.2 学生管理
如图5.2显示的就是学生管理页面，管理员可以对学生信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm747/blog.013.png)

图5.2 学生管理页面
### 5.1.3 项目培训管理
如图5.3显示的就是项目培训管理页面，管理员可以对项目培训信息修改，删除，批量删除以及查询操作。

![](/images/0700ssm/ssm747/blog.014.png)
...
![](/images/0700ssm/ssm747/blog.015.png)

图5.4 报名信息页面
### 5.2.2 成绩信息管理
如图5.4显示的就是成绩信息页面，教师在报名信息页面可以对学生成绩信息进行添加修改删除查询操作。

![](/images/0700ssm/ssm747/blog.016.png)
...
![](/images/0700ssm/ssm747/blog.017.png)
...
![](/images/0700ssm/ssm747/blog.018.png)

图5.7 公告信息页面
### 5.3.3 培训安排
如图5.4显示的就是培训安排页面，学生可以在后台查看培训安排。

![](/images/0700ssm/ssm747/blog.019.png)
