...
# [ssm230电子设备销售网站的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm230/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm230/blog.002.png)
...
![](/images/0200ssm/ssm230/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm230/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm230/blog.005.png)
...
![](/images/0200ssm/ssm230/blog.006.png)

图4.12  购物车信息实体属性图

（2）商品实体属性图如图4.13所示：

![](/images/0200ssm/ssm230/blog.007.png)

图4.13  商品实体属性图

（3）商品类型实体属性图如图4.14所示：

![](/images/0200ssm/ssm230/blog.008.png)
...
![](/images/0200ssm/ssm230/blog.009.png)

图5.1 电子商城管理界面
### 5.1.2 销售排行统计
系统管理员可以对销售信息进行统计。具体界面如图5.2所示。

![](/images/0200ssm/ssm230/blog.010.png)

图5.3 统计界面
### 5.1.3 用户信息管理
系统管理员可以对用户信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm230/blog.011.png)
...
![](/images/0200ssm/ssm230/blog.012.png)

图5.5 我的订单界面
### 5.2.2 商品购买
用户登录后，首页点击商品，可以查看商品信息并且可以购买操作。界面如下图所示：

![](/images/0200ssm/ssm230/blog.013.png)

图5.6 商品购买界面
### 5.2.3 确认下单管理
用户登录后购买商品可以选择确认下单。界面如下图所示：

![](/images/0200ssm/ssm230/blog.014.png)
