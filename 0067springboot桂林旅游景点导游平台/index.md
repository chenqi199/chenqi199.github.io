...
# [0067springboot桂林旅游景点导游平台](https://github.com/GraduationProject-springboot/0067springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0067springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0067springboot/blog.002.png)
...
![](/images/0000stringboot/0067springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0000stringboot/0067springboot/blog.004.png)
...
![](/images/0000stringboot/0067springboot/blog.005.png)

图4.12  管理员信息实体属性图

（2）新闻资讯信息实体属性图如图4.13所示：

![](/images/0000stringboot/0067springboot/blog.006.png)

图4.13  新闻资讯信息实体属性图

（3）景点类型信息实体属性图如图4.14所示：

![](/images/0000stringboot/0067springboot/blog.007.png)
...
![](/images/0000stringboot/0067springboot/blog.010.png)

图5.1 用户信息管理界面
### 5.1.2 景点类型管理
系统管理员可以查看对景点类型进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0000stringboot/0067springboot/blog.011.png)

图5.2 景点类型管理界面
### 5.1.3 景点信息管理
系统管理员可以对景点信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0000stringboot/0067springboot/blog.012.png)

图5.3 景点信息管理界面
### 5.1.4 线路推荐管理
系统管理员可以对线路推荐进行添加修改删除操作。界面如下图所示：

![](/images/0000stringboot/0067springboot/blog.013.png)
...
![](/images/0000stringboot/0067springboot/blog.014.png)

图5.5 用户注册界面
### 5.2.3 线路推荐
用户登录后，就可以看到线路推荐，可以对推荐线路进行预定。界面如下图所示：

![](/images/0000stringboot/0067springboot/blog.015.png)
...
![](/images/0000stringboot/0067springboot/blog.016.png)
