...
# [0100springboot校园社团信息管理](https://github.com/GraduationProject-springboot/0100springboot)
...
## 3.4系统流程和逻辑
![](/images/0100stringboot/0100springboot/blog.001.png)

图3-3登录流程图

![](/images/0100stringboot/0100springboot/blog.002.png)
...
![](/images/0100stringboot/0100springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0100stringboot/0100springboot/blog.004.png)
...
![](/images/0100stringboot/0100springboot/blog.005.png)

图4.12  管理员信息实体属性图

（2）社长信息实体属性图如图4.13所示：

![](/images/0100stringboot/0100springboot/blog.006.png)

图4.13  社长信息实体属性图

（3）学生信息实体属性图如图4.14所示：

![](/images/0100stringboot/0100springboot/blog.007.png)
...
![](/images/0100stringboot/0100springboot/blog.010.png)

图5.1 学生信息管理界面
### 5.1.2 社长管理
系统管理员可以查看对社长信息进行修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0100stringboot/0100springboot/blog.011.png)

图5.2 社长信息管理界面
### 5.1.3 社团信息管理
系统管理员可以对社团信息进行添加修改删除操作。界面如下图所示：

![](/images/0100stringboot/0100springboot/blog.012.png)

图5.3 社团信息界面
### 5.1.4 社团新闻管理
系统管理员可以对社团新闻进行添加修改删操作。界面如下图所示：

![](/images/0100stringboot/0100springboot/blog.013.png)
...
![](/images/0100stringboot/0100springboot/blog.014.png)

图5.5 社团添加界面
### 5.2.2 社团活动
社长创建社团活动，等待管理员审核。界面如下图所示：

![](/images/0100stringboot/0100springboot/blog.015.png)
...
![](/images/0100stringboot/0100springboot/blog.016.png)
