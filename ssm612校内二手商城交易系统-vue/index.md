...
# [ssm612校内二手商城交易系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm612/blog.001.png)
...
![](/images/0600ssm/ssm612/blog.010.png)

图4.4 商品实体属性图

（2）商品订单包括的属性有购买数量，订单类型，支付类型等。其属性图如下。

![](/images/0600ssm/ssm612/blog.011.png)

图4.5 商品订单实体属性图

（3）商家包括的属性有商家名称，联系方式，邮箱等。其属性图如下。

![](/images/0600ssm/ssm612/blog.012.png)

图4.6 商家实体属性图

（4）用户包括的属性有用户头像，性别，电子邮箱等。其属性图如下。

![](/images/0600ssm/ssm612/blog.013.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0600ssm/ssm612/blog.014.png)
