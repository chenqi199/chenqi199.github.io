...
# [ssm521基于SSM框架的成绩管理系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm521/blog.001.png)
...
![](/images/0500ssm/ssm521/blog.004.png)

图3.4 管理员用例图

学生对于成绩管理系统操作的功能包括下载课程文件，查看课程成绩，更改登录成绩管理系统的密码，更改个人信息等。其用例图如图3.5所示：

![](/images/0500ssm/ssm521/blog.005.png)
...
![](/images/0500ssm/ssm521/blog.008.png)

图4.4 管理员实体属性图

（2）课程包括的属性有课程名称，课程简介，创建时间，课程编号等信息。其属性图如下。

![](/images/0500ssm/ssm521/blog.009.png)

图4.5 课程实体属性图

（3）成绩包括的属性有学生，创建时间，成绩，详情等。其属性图如下。

![](/images/0500ssm/ssm521/blog.010.png)

图4.6 成绩实体属性图

（4）学生包括的属性有姓名，头像，生日，性别等。其属性图如下。

![](/images/0500ssm/ssm521/blog.011.png)

图4.7 学生实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0500ssm/ssm521/blog.012.png)
...
![](/images/0500ssm/ssm521/blog.014.png)
...
![](/images/0500ssm/ssm521/blog.019.png)

图5.6 成绩信息查看界面
### 5.2.2 课程信息查看
课程信息查看界面的运行效果见图5.7。在此界面，学生下载课程文件，查询课程，对课程的详细内容进行查看。

![](/images/0500ssm/ssm521/blog.020.png)图5.7 课程信息查看界面
### 5.2.3 个人信息
个人信息界面的运行效果见图5.8。在此界面，学生可以更改头像，生日，班级，性别等信息。修改完成的个人信息需要及时保存。

![](/images/0500ssm/ssm521/blog.021.png)
