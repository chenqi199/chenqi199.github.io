...
# [ssm305食用菌菌棒溯源系统的开发与设计+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm305/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm305/blog.002.png)
...
![](/images/0300ssm/ssm305/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm305/blog.004.png)
...
![](/images/0300ssm/ssm305/blog.005.png)

图4.12  宠物信息实体属性图

（2）生长信息实体属性图如图4.13所示：

![](/images/0300ssm/ssm305/blog.006.png)

图4.13 生长信息实体属性图

（3）菌房实体属性图如图4.14所示：

![](/images/0300ssm/ssm305/blog.007.png)
...
![](/images/0300ssm/ssm305/blog.008.png)

图5.1普通用户信息管理界面
### 5.2 普通管理员管理
系统管理员可以管理普通管理员信息，可以对普通管理员信息进行添加，修改，删除查询操作，具体界面如图5.2所示。

![](/images/0300ssm/ssm305/blog.009.png)图5.2 普通管理员信息管理界面
### 5.3基本信息管理
系统管理员可以管理基本信息信息，对基本信息信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0300ssm/ssm305/blog.010.png)
...
![](/images/0300ssm/ssm305/blog.011.png)

图5.4 生长信息界面
### 5.5 菌房信息管理
系统管理员可以管理菌房信息，对菌房信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0300ssm/ssm305/blog.012.png)
