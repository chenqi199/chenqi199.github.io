...
# [ssm556班级事务管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm556/blog.011.png)

图4-3 学生实体属性图

（2）使用Visio这样的常用的实体属性图绘制工具来绘制请假实体属性图，绘制结果见图4-4。

![](/images/0500ssm/ssm556/blog.012.png)

图4-4 请假实体属性图

（3）使用Visio这样的常用的实体属性图绘制工具来绘制作业实体属性图，绘制结果见图4-5。

![](/images/0500ssm/ssm556/blog.013.png)

图4-5 作业实体属性图

（4）使用Visio这样的常用的实体属性图绘制工具来绘制老师实体属性图，绘制结果见图4-6。

![](/images/0500ssm/ssm556/blog.014.png)

图4-6 老师实体属性图

（5）绘制的上述实体间存在的联系见图4-7。

![](/images/0500ssm/ssm556/blog.015.png)
...
![打开新的 phpMyAdmin 窗口](blog.016.png "打开新的 phpMyAdmin 窗口")表4.1成绩表
...
![](/images/0500ssm/ssm556/blog.021.png)

图5-5 成绩管理界面
### 5.2.2 请假管理
老师进入如图5-6所示的请假管理界面之后，老师点击信息显示栏右侧的审核按钮即可对学生的请假进行线上审核。

![](/images/0500ssm/ssm556/blog.022.png)

图5-6 请假管理界面
### 5.2.3 作业管理
老师进入如图5-7所示的作业管理界面之后，老师新增作业，对发布的作业信息进行删除或更改。

` `![](/images/0500ssm/ssm556/blog.023.png)
...
![](/images/0500ssm/ssm556/blog.024.png)

图5-8 请假管理界面
### 5.3.2 作业管理
学生进入如图5-9所示的作业管理界面之后，学生需要下载老师发布的作业文件，同时，学生可以查询作业信息。

` `![](/images/0500ssm/ssm556/blog.025.png)

图5-9 作业管理界面
### 5.3.3 考勤查看
学生进入如图5-10所示的考勤查看界面之后，学生对自己的考勤信息进行查看，包括考勤类型，考勤日期等信息。

![](/images/0500ssm/ssm556/blog.026.png)
