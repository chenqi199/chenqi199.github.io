...
![](/images/0300stringboot/0308springboot/blog.001.png)
...
![](/images/0300stringboot/0308springboot/blog.002.png)

图3.2 注册流程图

当需要用户登录的时候，肯定是要验证的，只有验证通过的用户才可以进行下一步操作，用户登录成功代表着用户模块的功能对登录用户进行了开放。流程就是如下面的图所示。

![](/images/0300stringboot/0308springboot/blog.003.png)
...
![](/images/0300stringboot/0308springboot/blog.004.png)
...
![](/images/0300stringboot/0308springboot/blog.005.png)
...
![](/images/0300stringboot/0308springboot/blog.006.png)
...
![](/images/0300stringboot/0308springboot/blog.010.png)

图4.4 手工艺品实体属性图

（2）手工艺品订单包括的属性有购买数量，订单类型，支付类型等。其属性图如下。

![](/images/0300stringboot/0308springboot/blog.011.png)

图4.5 手工艺品订单实体属性图

（3）商家包括的属性有商家名称，联系方式，邮箱等。其属性图如下。

![](/images/0300stringboot/0308springboot/blog.012.png)

图4.6 商家实体属性图

（4）用户包括的属性有用户头像，性别，电子邮箱等。其属性图如下。

![](/images/0300stringboot/0308springboot/blog.013.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0300stringboot/0308springboot/blog.014.png)
