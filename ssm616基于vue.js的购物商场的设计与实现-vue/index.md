...
# [ssm616基于vue.js的购物商场的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm616/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0600ssm/ssm616/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0600ssm/ssm616/blog.003.png)
...
![](/images/0600ssm/ssm616/blog.004.png)
...
![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品.jpg](/images/0600ssm/ssm616/blog.005.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品.jpg")
图4.1 商品实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\用户.jpg](/images/0600ssm/ssm616/blog.006.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\用户.jpg")
图4.2 用户实体属性图

（3）下图是送货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\送货地址.jpg](/images/0600ssm/ssm616/blog.007.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\送货地址.jpg")
图4.3 送货地址实体属性图

（4）下图是营销活动实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\营销活动.jpg](/images/0600ssm/ssm616/blog.008.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\营销活动.jpg")
图4.4 营销活动实体属性图

（5）下图是留言版实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\留言版.jpg](/images/0600ssm/ssm616/blog.009.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\留言版.jpg")
图4.5 留言版实体属性图

（6）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\购物车.jpg](/images/0600ssm/ssm616/blog.010.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\购物车.jpg")
图4.6 购物车实体属性图

（7）下图是商品评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品评价.jpg](/images/0600ssm/ssm616/blog.011.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品评价.jpg")
图4.7 商品评价实体属性图

（8）下图是商品订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品订单.jpg](/images/0600ssm/ssm616/blog.012.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\商品订单.jpg")
图4.8 商品订单实体属性图

（9）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gouwushangchengxittong\用户表.jpg](/images/0600ssm/ssm616/blog.013.jpeg "C:\Users\Administrator\Desktop\img\gouwushangchengxittong\用户表.jpg")
图4.9 用户表实体属性图
### 4.3.2 数据库物理设计
...
![](/images/0600ssm/ssm616/blog.014.png)

![](/images/0600ssm/ssm616/blog.015.png)

图5.1 用户信息管理页面
### 5.2 商品信息管理
如图5.2显示的就是商品信息管理页面，此页面提供给管理员的功能有：查看已发布的商品信息数据，修改商品信息，商品信息作废，即可删除，还进行了对商品信息名称的模糊查询 商品信息信息的类型查询等等一些条件。

![](/images/0600ssm/ssm616/blog.016.png)

![](/images/0600ssm/ssm616/blog.017.png)
...
![](/images/0600ssm/ssm616/blog.018.png)

![](/images/0600ssm/ssm616/blog.019.png)

图5.3 商品评论管理页面
### 5.1商品订单管理
如图5.4显示的就是商品订单管理页面，此页面提供给管理员的功能有：根据商品订单进行新增、修改、查询操作等等。

![](/images/0600ssm/ssm616/blog.020.png)

![](/images/0600ssm/ssm616/blog.021.png)
