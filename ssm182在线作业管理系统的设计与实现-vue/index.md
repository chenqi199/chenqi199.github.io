...
# [ssm182在线作业管理系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0100ssm/ssm182/blog.001.png)
...
![](/images/0100ssm/ssm182/blog.002.png)

图3.2 注册流程图

访问者操作系统，前提是需要验证身份，而登录功能的设置就是把本系统的用户引导进入后台操作区，把不是本系统的用户拒之门外。其流程见下图。

![](/images/0100ssm/ssm182/blog.003.png)
...
![](/images/0100ssm/ssm182/blog.010.png)

图4.4 教师实体属性图

（2）设计的教学资源实体，其具备的属性见下图。

![](/images/0100ssm/ssm182/blog.011.png)

图4.5 教学资源实体属性图

（3）设计的学生实体，其具备的属性见下图。

![](/images/0100ssm/ssm182/blog.012.png)

图4.6 学生实体属性图

（4）设计的作业实体，其具备的属性见下图。

![](/images/0100ssm/ssm182/blog.013.png)

图4.7 作业实体属性图

（5）设计的各实体间关系见下图。

![](/images/0100ssm/ssm182/blog.014.png)
...
![](/images/0100ssm/ssm182/blog.021.png)

图5.7 作业信息页面
### 5.3.2 教学资源
学生权限中的教学资源，其运行效果见下图。学生收藏教学资源，播放教学资源视频。

![](/images/0100ssm/ssm182/blog.022.png)

图5.8 教学资源页面
### 5.3.3 通知公告
学生权限中的通知公告，其运行效果见下图。学生点击公告标题即可查看公告内容。

![](/images/0100ssm/ssm182/blog.023.png)
