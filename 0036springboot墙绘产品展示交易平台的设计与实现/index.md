...
# [0036springboot墙绘产品展示交易平台的设计与实现](https://github.com/GraduationProject-springboot/0036springboot)
...
![](/images/0000stringboot/0036springboot/blog.001.png)
...
![](/images/0000stringboot/0036springboot/blog.002.png)
...
![](/images/0000stringboot/0036springboot/blog.007.png)
...
![](/images/0000stringboot/0036springboot/blog.008.png)
...
1
![](/images/0000stringboot/0036springboot/blog.009.png)
...
![](/images/0000stringboot/0036springboot/blog.010.png)

![](/images/0000stringboot/0036springboot/blog.011.png)

图5.1 用户信息管理页面
### 5.2 商品信息管理
如图5.2显示的就是商品信息管理页面，此页面提供给管理员的功能有：查看已发布的商品信息数据，修改商品信息，商品信息作废，即可删除。

![](/images/0000stringboot/0036springboot/blog.012.png)

图5.2 商品信息管理页面
### 5.3商品分类管理
如图5.3显示的就是商品分类管理页面，此页面提供给管理员的功能有：根据商品分类进行条件查询，还可以对商品分类进行新增、修改、查询操作等等。

![](/images/0000stringboot/0036springboot/blog.013.png)
...
![](/images/0000stringboot/0036springboot/blog.014.png)
