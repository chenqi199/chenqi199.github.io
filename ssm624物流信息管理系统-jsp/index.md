...
# [ssm624物流信息管理系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm624/blog.001.png)
...
![](/images/0600ssm/ssm624/blog.004.png)

图3.4 管理员用例图

用户对于物流信息管理系统操作的功能包括查询快递，查看订单，查看运货路线，管理收货地址，管理发货地址，查看公告等。其用例图如图3.5所示：

![](/images/0600ssm/ssm624/blog.005.png)
...
![](/images/0600ssm/ssm624/blog.008.png)

图4.4 管理员实体属性图

（2）订单包括的属性有运输物品名称，发货地址，订单状态等。其属性图如下。

![](/images/0600ssm/ssm624/blog.009.png)

图4.5 订单实体属性图

（3）运货路线包括的属性有费用，运货路线编号，大概时长等。其属性图如下。

![](/images/0600ssm/ssm624/blog.010.png)

图4.6 运货路线实体属性图

（4）用户包括的属性有用户姓名，用户头像，用户手机号，性别等。其属性图如下。

![](/images/0600ssm/ssm624/blog.011.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0600ssm/ssm624/blog.012.png)
...
![](/images/0600ssm/ssm624/blog.013.png)
...
![](/images/0600ssm/ssm624/blog.014.png)
