...
# [ssm220传统文化网站+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm220/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm220/blog.002.png)
...
![](/images/0200ssm/ssm220/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm220/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm220/blog.005.png)
...
![](/images/0200ssm/ssm220/blog.006.png)

图4.12  资讯信息实体属性图

（2）留言板实体属性图如图4.13所示：

![](/images/0200ssm/ssm220/blog.007.png)

图4.13  留言板实体属性图

（3）文章类型实体属性图如图4.14所示：

![](/images/0200ssm/ssm220/blog.008.png)
...
![](/images/0200ssm/ssm220/blog.009.png)

图5.1 员工信息管理界面
### 5.1.2 文章类型管理
系统管理员可以文章类型进行添加，修改，删除操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm220/blog.010.png)

图5.3 文章类型管理界面
### 5.1.3 文章信息管理
系统管理员可以对用户提交的文章信息进行审核以及删除操作。界面如下图所示：

![](/images/0200ssm/ssm220/blog.011.png)
...
![](/images/0200ssm/ssm220/blog.012.png)

图5.5 系统首页界面
### 5.2.2 用户投票
用户登录后，点击文章可以进行投票操作。界面如下图所示：

![](/images/0200ssm/ssm220/blog.013.png)

图5.6 用户投票界面
### 5.2.3 文章信息
用户登录后可以在首页文章信息里面提交自己想要写作的文章。界面如下图所示：

![](/images/0200ssm/ssm220/blog.014.png)
