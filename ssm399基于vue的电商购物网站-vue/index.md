...
# [ssm399基于vue的电商购物网站+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm399/blog.001.png)
...
![](/images/0300ssm/ssm399/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0300ssm/ssm399/blog.006.png)
...
![](/images/0300ssm/ssm399/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是购物资讯实体E-R图

![](/images/0300ssm/ssm399/blog.008.png)

图4.8 购物资讯实体E-R图

（3）下图就是留言板信息实体E-R图

![](/images/0300ssm/ssm399/blog.009.png)
...
![](/images/0300ssm/ssm399/blog.011.png)

图5.1 用户信息管理页面
## 5.2 商品类型管理
管理员可以对商品类型信息进行添加，修改，删除，查询操作。下图就是商品类型信息管理页面。

![](/images/0300ssm/ssm399/blog.012.png)

图5.2商品类型信息管理页面
## 5.3 商品信息管理
管理员可以对商品信息进行添加，修改，删除，查询操作。下图就是商品信息管理页面。

![](/images/0300ssm/ssm399/blog.013.png)

图5.3 商品信息管理页面
## 5.4 用户注册
用户需要注册才可以登录。下图就是用户注册页面。

![](/images/0300ssm/ssm399/blog.014.png)

图5.4 用户注册页面
## 5.5 商品购买与收藏
用户可以对商品进行购买与收藏。下图就是商品购买与收藏页面。

![](/images/0300ssm/ssm399/blog.015.png)

图5.5 商品购买与收藏页面
## 5.6 我的订单
用户购买后会产生订单，在我的订单里查看。下图就是我的订单页面。

![](/images/0300ssm/ssm399/blog.016.png)
