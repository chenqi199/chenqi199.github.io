...
[]{#__RefHeading___Toc22701 .anchor}

[摘 要 I](#摘-要)

[目 录 III](#__RefHeading___Toc22701)
...
[4.4数据库设计 12](#__RefHeading___Toc31060)

[4.4.1 数据库E-R图 12](#__RefHeading___Toc2466)
...
[第6章 系统测试 19](#__RefHeading___Toc26107)
...
表4.5水果表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    6        shuiguo_types            Integer             一级分类          是

    7      shuiguo_erji_types         Integer             二级分类          是

    8        tuijian_types            Integer             是否推荐          是

    9         tejia_types             Integer             是否特价          是

    10        jinkou_types            Integer             是否进口          是

    11    shuiguo_kucun_number        Integer             水果库存          是

    12     shuiguo_old_money         BigDecimal           水果原价          是

    13     shuiguo_new_money         BigDecimal             现价            是

    14      shuiguo_clicknum          Integer             点击次数          是

    15      shuiguo_content            String             水果介绍          是

    16       shangxia_types           Integer             是否上架          是

    17       shuiguo_delete           Integer             逻辑删除          是
...
表4.7水果评价表
  ...
  ------ -------------------------- -------------------- ------------------- --------
   序号             列名                  数据类型              说明          允许空
    ...
    4     shuiguo_commentback_text         String             评价内容          是
...
表4.8水果订单表
  ...
  ------ ------------------------------ -------------------- ------------------- --------
   序号               列名                    数据类型              说明          允许空
    ...
    2      shuiguo_order_uuid_number           String              订单号           是
    ...
    8      shuiguo_order_courier_name          String             快递公司          是

    9     shuiguo_order_courier_number         String           订单快递单号        是

    10        shuiguo_order_types             Integer             订单类型          是

    11    shuiguo_order_payment_types         Integer             支付类型          是
...
表4.11商家表
  ...
  ------ ----------------------- -------------------- ------------------- --------
   序号           列名                 数据类型              说明          允许空
    ...
    9     shangjia_yesno_types         Integer             审核状态          是

    10     shangjia_yesno_text          String             审核意见          是

    11    shangjia_shenhe_time           Date              审核时间          是

    12       shangjia_delete           Integer             逻辑删除          是
...
![](media/image16.png){width="6.292361111111111in"
...
![](media/image17.png){width="6.279861111111111in" height="3.14375in"}
...
![](media/image18.png){width="6.279861111111111in" height="3.15625in"}

图5.4 公告类型列表页面

[]{#__RefHeading___Toc26107 .anchor}
...
精品水果线上销售网站在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的精品水果线上销售网站符合用户需求，它在用户电脑上运行使用带给用户的便利是显而易见的。

# 结 论

精品水果线上销售网站的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。从精品水果线上销售网站的前台页面实现，到精品水果线上销售网站的后台代码的编辑，我用到的软件包括了数据库软件Mysql，Java开发工具IDEA，办公软件Office，浏览器软件Fireworks，图像处理软件Photoshop等，这也是我第一次使用Java语言，开发的这个比较简单的精品水果线上销售网站。

精品水果线上销售网站开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
精品水果线上销售网站现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0311springboot精品水果线上销售网站的设计与实现 项目图片
![图片](/images/0311springbootimg_014.jpg)
![图片](/images/0311springbootimg_015.jpg)
![图片](/images/0311springbootimg_001.jpg)
![图片](/images/0311springbootimg_017.jpg)
![图片](/images/0311springbootimg_003.jpg)
![图片](/images/0311springbootimg_002.jpg)
![图片](/images/0311springbootimg_016.jpg)
![图片](/images/0311springbootimg_012.jpg)
![图片](/images/0311springbootimg_006.jpg)
![图片](/images/0311springbootimg_007.jpg)
![图片](/images/0311springbootimg_013.jpg)
![图片](/images/0311springbootimg_005.jpg)
![图片](/images/0311springbootimg_011.jpg)
![图片](/images/0311springbootimg_010.jpg)
![图片](/images/0311springbootimg_004.jpg)
![图片](/images/0311springbootimg_009.jpg)
![图片](/images/0311springbootimg_021.jpg)
![图片](/images/0311springbootimg_020.jpg)
![图片](/images/0311springbootimg_008.jpg)
![图片](/images/0311springbootimg_018.jpg)
![图片](/images/0311springbootimg_019.jpg)
