...
# [ssm568校园二手交易管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0500ssm/ssm568/blog.001.png)
...
![](/images/0500ssm/ssm568/blog.010.png)

图4.4 商品实体属性图

（2）商品订单包括的属性有购买数量，订单类型，支付类型等。其属性图如下。

![](/images/0500ssm/ssm568/blog.011.png)

图4.5 商品订单实体属性图

（3）商家包括的属性有商家名称，联系方式，邮箱等。其属性图如下。

![](/images/0500ssm/ssm568/blog.012.png)

图4.6 商家实体属性图

（4）用户包括的属性有用户头像，性别，会员等级等。其属性图如下。

![](/images/0500ssm/ssm568/blog.013.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0500ssm/ssm568/blog.014.png)
...
![](/images/0500ssm/ssm568/blog.025.png)

图5.10 确认下单界面
### 5.3.5 商品订单
商品订单界面的运行效果见图5.11。在此界面，用户可以对订单商品进行退款，收货，评价等操作。

![](/images/0500ssm/ssm568/blog.026.png)
