...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1EbH&bvid=BV1jqaLe1EbH&cid=500001610881567&p=5)
...
[]{#__RefHeading___Toc14198 .anchor}

[摘 要 I](#摘-要)

[目 录 III](#__RefHeading___Toc14198)
...
[4.4数据库设计 12](#__RefHeading___Toc14464)

[4.4.1 数据库E-R图 12](#__RefHeading___Toc12339)

[4.4.2 数据库表结构 13](#数据库表结构)

[第5章 系统实现 18](#系统实现)

[5.1管理员功能实现 18](#管理员功能实现)

[5.1.1 出售房屋管理 18](#出售房屋管理)

[5.1.2 公告信息管理 18](#公告信息管理)

[5.1.3公告类型管理 19](#公告类型管理)

[第6章 系统测试 20](#__RefHeading___Toc29468)

[6.1系统测试方法 20](#系统测试方法)

[6.2 系统功能测试 21](#系统功能测试)

[6.2.1 用户登录测试 21](#用户登录测试)

[6.2.2 添加账户功能测试 21](#添加账户功能测试)

[6.3 系统测试分析 21](#系统测试分析)
...
表4.1出售房屋表
  ...
  ------ ------------------------------- -------------------- ------------------- --------
   序号               列名                     数据类型              说明          允许空
    ...
    3          chushoufangwu_name               String           出售房屋名称        是

    4       chushoufangwu_uuid_number           String           出售房屋编号        是

    5          chushoufangwu_photo              String           出售房屋照片        是

    6          chushoufangwu_types             Integer             房屋类型          是

    7      chushoufangwu_xinjiu_types          Integer             新房旧房          是

    8              quyu_types                  Integer               区域            是

    9         chushoufangwu_xiaoqu              String             所在小区          是

    10        chushoufangwu_weizhi              String           所在详细位置        是

    11        chushoufangwu_mianji            BigDecimal           房屋面积          是

    12       chushoufangwu_old_money          BigDecimal            原总价           是

    13       chushoufangwu_new_money          BigDecimal            现总价           是

    14       chushoufangwu_clicknum            Integer             房屋热度          是

    15        chushoufangwu_content             String           出售房屋介绍        是

    16    chushoufangwu_zhuangtai_types        Integer             房屋状态          是

    17           shangxia_types                Integer             是否上架          是

    18        chushoufangwu_delete             Integer             逻辑删除          是
...
表4.2出售房屋收藏表
  ...
  ------ -------------------------------- -------------------- ------------------- --------
   序号                列名                     数据类型              说明          允许空
    ...
    2            chushoufangwu_id               Integer             出售房屋          是

    3               yonghu_id                   Integer               用户            是

    4     chushoufangwu_collection_types        Integer               类型            是
...
表4.3出售房屋留言表
  ...
  ------ --------------------------- -------------------- ------------------- --------
   序号             列名                   数据类型              说明          允许空
    ...
    4     chushoufangwu_liuyan_text         String             留言内容          是
...
表4.4预约出售房屋看房表
  ...
  ------ --------------------------------- -------------------- -------------------- --------
   序号                列名                      数据类型               说明          允许空
    ...
    2     chushoufangwu_order_uuid_number         String              看房编号          是

    3            chushoufangwu_id                Integer              出售房屋          是

    4                yonghu_id                   Integer                用户            是

    5        chushoufangwu_order_name             String           申请看房人姓名       是

    6        chushoufangwu_order_phone            String         申请看房人联系电话     是

    7               insert_time                    Date               申请时间          是

    8              kanfang_time                    Date               看房时间          是

    9     chushoufangwu_order_yesno_types        Integer              审核状态          是

    10    chushoufangwu_order_yesno_text          String              回复内容          是

    11    chushoufangwu_order_shenhe_time          Date               审核时间          是
...
表4.8租房表
  ...
  ------ ------------------------ -------------------- ------------------- --------
   序号            列名                 数据类型              说明          允许空
    ...
    3          zufang_name               String             房屋名称          是

    4       zufang_uuid_number           String             房屋编号          是

    5          zufang_photo              String             租房照片          是

    6          zufang_types             Integer           出租房屋类型        是

    7           quyu_types              Integer               区域            是

    8         zufang_xiaoqu              String             所在小区          是

    9         zufang_weizhi              String           所在详细位置        是

    10        zufang_mianji            BigDecimal           房屋面积          是

    11       zufang_old_money          BigDecimal            原价/月          是

    12       zufang_new_money          BigDecimal            现加/月          是

    13       zufang_clicknum            Integer             房屋热度          是

    14        zufang_content             String             房屋介绍          是

    15    zufang_zhuangtai_types        Integer             房屋状态          是

    16        shangxia_types            Integer             是否上架          是

    17        zufang_delete             Integer             逻辑删除          是
...
表4.9租房收藏表
  ...
  ------ ------------------------- -------------------- ------------------- --------
   序号            列名                  数据类型              说明          允许空
    ...
    2            zufang_id               Integer               租房            是

    3            yonghu_id               Integer               用户            是

    4     zufang_collection_types        Integer               类型            是
...
表4.10租房留言表
  ...
  ------ -------------------- -------------------- ------------------- --------
   序号          列名               数据类型              说明          允许空
    ...
    4     zufang_liuyan_text         String             留言内容          是
...
表4.11预约租房看房表
  ...
  ------ -------------------------- -------------------- -------------------- --------
   序号             列名                  数据类型               说明          允许空
    ...
    2     zufang_order_uuid_number         String              看房编号          是

    3            zufang_id                Integer                租房            是

    4            yonghu_id                Integer                用户            是

    5        zufang_order_name             String           申请看房人姓名       是

    6        zufang_order_phone            String         申请看房人联系电话     是

    7           insert_time                 Date               申请时间          是

    8           kanfang_time                Date               看房时间          是

    9     zufang_order_yesno_types        Integer              审核状态          是

    10    zufang_order_yesno_text          String              回复内容          是

    11    zufang_order_shenhe_time          Date               审核时间          是
...
![](media/image16.png){width="6.295833333333333in" height="3.25in"}
...
![](media/image18.png){width="6.279861111111111in"
height="3.229861111111111in"}

图5.4 公告类型列表页面

[]{#__RefHeading___Toc29468 .anchor}
...
房屋交易平台在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的房屋交易平台符合用户需求，它在用户电脑上运行使用带给用户的便利是显而易见的。

# 结 论

房屋交易平台的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。从房屋交易平台的前台页面实现，到房屋交易平台的后台代码的编辑，我用到的软件包括了数据库软件Mysql，Java开发工具IDEA，办公软件Office，浏览器软件Fireworks，图像处理软件Photoshop等，这也是我第一次使用Java语言，开发的这个比较简单的房屋交易平台。

房屋交易平台开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
房屋交易平台现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0234springboot房屋交易平台的设计与实现 项目图片
![图片](/images/0234springbootimg_014.jpg)
![图片](/images/0234springbootimg_015.jpg)
![图片](/images/0234springbootimg_001.jpg)
![图片](/images/0234springbootimg_017.jpg)
![图片](/images/0234springbootimg_003.jpg)
![图片](/images/0234springbootimg_002.jpg)
![图片](/images/0234springbootimg_016.jpg)
![图片](/images/0234springbootimg_012.jpg)
![图片](/images/0234springbootimg_006.jpg)
![图片](/images/0234springbootimg_007.jpg)
![图片](/images/0234springbootimg_013.jpg)
![图片](/images/0234springbootimg_005.jpg)
![图片](/images/0234springbootimg_011.jpg)
![图片](/images/0234springbootimg_010.jpg)
![图片](/images/0234springbootimg_004.jpg)
![图片](/images/0234springbootimg_009.jpg)
![图片](/images/0234springbootimg_020.jpg)
![图片](/images/0234springbootimg_008.jpg)
![图片](/images/0234springbootimg_018.jpg)
![图片](/images/0234springbootimg_019.jpg)
