...
# [ssm235基于HTML5的OA办公系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm235/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm235/blog.002.png)
...
![](/images/0200ssm/ssm235/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm235/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm235/blog.005.png)
...
![](/images/0200ssm/ssm235/blog.006.png)

图4.12  考勤打卡信息实体属性图

（2）待办工作实体属性图如图4.13所示：

![](/images/0200ssm/ssm235/blog.007.png)

图4.13  待办工作实体属性图

（3）管理员实体属性图如图4.14所示：

![](/images/0200ssm/ssm235/blog.008.png)
...
![](/images/0200ssm/ssm235/blog.010.png)

图5.1 员工信息管理界面
### 5.1.2 公告通知管理
系统管理员可以对公告通知进行添加，修改，删除操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm235/blog.011.png)

图5.3 公告通知管理界面
### 5.1.3 考勤记录管理
系统管理员可以对考勤记录进行统计以及删除操作。界面如下图所示：

![](/images/0200ssm/ssm235/blog.012.png)
...
![](/images/0200ssm/ssm235/blog.013.png)

图5.5 考勤打卡界面
### 5.2.2 我的邮件
用户登录后，点击我的邮件管理里面的我的邮件，就可以出现我的邮件界面，可以对邮件新增和查看操作。界面如下图所示：

![](/images/0200ssm/ssm235/blog.014.png)

图5.6 我的邮件界面
### 5.2.3 新建工作管理
用户登录后可以在新建工作管理里面点击新建工作操作。界面如下图所示：

![](/images/0200ssm/ssm235/blog.015.png)
