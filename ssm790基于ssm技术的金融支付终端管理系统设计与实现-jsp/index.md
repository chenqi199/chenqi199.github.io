...
# [ssm790基于ssm技术的金融支付终端管理系统设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0700ssm/ssm790/blog.001.png)
...
![](/images/0700ssm/ssm790/blog.002.png)
...
![](/images/0700ssm/ssm790/blog.007.png)

图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图。

![](/images/0700ssm/ssm790/blog.008.png)
...
![](/images/0700ssm/ssm790/blog.009.png)

图4.4 管理员实体属性图

（2）用户实体属性图见图4.5。

![](/images/0700ssm/ssm790/blog.010.png)

图4.5 教师实体属性图

（3）商品类别实体属性图见图4.6。

![](/images/0700ssm/ssm790/blog.011.png)
...
![](/images/0700ssm/ssm790/blog.012.png)

图5.1 用户管理页面
### 5.1.2 商品类别管理
如图5.2显示的就是商品类别管理页面，管理员可以对商品类别信息进行添加，修改，删除，查询操作。

![](/images/0700ssm/ssm790/blog.013.png)

图5.2 商品类别管理页面
### 5.1.3 商品信息管理
如图5.3显示的就是商品信息管理页面，管理员可以对商品信息信息修改，删除，批量删除以及查询操作。

![](/images/0700ssm/ssm790/blog.014.png)

图5.3商品信息管理页面
### 5.1.4 公告资讯管理
如图5.4显示的就是公告资讯页面，管理员可以对公告资讯信息进行审核操作。

![](/images/0700ssm/ssm790/blog.015.png)

图5.4 公告资讯页面
### 5.1.5 订单管理
如图5.5显示的就是订单页面，管理员可以查看用户订单，还可以发货操作。

![](/images/0700ssm/ssm790/blog.016.png)
...
![](/images/0700ssm/ssm790/blog.017.png)
...
![](/images/0700ssm/ssm790/blog.018.png)

图5.7 购物车页面
### 5.2.3 我的订单
如图5.4显示的就是我的订单页面，用户可以在我的订单里面查看订单状态，如果未发货还可以退款。

![](/images/0700ssm/ssm790/blog.019.png)
