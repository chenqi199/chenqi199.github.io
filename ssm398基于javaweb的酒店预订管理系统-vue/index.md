...
# [ssm398基于javaweb的酒店预订管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm398/blog.001.png)
...
![](/images/0300ssm/ssm398/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0300ssm/ssm398/blog.006.png)
...
![](/images/0300ssm/ssm398/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是用户实体E-R图

![](/images/0300ssm/ssm398/blog.008.png)

图4.8 用户实体E-R图

（3）下图就是房间类型信息实体E-R图

![](/images/0300ssm/ssm398/blog.009.png)
...
![](/images/0300ssm/ssm398/blog.010.png)

图5.1 用户信息管理页面
## 5.2 房间信息管理
管理员可以对房间信息进行查询和修改操作。下图就是房间信息管理页面。

![](/images/0300ssm/ssm398/blog.011.png)

图5.2房间信息管理页面
## 5.3 房间类型管理
管理员可以对房间类型进行修改，查询操作。下图就是房间类型管理页面。

![](/images/0300ssm/ssm398/blog.012.png)

图5.3 房间类型管理页面
## 5.4 房间预定管理
管理员可以对房间预定信息进行审核操作。下图就是房间预定信息管理页面。

![](/images/0300ssm/ssm398/blog.013.png)
