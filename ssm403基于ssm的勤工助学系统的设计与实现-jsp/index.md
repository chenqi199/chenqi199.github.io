...
# [ssm403基于SSM的勤工助学系统的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0400ssm/ssm403/blog.001.png)

图3-3登录流程图

![](/images/0400ssm/ssm403/blog.002.png)
...
![](/images/0400ssm/ssm403/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0400ssm/ssm403/blog.004.png)
...
![](/images/0400ssm/ssm403/blog.005.png)

图4.12  管理员信息实体属性图

（2）用户实体属性图如图4.13所示：

![](/images/0400ssm/ssm403/blog.006.png)

图4.13  用户实体属性图

（3）部门管理员实体属性图如图4.14所示：

![](/images/0400ssm/ssm403/blog.007.png)
...
![](/images/0400ssm/ssm403/blog.008.png)

图5.1 岗位信息管理界面
### 5.1.2 薪资发放管理
系统管理员可以对薪资发放进行添加，修改，删除，查询操作。具体界面如图5.2所示。

![](/images/0400ssm/ssm403/blog.009.png)

图5.3 薪资发放界面
### 5.1.3 用户信息管理
系统管理员可以对用户信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0400ssm/ssm403/blog.010.png)
...
![](/images/0400ssm/ssm403/blog.011.png)

图5.5 申请岗位界面
### 5.2.2 岗位审核
用户登录后，可以查看申请审核，申请审核是用户申请岗位后的审核状态。界面如下图所示：

![](/images/0400ssm/ssm403/blog.012.png)

图5.6 申请审核界面
### 5.2.3 公告信息
用户可以查看和查询公告信息。界面如下图所示：

![](/images/0400ssm/ssm403/blog.013.png)
