...
# [ssm698网络办公系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm698/blog.007.png)

图4.4 工作日程实体属性图

（2）共享文件包括的属性有文件类型，文件介绍，部门等。其属性图如下。

![](/images/0600ssm/ssm698/blog.008.png)

图4.5 共享文件实体属性图

（3）会议包括的属性有会议名称，会议图片，会议时间等。其属性图如下。

![](/images/0600ssm/ssm698/blog.009.png)

图4.6 会议实体属性图

（4）员工包括的属性有姓名，部门，手机号，性别等。其属性图如下。

![](/images/0600ssm/ssm698/blog.010.png)

图4.7 员工实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0600ssm/ssm698/blog.011.png)
