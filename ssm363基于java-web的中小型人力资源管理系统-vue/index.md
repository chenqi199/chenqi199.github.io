...
# [ssm363基于java web的中小型人力资源管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm363/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm363/blog.002.png)
...
![](/images/0300ssm/ssm363/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0300ssm/ssm363/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的人事管理员功能结构图如下图所示：

![](/images/0300ssm/ssm363/blog.005.png)

图4-3 人事管理员功能结构图

本系统是基于B/S架构的网站系统，设计的员工功能结构图如下图所示：

![](/images/0300ssm/ssm363/blog.006.png)
...
![](/images/0300ssm/ssm363/blog.007.png)

图4.12  员工信息实体属性图

（2）员工培训信息实体属性图如图4.13所示：

![](/images/0300ssm/ssm363/blog.008.png)

图4.13  员工培训信息实体属性图

（3）管理员信息实体属性图如图4.14所示：

![](/images/0300ssm/ssm363/blog.009.png)
...
![](/images/0300ssm/ssm363/blog.012.png)

图5.1 人事管理员管理界面
### 5.1.2 普通员工管理
系统管理员可以对普通员工信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm363/blog.013.png)
...
![](/images/0300ssm/ssm363/blog.014.png)

图5.3 普通员工信息管理界面
### 5.2.1 调休申请管理
人事管理员可以对项目结项信息进行修改操作，还可以对项目结项信息进行查询。界面如下图所示：

![](/images/0300ssm/ssm363/blog.015.png)
...
![](/images/0300ssm/ssm363/blog.016.png)

图5.5 入职信息界面
### 5.2.3 岗位调动信息
员工登录后可以查看岗位调动。界面如下图所示：

![](/images/0300ssm/ssm363/blog.017.png)
