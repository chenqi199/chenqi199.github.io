...
# [ssm661基于Web的数字家庭网站设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=60)
...
![](/images/0600ssm/ssm661/blog.001.png)
...
1. ### 法律可行性
` `我是通过图书馆、百度文库、百度网页等获得的开发该数字家庭网站所需要用到的资料和软件，都是采用的合法渠道，另外源代码和论文内容都是我自己一字一字写出来的，没有抄袭别人的，具有法律可行性。

通过上述的技术可行性、操作可行性、经济可行性以及法律可行性分析，可以看出，该数字家庭网站完全可以进行顺利开发。
1. ## 系统性能分析
1. 存储性：该数字家庭网站的数据库功能比较强大，能够录入很多纷繁复杂的信息，且能够保证数据的实时性；

二、易学性：该数字家庭网站使用起来非常简单，用户一看就会，不需要进行专门的培训，非常好上手，使用个一两次就能够熟练操作；
...
![](/images/0600ssm/ssm661/blog.002.png)
...
![](/images/0600ssm/ssm661/blog.005.png)
...
![](/images/0600ssm/ssm661/blog.006.png)
...
![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\论坛.jpg](/images/0600ssm/ssm661/blog.007.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\论坛.jpg")
图4.1 论坛实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\用户.jpg](/images/0600ssm/ssm661/blog.008.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\用户.jpg")
图4.2 用户实体属性图

（3）下图是家庭日记实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭日记.jpg](/images/0600ssm/ssm661/blog.009.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭日记.jpg")
图4.3 家庭日记实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\字典表.jpg](/images/0600ssm/ssm661/blog.010.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是家庭亲子视频实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭亲子视频.jpg](/images/0600ssm/ssm661/blog.011.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭亲子视频.jpg")
图4.5 家庭亲子视频实体属性图

（6）下图是亲友动态实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\亲友动态.jpg](/images/0600ssm/ssm661/blog.012.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\亲友动态.jpg")
图4.6 亲友动态实体属性图

（7）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\用户表.jpg](/images/0600ssm/ssm661/blog.013.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\用户表.jpg")
图4.7 用户表实体属性图

（8）下图是家庭寄语实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭寄语.jpg](/images/0600ssm/ssm661/blog.014.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\家庭寄语.jpg")
图4.8 家庭寄语实体属性图

（9）下图是新闻信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\新闻信息.jpg](/images/0600ssm/ssm661/blog.015.jpeg "C:\Users\Administrator\Desktop\img\shuzijiatingwangzhan\新闻信息.jpg")
图4.9 新闻信息实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiatingriji\_name|String|寄语标题|是|
|3|jiatingjiyu\_text|String|寄语内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiatingqinzishipin\_name|String|亲子视频标题|是|
|3|jiatingqinzishipin\_types|Integer|视频类型|是|
|4|jiatingqinzishipin\_photo|String|封面|是|
|5|jiatingqinzishipin\_video|String|视频类型|是|
|6|yonghu\_id|Integer|用户|是|
|7|jiatingqinzishipin\_content|String|视频详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiatingriji\_name|String|日记标题|是|
|3|jiatingriji\_types|Integer|日记类型|是|
|4|jiatingriji\_photo|String|图片|是|
|5|yonghu\_id|Integer|用户|是|
|6|jiatingriji\_time|Date|记录日期|是|
|7|jiatingriji\_content|String|日记内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|qinyoumokuai\_name|String|动态标题|是|
|3|qinyoumokuai\_types|Integer|动态类型|是|
|4|qinyoumokuai\_photo|String|封面|是|
|5|yonghu\_id|Integer|用户|是|
|6|qinyoumokuai\_content|String|动态详情|是|
...
![](/images/0600ssm/ssm661/blog.018.png)

图5.3 家庭视频管理页面
### 5.1新闻信息管理
如图5.4显示的就是新闻信息管理页面，此页面提供给管理员的功能有：根据新闻信息进行新增、修改、查询操作等等。

![](/images/0600ssm/ssm661/blog.019.png)
