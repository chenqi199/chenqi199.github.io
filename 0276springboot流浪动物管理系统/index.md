...
![](/images/0200stringboot/0276springboot/blog.015.png)

图4-3 用户实体属性图

（2）使用Visio这样的常用的实体属性图绘制工具来绘制宠物寄养实体属性图，绘制结果见图4-4。

![](/images/0200stringboot/0276springboot/blog.016.png)

图4-4 宠物寄养实体属性图

（3）使用Visio这样的常用的实体属性图绘制工具来绘制宠物领养实体属性图，绘制结果见图4-5。

![](/images/0200stringboot/0276springboot/blog.017.png)

图4-5 宠物领养实体属性图

（4）使用Visio这样的常用的实体属性图绘制工具来绘制管理员实体属性图，绘制结果见图4-6。

![](/images/0200stringboot/0276springboot/blog.018.png)

图4-6 管理员实体属性图

（5）绘制的上述实体间存在的联系见图4-7。

![](/images/0200stringboot/0276springboot/blog.019.png)
...
![](/images/0200stringboot/0276springboot/blog.025.png)

图5-5 论坛管理界面
### 5.2.2 宠物寄养查看
自愿者进入如图5-6所示的宠物寄养查看界面之后，自愿者点击信息显示栏中最右侧的详情按钮可完成宠物寄养信息的详情查看操作，自愿者也能查询宠物寄养信息，查询条件包括根据宠物名称或宠物类型等字段进行查询。

![](/images/0200stringboot/0276springboot/blog.026.png)
