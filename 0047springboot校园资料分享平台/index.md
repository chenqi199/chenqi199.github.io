...
# [0047springboot校园资料分享平台](https://github.com/GraduationProject-springboot/0047springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0047springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0047springboot/blog.002.png)
...
![](/images/0000stringboot/0047springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0000stringboot/0047springboot/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的学生功能结构图如下图所示：

![](/images/0000stringboot/0047springboot/blog.005.png)
...
![](/images/0000stringboot/0047springboot/blog.006.png)

图4.12  学生信息实体属性图

（2）资料分享实体属性图如图4.13所示：

![](/images/0000stringboot/0047springboot/blog.007.png)

图4.13  资料分享实体属性图

（3）资源分类类型实体属性图如图4.14所示：

![](/images/0000stringboot/0047springboot/blog.008.png)
...
![](/images/0000stringboot/0047springboot/blog.010.png)

图5.1 学生信息管理界面
### 5.1.2 学生统计管理
系统管理员可以对学生数据进行统计。具体界面如图5.2所示。

![](/images/0000stringboot/0047springboot/blog.011.png)

图5.2 学生统计界面
### 5.1.3 资料分享管理
系统管理员可以对资料分享信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0000stringboot/0047springboot/blog.012.png)

图5.3 资料分享信息管理界面
### 5.1.4 公告资讯管理
系统管理员可以对公告资讯信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0000stringboot/0047springboot/blog.013.png)
...
![](/images/0000stringboot/0047springboot/blog.014.png)

图5.5 首页资料分享界面
### 5.2.2 资料分享评论
学生登录后点击资料分享，点击资料信息后可以进行评论操作。界面如下图所示：

![](/images/0000stringboot/0047springboot/blog.015.png)

图5.6 资料分享评论界面
### 5.2.3 我的收藏
学生登录后可以在个人中心里面的我的收藏查看自己收藏的资料信息。界面如下图所示：

![](/images/0000stringboot/0047springboot/blog.016.png)
