...
# [ssm801学生奖惩管理系统+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0800ssm/ssm801/blog.005.png)

图3-5 管理员用例图

学生用例图的绘制结果见图3-6。学生登录进入本系统操作的功能包括查询出勤率，查询成绩，查询奖惩信息，增删改查分数记录信息等。

![](/images/0800ssm/ssm801/blog.006.png)
...
![](/images/0800ssm/ssm801/blog.007.png)

图4-1 管理员功能结构图

学生功能结构图的绘制结果见图4-2。学生登录进入本系统操作的功能包括查询出勤率，查询成绩，查询奖惩信息，增删改查分数记录信息等。

![](/images/0800ssm/ssm801/blog.008.png)
...
![](/images/0800ssm/ssm801/blog.009.png)

图4-3 学生实体属性图

（2）使用Visio这样的常用的实体属性图绘制工具来绘制出勤率实体属性图，绘制结果见图4-4。

![](/images/0800ssm/ssm801/blog.010.png)

图4-4 出勤率实体属性图

（3）使用Visio这样的常用的实体属性图绘制工具来绘制分数记录实体属性图，绘制结果见图4-5。

![](/images/0800ssm/ssm801/blog.011.png)

图4-5分数记录实体属性图

（4）使用Visio这样的常用的实体属性图绘制工具来绘制成绩实体属性图，绘制结果见图4-6。

![](/images/0800ssm/ssm801/blog.012.png)

图4-6 成绩实体属性图

（5）使用Visio这样的常用的实体属性图绘制工具来绘制奖惩实体属性图，绘制结果见图4-7。

![](/images/0800ssm/ssm801/blog.013.png)

图4-7 奖惩实体属性图

（6）绘制的上述实体间存在的联系见图4-8。

![](/images/0800ssm/ssm801/blog.014.png)
