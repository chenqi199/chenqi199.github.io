...
![](/images/0200stringboot/0243springboot/blog.001.png)
...
![](/images/0200stringboot/0243springboot/blog.002.png)

图3.2 注册流程图

当需要用户登录的时候，肯定是要验证的，只有验证通过的用户才可以进行下一步操作，用户登录成功代表着用户模块的功能对登录用户进行了开放。流程就是如下面的图所示。

![](/images/0200stringboot/0243springboot/blog.003.png)
...
![](/images/0200stringboot/0243springboot/blog.004.png)

图3.4 管理员用例图

用户对于智慧生活商城系统操作的功能包括在前台购买商品，管理收货地址，管理购买的商品信息，查看公告，管理购物车，对需要退货的订单商品申请退货等。其用例图如图3.5所示：

![](/images/0200stringboot/0243springboot/blog.005.png)
...
![](/images/0200stringboot/0243springboot/blog.008.png)

图4.4 商品实体属性图

（2）商品订单包括的属性有购买数量，订单类型，支付类型等。其属性图如下。

![](/images/0200stringboot/0243springboot/blog.009.png)

图4.5 商品订单实体属性图

（3）管理员包括的属性有用户名，角色等。其属性图如下。

![](/images/0200stringboot/0243springboot/blog.010.png)

图4.6 管理员实体属性图

（4）用户包括的属性有用户头像，性别，电子邮箱等。其属性图如下。

![](/images/0200stringboot/0243springboot/blog.011.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0200stringboot/0243springboot/blog.012.png)
...
![](/images/0200stringboot/0243springboot/blog.014.png)
