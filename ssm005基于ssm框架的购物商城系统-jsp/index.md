...
# [ssm005基于SSM框架的购物商城系统+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0000ssm/ssm005/blog.001.png)
...
![](/images/0000ssm/ssm005/blog.002.png)

图3.2 注册流程图

访问者操作系统，前提是需要验证身份，而登录功能的设置就是把本系统的用户引导进入后台操作区，把不是本系统的用户拒之门外。其流程见下图。

![](/images/0000ssm/ssm005/blog.003.png)
...
![](/images/0000ssm/ssm005/blog.004.png)

图3.4 管理员用例图

购物商城系统设置了用户权限，其用例图见下图。用户管理收货地址，管理不同状态的订单，收藏商品，评价商品。

![](/images/0000ssm/ssm005/blog.005.png)
...
![](/images/0000ssm/ssm005/blog.006.png)

图4.1 管理员功能结构图

设计的用户的详细功能见下图，用户管理收货地址，管理不同状态的订单，收藏商品，评价商品。

![](/images/0000ssm/ssm005/blog.007.png)
...
![](/images/0000ssm/ssm005/blog.008.png)

图4.4 订单实体属性图

（2）设计的商品实体，其具备的属性见下图。商品实体包括的属性值有品牌，规格，原价，数量，商品分类等信息。

![](/images/0000ssm/ssm005/blog.009.png)

图4.5 商品实体属性图

（3）设计的用户实体，其具备的属性见下图。用户实体包括的属性值有用户姓名，密码，联系电话，电子邮箱等信息。

![](/images/0000ssm/ssm005/blog.010.png)

图4.6 用户实体属性图

（4）设计的购物车实体，其具备的属性见下图。购物车实体包括的属性值有商品名称，用户，创建时间，购买数量，单价等信息。

![](/images/0000ssm/ssm005/blog.011.png)

图4.7 购物车实体属性图

（5）设计的各实体间关系见下图。

![](/images/0000ssm/ssm005/blog.012.png)
