...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1ULbQeREgz?p=60)
...
![](/images/0400stringboot/0460springboot/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0400stringboot/0460springboot/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0400stringboot/0460springboot/blog.003.png)
...
![结构设计图](/images/0400stringboot/0460springboot/blog.004.jpeg "结构设计图")![结构设计图](/images/0400stringboot/0460springboot/blog.004.jpeg "结构设计图")
...
![](/images/0400stringboot/0460springboot/blog.005.png "IMG\_256")
考试记录表实体属性图

（2）下图是教师实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.006.png "IMG\_257")
教师实体属性图

（3）下图是答题详情表实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.007.png "IMG\_258")
答题详情表实体属性图

（4）下图是公告信息实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.008.png "IMG\_259")
公告信息实体属性图

（5）下图是操作日志实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.009.png "IMG\_260")
操作日志实体属性图

（6）下图是试卷选题实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.010.png "IMG\_261")
试卷选题实体属性图

（7）下图是错题表实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.011.png "IMG\_262")
错题表实体属性图

（8）下图是论坛实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.012.png "IMG\_263")
论坛实体属性图

（9）下图是试卷表实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.013.png "IMG\_264")
试卷表实体属性图

（10）下图是留言板实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.014.png "IMG\_265")
留言板实体属性图

（11）下图是学生实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.015.png "IMG\_266")
学生实体属性图

（12）下图是试题表实体和其具备的属性。

![](/images/0400stringboot/0460springboot/blog.016.png "IMG\_267")
试题表实体属性图
...
![](/images/0400stringboot/0460springboot/blog.017.png)
...
![](/images/0400stringboot/0460springboot/blog.018.png)

图5.2 教师信息管理页面
### 5.3试卷信息管理
如图5.3显示的就是试卷信息管理页面，此页面提供给管理员的功能有：根据试卷信息进行条件查询，还可以对试卷信息进行新增、修改、查询操作等等。

![](/images/0400stringboot/0460springboot/blog.019.png)
...
![](/images/0400stringboot/0460springboot/blog.020.png)
