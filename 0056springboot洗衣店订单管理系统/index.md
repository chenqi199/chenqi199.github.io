...
# [0056springboot洗衣店订单管理系统](https://github.com/GraduationProject-springboot/0056springboot)
...
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV16ia6epENY?p=57)
...
# 3系统分析
## 3.1可行性分析
通过对本洗衣店订单管理系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本洗衣店订单管理系统采用JAVA作为开发语言，Spring Boot框架，是基于WEB平台的B/S架构系统。
...
因此，洗衣店订单管理系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本洗衣店订单管理系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本洗衣店订单管理系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此洗衣店订单管理系统要严格控制管理权限，具体要求如下：

（1）要想对洗衣店订单管理系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0056springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0056springboot/blog.002.png)
...
![](/images/0000stringboot/0056springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0000stringboot/0056springboot/blog.004.png)

图4-1管理员功能结构图

本系统是基于B/S架构的网站系统，设计的店家功能结构图如下图所示：

![](/images/0000stringboot/0056springboot/blog.005.png)

图4-2店家功能结构图

本系统是基于B/S架构的网站系统，设计的顾客功能结构图如下图所示：

![](/images/0000stringboot/0056springboot/blog.006.png)
...
![](/images/0000stringboot/0056springboot/blog.007.png)

图4.12  顾客信息实体属性图

（2）店家信息实体属性图如图4.13所示：

![](/images/0000stringboot/0056springboot/blog.008.png)

图4.13  店家信息实体属性图

（3）管理员信息实体属性图如图4.14所示：

![](/images/0000stringboot/0056springboot/blog.009.png)

图4.14 管理员信息实体属性图
### 4.3.2数据库设计表
洗衣店订单管理系统需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
|dianpuzhaopian|varchar(200)|是|NULL|店铺照片|
...
|yifushuliang|varchar(200)|是|NULL|衣服数量|
|dangqianjindu|varchar(200)|是|NULL|当前进度|
|dianjiazhanghao|varchar(200)|是|NULL|店家账号|
|dianjiaxingming|varchar(200)|是|NULL|店家姓名|
|shoujihaoma|varchar(200)|是|NULL|手机号码|
|gukezhanghao|varchar(200)|是|NULL|顾客账号|
...
|gukezhanghao|varchar(200)|是|NULL|顾客账号|
|gukexingming|varchar(200)|是|NULL|顾客姓名|
|jiatingdizhi|varchar(200)|是|NULL|家庭地址|
|zhifupingzheng|varchar(200)|是|NULL|支付凭证|
|beizhu|longtext|是|NULL|备注|
|sfsh|varchar(200)|是|否|是否审核|
|shhf|longtext|是|NULL|审核回复|
表4.5 店铺信息评论表
...
|id (主键)|bigint(20)|否||主键|
|addtime|timestamp|否|CURRENT\_TIMESTAMP|创建时间|
|gukezhanghao|varchar(200)|否||顾客账号|
|mima|varchar(200)|否||密码|
|gukexingming|varchar(200)|是|NULL|顾客姓名|
|xingbie|varchar(200)|是|NULL|性别|
|shoujihaoma|varchar(200)|是|NULL|手机号码|
...
![](/images/0000stringboot/0056springboot/blog.010.png)

图5.1 顾客信息管理界面
### 5.1.2 店家信息管理
系统管理员可以查看对店家信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0000stringboot/0056springboot/blog.011.png)
...
![](/images/0000stringboot/0056springboot/blog.012.png)

图5.3 店铺信息信息管理界面
### 5.2.1 洗衣信息管理
店家可以对报洗衣信息信息进行查询，审核等操作。界面如下图所示：

![](/images/0000stringboot/0056springboot/blog.013.png)
...
![](/images/0000stringboot/0056springboot/blog.014.png)

图5.5 预约界面
### 5.2.3 洗衣信息
顾客登录后在后台的洗衣信息可以查看自己的洗衣信息。界面如下图所示：

![](/images/0000stringboot/0056springboot/blog.015.png)
...
![](/images/0000stringboot/0056springboot/blog.016.png)
