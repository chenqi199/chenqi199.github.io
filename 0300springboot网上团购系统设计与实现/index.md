...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1T1bpekEK7&bvid=BV1T1bpekEK7&cid=500001612665249&p=1)
...
社会发展日新月异，用计算机应用实现数据管理功能已经算是很完善的了，但是随着移动互联网的到来，处理信息不再受制于地理位置的限制，处理信息及时高效，备受人们的喜爱。本次开发一套网上团购系统有管理员和用户两个角色。管理员功能有个人中心，用户管理，商品类别管理，团购商品管理，订单管理，系统管理。用户可以注册登录，查看公告信息，对可以团购的商品进行团购操作，把团购商品加入到购物车里，支付后变成订单信息。网上团购系统服务端用Java开发，用Spring
Boot框架开发的网站后台，前台采用支持HTML5的VUE框架，数据库用到了MySQL数据库作为数据的存储。这样就让用户用着方便快捷，都通过同一个后台进行业务处理，而后台又可以根据并发量做好部署，用硬件和软件进行协作，满足于数据的交互式处理，让用户的数据存储更安全，得到数据更方便。

**关键字：**网上团购系统；Spring Boot框架；Java；MySQL；HTML5;VUE框架
...
development of an online group buying system has two roles of
administrator and user. The administrator functions include personal
center, user management, commodity category management, group purchase
commodity management, order management, and system management. Users can
register and log in, view announcement information, perform group
purchase operations on products that can be group-purchased, add
group-purchased products to the shopping cart, and turn into order
information after payment. The server side of the online group
purchasing system is developed with Java, the backend of the website
developed with the Spring Boot framework, the VUE framework that
supports HTML5 is used in the front desk, and the database uses the
MySQL database as the data storage. In this way, users can use it
conveniently and quickly, and they all process business through the same
background, and the background can be deployed according to the amount
of concurrency, using hardware and software to cooperate, satisfying the
interactive processing of data, and allowing users to store more data.
Safe and easy to get data.

**Key Words：**Online group purchase system; Spring Boot framework;
Java; MySQL; HTML5; VUE framework

[]{#__RefHeading___Toc28196 .anchor}

[摘 要 I](#摘-要)

[目 录 III](#__RefHeading___Toc28196)
...
[4.1 系统设计的原则 11](#__RefHeading___Toc30767)

[4.2 功能结构设计 11](#功能结构设计)

[4.3 数据库设计 12](#数据库设计)

[4.3.1 数据库E-R图 12](#数据库e-r图)

[4.3.2 数据库表结构 14](#数据库表结构)
...
[5.1.2 商品类别管理 17](#商品类别管理)

[5.1.3 团购商品信息管理 18](#团购商品信息管理)

[5.1.4 订单管理 19](#订单管理)

[5.2 用户功能实现 19](#用户功能实现)

[5.2.1 团购商品信息 19](#团购商品信息)
...
[第6章 系统测试 23](#__RefHeading___Toc19348)
...
HTML , HTML 4.01的上一个版本诞生于 1999 年。自从那以后，Web
世界已经经历了巨变。
...
WHATWG 致力于 web 表单和应用程序，而 W3C 专注于 XHTML 2.0。在 2006
...
[]{#__RefHeading___Toc19348 .anchor}
...
网上团购系统在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的网上团购系统符合用户需求，它投入运行使用带给用户的便利是显而易见的。

# 结 论

网上团购系统的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。这也是我第一次使用Spring
Boot框架语言，开发的这个比较简单的网上团购系统。

网上团购系统开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
网上团购系统现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0300springboot网上团购系统设计与实现 项目图片
![图片](/images/0300springbootimg_014.jpg)
![图片](/images/0300springbootimg_015.jpg)
![图片](/images/0300springbootimg_001.jpg)
![图片](/images/0300springbootimg_017.jpg)
![图片](/images/0300springbootimg_003.jpg)
![图片](/images/0300springbootimg_002.jpg)
![图片](/images/0300springbootimg_016.jpg)
![图片](/images/0300springbootimg_012.jpg)
![图片](/images/0300springbootimg_006.jpg)
![图片](/images/0300springbootimg_007.jpg)
![图片](/images/0300springbootimg_013.jpg)
![图片](/images/0300springbootimg_005.jpg)
![图片](/images/0300springbootimg_011.jpg)
![图片](/images/0300springbootimg_010.jpg)
![图片](/images/0300springbootimg_004.jpg)
![图片](/images/0300springbootimg_009.jpg)
![图片](/images/0300springbootimg_008.jpg)
![图片](/images/0300springbootimg_018.jpg)
![图片](/images/0300springbootimg_019.jpg)
