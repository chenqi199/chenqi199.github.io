...
# [ssm676基于VUE的儿童教育网站的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm676/blog.004.png)
...
删文章删除
![](/images/0600ssm/ssm676/blog.007.png)
...
![用户](/images/0600ssm/ssm676/blog.008.jpeg "用户")
图4.1 用户实体属性图

（2）下图是文章留言实体和其具备的属性。

![文章留言](/images/0600ssm/ssm676/blog.009.jpeg "文章留言")
图4.2 文章留言实体属性图

（3）下图是文章目录实体和其具备的属性。

![文章目录](/images/0600ssm/ssm676/blog.010.jpeg "文章目录")
图4.3 文章目录实体属性图

（4）下图是文章目录收藏实体和其具备的属性。

![文章目录收藏](/images/0600ssm/ssm676/blog.011.jpeg "文章目录收藏")
图4.4 文章目录收藏实体属性图

（5）下图是章节收藏实体和其具备的属性。

![章节收藏](/images/0600ssm/ssm676/blog.012.jpeg "章节收藏")
图4.5 章节收藏实体属性图

（6）下图是章节实体和其具备的属性。

![章节](/images/0600ssm/ssm676/blog.013.jpeg "章节")
图4.6 章节实体属性图

（7）下图是视频收藏实体和其具备的属性。

![视频收藏](/images/0600ssm/ssm676/blog.014.jpeg "视频收藏")
图4.7 视频收藏实体属性图

（8）下图是名师实体和其具备的属性。

![名师](/images/0600ssm/ssm676/blog.015.jpeg "名师")
图4.8 名师实体属性图

（9）下图是文章收藏实体和其具备的属性。

![文章收藏](/images/0600ssm/ssm676/blog.016.jpeg "文章收藏")
图4.9 文章收藏实体属性图

（10）下图是文章实体和其具备的属性。

![文章](/images/0600ssm/ssm676/blog.017.jpeg "文章")
图4.10 文章实体属性图

（11）下图是视频实体和其具备的属性。

![视频](/images/0600ssm/ssm676/blog.018.jpeg "视频")
图4.11 视频实体属性图

（12）下图是视频留言实体和其具备的属性。

![视频留言](/images/0600ssm/ssm676/blog.019.jpeg "视频留言")
图4.12 视频留言实体属性图
