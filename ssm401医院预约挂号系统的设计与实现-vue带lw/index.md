# ssm401医院预约挂号系统的设计与实现+vue带lw


# [项目清单 包安装运行](http://chenqi1990.site) 官网地址 http://chenqi1990.site

# [ssm401医院预约挂号系统的设计与实现+vue带lw](https://github.com/GraduationProject-springboot/)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=2)
...
# 3系统分析
## 3.1可行性分析
通过对本医院预约挂号系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本医院预约挂号系统采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
因此，医院预约挂号系统在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本医院预约挂号系统采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本医院预约挂号系统的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此医院预约挂号系统要严格控制管理权限，具体要求如下：

（1）要想对医院预约挂号系统进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
## 3.4系统流程和逻辑
![](/images/0400ssm/ssm401/blog.001.png)

图3-3登录流程图

![](/images/0400ssm/ssm401/blog.002.png)
...
![](/images/0400ssm/ssm401/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0400ssm/ssm401/blog.004.png)
...
![](/images/0400ssm/ssm401/blog.005.png)

图4.12  管理员信息实体属性图

（2）科室分类信息实体属性图如图4.13所示：

![](/images/0400ssm/ssm401/blog.006.png)

图4.13  科室分类信息实体属性图

（3）医生信息实体属性图如图4.14所示：

![](/images/0400ssm/ssm401/blog.007.png)
...
![](/images/0400ssm/ssm401/blog.010.png)

图5.1 医生信息管理界面
## 5.2 科室信息管理
系统管理员可以对科室信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0400ssm/ssm401/blog.011.png)

图5.2 科室信息管理界面
## 5.3 投诉处理管理
系统管理员可以查看投诉处理并可以进行删除。界面如下图所示：

![](/images/0400ssm/ssm401/blog.012.png)

图5.3 投诉处理界面
## 5.4 用户预约挂号
用户可以对医生进行预约挂号操作可以进行支付。界面如下图所示：

![](/images/0400ssm/ssm401/blog.013.png)
...
![](/images/0400ssm/ssm401/blog.014.png)

图5.5 用户投诉界面
## 5.6 医生预约挂号
医生可以在预约挂号看到用户的挂号信息。界面如下图所示：

![](/images/0400ssm/ssm401/blog.015.png)
