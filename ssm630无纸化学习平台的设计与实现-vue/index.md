...
# [ssm630无纸化学习平台的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm630/blog.001.png)
...
![](/images/0600ssm/ssm630/blog.002.png)
...
![](/images/0600ssm/ssm630/blog.005.png)
...
![](/images/0600ssm/ssm630/blog.006.png)
...
![](/images/0600ssm/ssm630/blog.007.png)

![](/images/0600ssm/ssm630/blog.008.png)

图5.1 学生信息管理页面
### 5.2 教师信息管理
如图5.2显示的就是教师信息管理页面，此页面提供给管理员的功能有：查看已发布的教师信息数据，修改教师信息，教师信息作废，即可删除，还进行了对教师信息名称的模糊查询 教师信息信息的类型查询等等一些条件。

![](/images/0600ssm/ssm630/blog.009.png)
...
![](/images/0600ssm/ssm630/blog.010.png)

![](/images/0600ssm/ssm630/blog.011.png)

图5.3 课程信息管理页面
### 5.1作业信息管理
如图5.4显示的就是作业信息管理页面，此页面提供给管理员的功能有：根据作业信息进行新增、修改、查询操作等等。

![](/images/0600ssm/ssm630/blog.012.png)
