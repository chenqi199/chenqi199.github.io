...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1ULbQeREgz&bvid=BV1ULbQeREgz&cid=500001616870008&p=12)
...
![](media/image21.jpeg){width="5.555555555555555in"
height="2.9854166666666666in"}\
收货地址实体属性图
...
表4.2笔记广场表
  ...
  ------ ------------------ -------------------- ------------------- --------
   序号         列名              数据类型              说明          允许空
    ...
    3        biji_name             String             笔记名称          是

    4     biji_uuid_number         String             笔记编号          是

    5        biji_photo            String             笔记照片          是

    6        zan_number           Integer                赞             是

    7        cai_number           Integer                踩             是

    8        biji_types           Integer             笔记类型          是

    9       biji_content           String             笔记内容          是

    10      insert_time             Date              发布时间          是
...
表4.3笔记收藏表
  ...
  ------ ----------------------- -------------------- ------------------- --------
   序号           列名                 数据类型              说明          允许空
    ...
    2            biji_id               Integer               笔记            是

    3           yonghu_id              Integer               用户            是

    4     biji_collection_types        Integer               类型            是
...
表4.4笔记留言表
  ...
  ------ ------------------ -------------------- ------------------- --------
   序号         列名              数据类型              说明          允许空
    ...
    4     biji_liuyan_text         String             留言内容          是
...
表4.8我的关注表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    3     guanzhu_uuid_number          String             关注编号          是

    4     guanzhu_kucun_number        Integer              关注人           是

    5         insert_time               Date              关注时间          是
...
表4.9日常任务表
  ...
  ------ ------------------------------- -------------------- ------------------- --------
   序号               列名                     数据类型              说明          允许空
    ...
    2       richangrenwu_uuid_number            String           日常任务编号        是

    3           richangrenwu_name               String           日常任务标题        是

    4          richangrenwu_types              Integer           日常任务类型        是

    5          richangrenwu_jifen             BigDecimal           任务积分          是

    6         richangrenwu_content              String             任务内容          是

    7     richangrenwu_wancheng_content         String             完成标准          是
...
表4.10领取任务表
  ...
  ------ --------------------------------- -------------------- ------------------- --------
   序号                列名                      数据类型              说明          允许空
    ...
    2             richangrenwu_id                Integer             日常任务          是

    3                yonghu_id                   Integer               用户            是

    4     richangrenwu_lingqu_uuid_number         String           领取任务编号        是

    5        richangrenwu_lingqu_time              Date              所属日期          是

    6               insert_time                    Date              领取时间          是

    7        richangrenwu_lingqu_types           Integer             任务状态          是

    8     richangrenwu_lingqu_yesno_types        Integer             审核状态          是

    9     richangrenwu_lingqu_yesno_text          String             审核回复          是

    10    richangrenwu_lingqu_shenhe_time          Date              审核时间          是
...
表4.11商品表
  ...
  ------ ----------------------- -------------------- ------------------- --------
   序号           列名                 数据类型              说明          允许空
    ...
    9      shangpin_new_money         BigDecimal           所需积分          是

    10       shangpin_cangku            String             所属仓库          是
...
表4.14商品兑换表
  ...
  ------ ------------------------------- -------------------- ------------------- --------
   序号               列名                     数据类型              说明          允许空
    ...
    6              buy_number                  Integer             兑换数量          是

    7       shangpin_order_true_price         BigDecimal           花费积分          是
...
表4.15用户表
  ...
  ------ ------------------ -------------------- ------------------- --------
   序号         列名              数据类型              说明          允许空
    ...
    7        new_money           BigDecimal             积分            是

    8      yonghu_content          String             用户介绍          是
...
![](media/image24.png){width="6.285416666666666in"
height="3.5208333333333335in"}
...
![](media/image26.png){width="6.285416666666666in"
height="3.5208333333333335in"}
...
笔记记录分享网站在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的笔记记录分享网站符合用户需求，它在用户电脑上运行使用带给用户的便利是显而易见的。

# 结 论

笔记记录分享网站的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。从笔记记录分享网站的前台页面实现，到笔记记录分享网站的后台代码的编辑，我用到的软件包括了数据库软件Mysql，Java开发工具IDEA，办公软件Office，浏览器软件Fireworks，图像处理软件Photoshop等，这也是我第一次使用Java语言，开发的这个比较简单的笔记记录分享网站。

笔记记录分享网站开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
笔记记录分享网站现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0411springboot笔记记录分享网站--论文pf 项目图片
![图片](/images/0411springbootimg_014.jpg)
![图片](/images/0411springbootimg_015.jpg)
![图片](/images/0411springbootimg_001.jpg)
![图片](/images/0411springbootimg_003.jpg)
![图片](/images/0411springbootimg_002.jpg)
![图片](/images/0411springbootimg_012.jpg)
![图片](/images/0411springbootimg_006.jpg)
![图片](/images/0411springbootimg_007.jpg)
![图片](/images/0411springbootimg_013.jpg)
![图片](/images/0411springbootimg_005.jpg)
![图片](/images/0411springbootimg_011.jpg)
![图片](/images/0411springbootimg_010.jpg)
![图片](/images/0411springbootimg_004.jpg)
![图片](/images/0411springbootimg_009.jpg)
![图片](/images/0411springbootimg_008.jpg)
