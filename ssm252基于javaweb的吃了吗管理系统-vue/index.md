...
# [ssm252基于javaweb的吃了吗管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm252/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm252/blog.002.png)
...
![](/images/0200ssm/ssm252/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
设计的管理员主要是为用户提供的一些信息进行服务的。设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm252/blog.004.png)

图4-2管理员功能结构图

设计的用店家功能结构图如下图所示：

![](/images/0200ssm/ssm252/blog.005.png)

图4-2管理员功能结构图

设计的用户功能结构图如下图所示：

![](/images/0200ssm/ssm252/blog.006.png)
...
![](/images/0200ssm/ssm252/blog.007.png)

图4.12  美食信息实体属性图

（2）店家实体属性图如图4.13所示：

![](/images/0200ssm/ssm252/blog.008.png)

图4.13  店家实体属性图

（3）店铺分类信息实体属性图如图4.14所示：

![](/images/0200ssm/ssm252/blog.009.png)
...
![](/images/0200ssm/ssm252/blog.011.png)

图5.1 店家信息界面
### 5.1.2 用户信息管理
管理员可以对用户进行查询修改，删除操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm252/blog.012.png)

图5.2 用户信息管理界面
### 5.1.3 店铺分类管理
管理员可以对店铺分类进行查询修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm252/blog.013.png)
...
![](/images/0200ssm/ssm252/blog.014.png)

图5.4 个人信息管理界面
### 5.2.2 美食信息管理
店家可以对美食信息进行添加修改删除操作。界面如下图所示：

![](/images/0200ssm/ssm252/blog.015.png)
