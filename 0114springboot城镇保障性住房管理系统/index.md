...
# [0114springboot城镇保障性住房管理系统](https://github.com/GraduationProject-springboot/0114springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610720976&p=14)
...
Boot框架，MYSQL数据库设计开发，充分保证系统的稳定性。系统具有界面清晰、操作简单，功能齐全的特点，使得城镇保障性住房管理系统管理工作系统化、规范化。本系统的使用使管理人员从繁重的工作中解脱出来，实现无纸化办公，能够有效的提高城镇保障性住房管理系统管理效率。
...
whole process of the development of urban security housing management
system. Through analyzing the deficiency of the management system of
urban security housing, a computer management scheme of urban security
housing management system is established. This paper introduces the
system analysis part of urban security housing management system,
...
Administrator and user of the urban security housing management system.
The functions of administrator include personal center, user management,
house type management, housing source information management, housing
source application management, housing distribution management, message
board management, system management, etc. Therefore, it has certain
practicability.
...
management of urban security housing management system systematic and
standardized. The use of this system makes the managers free from the
heavy work, realizes paperless office, and can effectively improve the
management efficiency of urban security housing management system.

**Keywords:** Urban affordable housing management system; Spring boot
...
[1.1 研究背景 1](#__RefHeading___Toc14027)

[1.2研究目的 1](#__RefHeading___Toc13858)
...
[3.3系统界面分析 6](#__RefHeading___Toc17883)
...
[5.1 用户信息管理 14](#用户信息管理)

[5.2 房屋类型管理 14](#房屋类型管理)

[5.3 房源信息管理 15](#房源信息管理)

[5.4 房源申请管理 15](#房源申请管理)
...
[]{#__RefHeading___Toc14027 .anchor}1.1 研究背景
...
[]{#__RefHeading___Toc13858 .anchor}1.2研究目的
...
[]{#__RefHeading___Toc17883 .anchor}3.3系统界面分析
...
![](media/image9.png){width="6.371527777777778in"
...
![](media/image10.png){width="6.367361111111111in"
...
![](media/image14.png){width="6.375in" height="4.441666666666666in"}
...
经过对上述测试结果分析，本系统符合用户需求。所有基本功能点实现，操作简单，操作流程简单合理，产品运行性能良好，是一款值得推广的城镇保障性住房管理系统。
...
首先我要感谢此次指导我的老师，是他的及时纠正我在设计当中出现的问题，使得我的设计高质量完成。指导老师在我本次城镇保障性住房管理系统的开发过程中，为程序、框架的设计、代码等方面以及论文设计提供了很多宝贵的意见，并且为我推荐了许多相关的资料，他的指导和建议使我受益匪浅，通过老师的耐心辅导和指点，我的论文顺利完成，在此，我表示深刻的感谢。
...
### 0114springboot城镇保障性住房管理系统 项目图片
