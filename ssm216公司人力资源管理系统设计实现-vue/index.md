...
# [ssm216公司人力资源管理系统设计实现+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm216/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm216/blog.002.png)
...
![](/images/0200ssm/ssm216/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0200ssm/ssm216/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的员工用户功能结构图如下图所示：

![](/images/0200ssm/ssm216/blog.005.png)
...
![](/images/0200ssm/ssm216/blog.006.png)

图4.12 考核结果信息实体属性图

（2）缺勤扣钱标准实体属性图如图4.13所示：

![](/images/0200ssm/ssm216/blog.007.png)

图4.13   缺勤扣钱标准实体属性图

（3）考核标准实体属性图如图4.14所示：

![](/images/0200ssm/ssm216/blog.008.png)
...
![](/images/0200ssm/ssm216/blog.010.png)

图5.1 考核标准管理界面
### 5.1.2 缺勤扣钱标准管理
系统管理员可以对缺勤扣钱标准进行管理操作。具体界面如图5.2所示。

![](/images/0200ssm/ssm216/blog.011.png)

图5.3 缺勤扣钱标准管理界面
### 5.1.3 登记员工工资
系统管理员可以登记员工工资。界面如下图所示：

![](/images/0200ssm/ssm216/blog.012.png)
...
![](/images/0200ssm/ssm216/blog.013.png)

图5.5 添加休假申请界面
### 5.2.2 考核结果管理
员工用户登录后，可以查看考核结果信息。界面如下图所示：

![](/images/0200ssm/ssm216/blog.014.png)

图5.6 考核结果管理界面
### 5.2.3 员工考核登记管理
员工用户登录后可以对考核信息进行修改，删除。界面如下图所示：

![](/images/0200ssm/ssm216/blog.015.png)
