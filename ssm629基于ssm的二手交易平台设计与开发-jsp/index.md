...
# [ssm629基于SSM的二手交易平台设计与开发+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm629/blog.001.png)
...
![](/images/0600ssm/ssm629/blog.002.png)
...
![](/images/0600ssm/ssm629/blog.007.png)

图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图。

![](/images/0600ssm/ssm629/blog.008.png)
...
![](/images/0600ssm/ssm629/blog.009.png)

图4.4 管理员实体属性图

（2）用户实体属性图见图4.5。

![](/images/0600ssm/ssm629/blog.010.png)

图4.5 用户实体属性图

（3）卖家实体属性图见图4.6。

![](/images/0600ssm/ssm629/blog.011.png)
...
![](/images/0600ssm/ssm629/blog.012.png)

图5.1 用户管理页面
### 5.1.2 卖家管理
如图5.2显示的就是卖家管理页面，管理员可以对卖家信息进行添加，修改，删除，查询操作。

![](/images/0600ssm/ssm629/blog.013.png)

图5.2 卖家管理页面
### 5.1.3 商品分类管理
如图5.3显示的就是商品分类管理页面，管理员可以对商品分类信息信息修改，删除，批量删除以及查询操作。

![](/images/0600ssm/ssm629/blog.014.png)
...
![](/images/0600ssm/ssm629/blog.015.png)

图5.4 商品信息页面
### 5.2.2 在线咨询管理
如图5.4显示的就是在线咨询页面，卖家可以对用户提交的商品的在线咨询进行审核，查看，搜索操作。

![](/images/0600ssm/ssm629/blog.016.png)
...
![](/images/0600ssm/ssm629/blog.017.png)
...
![](/images/0600ssm/ssm629/blog.018.png)

图5.7 购物车管理页面
### 5.3.3 订单管理
如图5.4显示的就是订单管理页面，用户可以在订单管理里面对订单进行查询和支付操作。

![](/images/0600ssm/ssm629/blog.019.png)
