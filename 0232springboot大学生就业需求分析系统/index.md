...
![](/images/0200stringboot/0232springboot/blog.001.png)

图3-1 程序操作流程图

程序处理数据会涉及到数据的录入环节，绘制的添加流程见下图。程序录入数据过程中，始终与数据库保持同步。

![](/images/0200stringboot/0232springboot/blog.002.png)

图3-2 信息添加流程图

程序里面的数据也会出现错误，因此就有相应的修改数据的功能，绘制的程序修改流程见下图。此过程也是跟后台数据库进行数据同步显示。

![](/images/0200stringboot/0232springboot/blog.003.png)

图3-3信息修改流程图

程序数据存放于数据仓库，有时也会涉及到数据删除，此过程对应的流程图见下图。数据信息被删除之后，数据库里面也就没有了该数据信息了。

![](/images/0200stringboot/0232springboot/blog.004.png)
...
![](/images/0200stringboot/0232springboot/blog.005.png)
...
删招聘删除
![](/images/0200stringboot/0232springboot/blog.006.png)
...
![C:\Users\Administrator\Desktop\img\jiuyeguanli\招聘信息.jpg](/images/0200stringboot/0232springboot/blog.007.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\招聘信息.jpg")
图4.1 招聘信息实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\用户.jpg](/images/0200stringboot/0232springboot/blog.008.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\用户.jpg")
图4.2 用户实体属性图

（3）下图是邀请面试实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\邀请面试.jpg](/images/0200stringboot/0232springboot/blog.009.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\邀请面试.jpg")
图4.3 邀请面试实体属性图

（4）下图是公司实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\公司.jpg](/images/0200stringboot/0232springboot/blog.010.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\公司.jpg")
图4.4 公司实体属性图

（5）下图是简历实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\简历.jpg](/images/0200stringboot/0232springboot/blog.011.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\简历.jpg")
图4.5 简历实体属性图

（6）下图是学生就业信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\学生就业信息.jpg](/images/0200stringboot/0232springboot/blog.012.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\学生就业信息.jpg")
图4.6 学生就业信息实体属性图

（7）下图是简历投递实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jiuyeguanli\简历投递.jpg](/images/0200stringboot/0232springboot/blog.013.jpeg "C:\Users\Administrator\Desktop\img\jiuyeguanli\简历投递.jpg")
图4.7 简历投递实体属性图
...
![](/images/0200stringboot/0232springboot/blog.014.png)

图5-1 学生就业信息管理页面
### 5.1.2 招聘信息管理
招聘信息管理页面提供的功能操作有：新增招聘，修改招聘，删除招聘操作。下图就是招聘信息管理页面。

![](/images/0200stringboot/0232springboot/blog.015.png)

图5.3 招聘信息管理页面
### 5.1.3招聘岗位类型管理
招聘岗位类型管理页面显示所有招聘岗位类型，在此页面既可以让管理员添加新的招聘信息类型，也能对已有的招聘岗位类型信息执行编辑更新，失效的招聘岗位类型信息也能让管理员快速删除。下图就是招聘岗位类型管理页面。

![](/images/0200stringboot/0232springboot/blog.016.png)
