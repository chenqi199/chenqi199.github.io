...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1EbH&bvid=BV1jqaLe1EbH&cid=500001610885047&p=36)
...
表4.6顾客订单表
  ...
  ------ ------------------------- -------------------- ------------------- --------
   序号            列名                  数据类型              说明          允许空
    ...
    2     gukedingdan_uuid_unmber         String             订单编号          是

    3           chanpin_id               Integer               产品            是

    4       gukedingdan_number           Integer             订购数量          是

    5           insert_time                Date             下订单日期         是

    6        gukedingdan_time              Date            订单截止时间        是

    7        gukedingdan_types           Integer             订单状态          是

    8        gukedingdan_text             String           顾客订单内容        是
...
表4.7设备信息表
  ...
  ------ -------------------- -------------------- ------------------- --------
   序号          列名               数据类型              说明          允许空
    ...
    2     shebei_uuid_unmber         String             设备编号          是

    3        shebei_name             String             设备名称          是

    4        shebei_types           Integer             设备类型          是

    5        shebei_time              Date            上次检修日期        是

    6        status_types           Integer             设备状态          是
...
表4.8设备检修表
  ...
  ------ -------------------- -------------------- ------------------- --------
   序号          列名               数据类型              说明          允许空
    ...
    3       weixiuyuan_id           Integer               员工            是

    4     shebeijianxiu_time          Date            上次检修日期        是
...
表4.9生产计划表
  ...
  ------ ------------------------- -------------------- ------------------- --------
   序号            列名                  数据类型              说明          允许空
    ...
    2         gukedingdan_id             Integer             订单编号          是

    3     shengcanjihukaishi_time          Date             开始的时间         是

    4     shengcanjihujieshu_time          Date              结束时间          是

    5       shengcanjihua_types          Integer             计划状态          是
...
表4.10维修员表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    3       weixiuyuan_photo           String               头像            是

    4       weixiuyuan_phone           String           维修员手机号        是

    5     weixiuyuan_id_number         String          维修员身份证号       是

    6       weixiuyuan_email           String               邮箱            是

    7      weixiuyuan_delete          Integer               假删            是

    8       weixiuyuan_time             Date              入职日期          是
...
表4.11员工表
  ...
  ------ ------------------ -------------------- ------------------- --------
   序号         列名              数据类型              说明          允许空
    ...
    4       yonghu_phone           String            员工手机号         是

    5     yonghu_id_number         String           员工身份证号        是

    6       yonghu_email           String               邮箱            是

    7      yonghu_zhineng          String               职能            是

    8       bumen_types           Integer               部门            是

    9      yonghu_delete          Integer               假删            是

    10      yonghu_time             Date              入职日期          是
...
表4.12质量监控表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2      shengcanjihua_id          Integer             生产计划          是

    3      zhiljiankong_name          String          不合格产品名称       是

    4        shebei_types            Integer             设备类型          是

    5          yonghu_id             Integer               员工            是

    6     zhiljiankong_number        Integer          不合格产品数量       是

    7         insert_time              Date                时间            是
...
如图5.2显示的就是材料信息管理页面，此页面提供给管理员的功能有：查看已发布的材料信息数据，修改材料信息，材料信息作废，即可删除，还进行了对材料信息名称的模糊查询
材料信息信息的类型查询等等一些条件。
...
制造装备物联及生产管理ERP系统的目标用户最终面向的是系统的功能，所以检验本系统的功能也是一项重要任务，只有该系统的功能都能保证正常使用，才会吸引更多的用户来使用。
...
通过测试，可以发现制造装备物联及生产管理ERP系统具备完善的功能，同时具备易操作性和易维护性的特点，在系统安全性上也有比较健全的数据保护机制。至此，制造装备物联及生产管理ERP系统可以投入使用。
...
### 0270springboot制造装备物联及生产管理ERP系统 项目图片
![图片](/images/0270springbootimg_014.jpg)
![图片](/images/0270springbootimg_015.jpg)
![图片](/images/0270springbootimg_001.jpg)
![图片](/images/0270springbootimg_017.jpg)
![图片](/images/0270springbootimg_003.jpg)
![图片](/images/0270springbootimg_002.jpg)
![图片](/images/0270springbootimg_016.jpg)
![图片](/images/0270springbootimg_012.jpg)
![图片](/images/0270springbootimg_006.jpg)
![图片](/images/0270springbootimg_007.jpg)
![图片](/images/0270springbootimg_013.jpg)
![图片](/images/0270springbootimg_005.jpg)
![图片](/images/0270springbootimg_011.jpg)
![图片](/images/0270springbootimg_010.jpg)
![图片](/images/0270springbootimg_004.jpg)
![图片](/images/0270springbootimg_009.jpg)
![图片](/images/0270springbootimg_008.jpg)
![图片](/images/0270springbootimg_018.jpg)
![图片](/images/0270springbootimg_019.jpg)
