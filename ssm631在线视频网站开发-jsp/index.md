...
# [ssm631在线视频网站开发+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm631/blog.001.png)
...
![](/images/0600ssm/ssm631/blog.008.png)

图4.4 管理员实体属性图

（2）视频包括的属性有视频照片，热度，视频名称等。其属性图如下。

![](/images/0600ssm/ssm631/blog.009.png)

图4.5 视频实体属性图

（3）视频留言包括的属性有留言内容，回复内容等。其属性图如下。

![](/images/0600ssm/ssm631/blog.010.png)

图4.6 视频留言实体属性图

（4）用户包括的属性有用户姓名，用户头像，用户手机号，性别等。其属性图如下。

![](/images/0600ssm/ssm631/blog.011.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0600ssm/ssm631/blog.012.png)
