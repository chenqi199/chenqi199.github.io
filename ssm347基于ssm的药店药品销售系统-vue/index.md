...
# [ssm347基于SSM的药店药品销售系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0300ssm/ssm347/blog.001.png)

图3-3登录流程图

![](/images/0300ssm/ssm347/blog.002.png)
...
![](/images/0300ssm/ssm347/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0300ssm/ssm347/blog.004.png)
...
![](/images/0300ssm/ssm347/blog.005.png)

图4.12  药品资讯信息实体属性图

（2）留言板信息实体属性图如图4.13所示：

![](/images/0300ssm/ssm347/blog.006.png)

图4.13  留言板信息实体属性图

（3）管理员信息实体属性图如图4.14所示：

![](/images/0300ssm/ssm347/blog.007.png)
...
![](/images/0300ssm/ssm347/blog.010.png)

图5.1 用户信息管理界面
## 5.2 药品信息管理
系统管理员可以查看对药品信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0300ssm/ssm347/blog.011.png)
...
![](/images/0300ssm/ssm347/blog.012.png)

图5.3 销售统计管理界面
## 5.4 财务统计管理
系统管理员可以对财务统计进行添加修改删除。具体界面如图5.2所示。

![](/images/0300ssm/ssm347/blog.013.png)

图5.4 财务统计管理界面
## 5.5 用户购买药品
用户登录后可以在药品信息购买药品。具体界面如图5.2所示。

![](/images/0300ssm/ssm347/blog.014.png)

图5.5 门诊病历信息管理界面
## 5.6 我的订单
用户购买药品后会生成我的订单，可以在我的订单里面查看。具体界面如图5.2所示。

![](/images/0300ssm/ssm347/blog.015.png)
