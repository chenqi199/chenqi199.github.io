...
# [0077springboot民宿在线预定平台](https://github.com/GraduationProject-springboot/0077springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0077springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0077springboot/blog.002.png)
...
![](/images/0000stringboot/0077springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计功能结构图如下图所示：

![](/images/0000stringboot/0077springboot/blog.004.png)
...
![](/images/0000stringboot/0077springboot/blog.005.png)

图4.12  客服信息实体属性图

（2）民宿资讯信息实体属性图如图4.13所示：

![](/images/0000stringboot/0077springboot/blog.006.png)

图4.13  民宿资讯信息实体属性图

（3）民宿分类信息实体属性图如图4.14所示：

![](/images/0000stringboot/0077springboot/blog.007.png)
...
![](/images/0000stringboot/0077springboot/blog.010.png)

图5.1 用户信息信息管理界面
### 5.1.2 民宿信息管理
系统管理员可以查看对民宿信息信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/images/0000stringboot/0077springboot/blog.011.png)

图5.2 民宿信息信息管理界面
### 5.1.3 民宿资讯管理
管理员可以对民宿资讯信息进行添加，修改，删除以及查询操作。界面如下图所示：

![](/images/0000stringboot/0077springboot/blog.012.png)

图5.3 民宿资讯信息管理界面
### 5.1.4 民宿分类管理
管理员可以对民宿分类信息进行修改操作，还可以对民宿分类信息进行查询。界面如下图所示：

![](/images/0000stringboot/0077springboot/blog.013.png)
...
![](/images/0000stringboot/0077springboot/blog.014.png)

图5.5 用户注册界面
### 5.2.2 民宿信息
用户登录后可以对民宿信息进行添加购物车操作。界面如下图所示：

![](/images/0000stringboot/0077springboot/blog.015.png)
...
![](/images/0000stringboot/0077springboot/blog.016.png)
