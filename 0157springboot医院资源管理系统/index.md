...
# [0157springboot医院资源管理系统](https://github.com/GraduationProject-springboot/0157springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610829386&p=55)
...
[5.2 医生信息管理 21](#医生信息管理)

[5.3药品信息管理 22](#药品信息管理)

[5.1公告信息管理 23](#公告信息管理)

[第6章 系统测试 24](#__RefHeading___Toc11288)
...
[致 谢 27](#__RefHeading___Toc20695)
...
+-----+---------------+--------------------+-------------------+------+
| 6   | yisheng_photo | String             | 头像              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 7   | yisheng_phone | String             | 联系方式          | 是   |
+-----+---------------+--------------------+-------------------+------+
| 8   | yish          | String             | 医生身份证号      | 是   |
|     | eng_id_number |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 9   | yisheng_email | String             | 邮箱              | 是   |
+-----+---------------+--------------------+-------------------+------+
...
|     | isheng_guahao |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 12  | yish          | BigDecimal         | 挂号价格          | 是   |
|     | eng_new_money |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 13  | yis           | String             | 职称              | 是   |
|     | heng_zhichneg |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 14  | yisheng_types | Integer            | 科室              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 15  | yi            | String             | 简介              | 是   |
|     | sheng_content |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
...
表4.5 医生预约信息表
  ...
  ------ -------------------------- -------------------- ------------------- --------
   序号             列名                  数据类型              说明          允许空
    ...
    4     yishengyuyue_yesno_types        Integer             预约结果          是

    5        yishengyuyue_time              Date              预约时间          是
...
| 1   | id            | Int                | 编号              | 否   |
+-----+---------------+--------------------+-------------------+------+
| 2   | yisheng_id    | Integer            | 发布医生          | 是   |
+-----+---------------+--------------------+-------------------+------+
| 3   | yonghu_id     | Integer            | 用户              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 4   | bingshi_name  | String             | 病名              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 5   | bi            | String             | 病因              | 是   |
|     | ngshi_bingyin |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
...
|     | hi_xianzhuang |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 7   | bingshi_text  | String             | 药单              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 8   | bingshi_jinji | String             | 禁忌              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 9   | bingshi\_     | String             | 注意事项          | 是   |
|     |               |                    |                   |      |
|     | zhuyishixiang |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
...
表4.7 住院信息表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    4        zhuyuan_name             String             病房地址          是

    5     zhuyuan_fangjianhao         String              房间号           是

    6      zhuyuan_chuanghao          String               床号            是
...
+-----+---------------+--------------------+-------------------+------+
| 3   | yaopin_photo  | String             | 药品图片          | 是   |
+-----+---------------+--------------------+-------------------+------+
| 4   | yao           | String             | 主要成分          | 是   |
|     | pin_chyengfen |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 5   | yaopin\_      | String             | 适用范围          | 是   |
|     |               |                    |                   |      |
|     | shiyongfanwei |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
| 6   | yaopin_beizhu | String             | 备注              | 是   |
+-----+---------------+--------------------+-------------------+------+
| 7   | ya            | BigDecimal         | 价格              | 是   |
|     | opin_jiangshi |                    |                   |      |
+-----+---------------+--------------------+-------------------+------+
...
### 0157springboot医院资源管理系统 项目图片
![图片](/images/0157springbootimg_001.jpg)
![图片](/images/0157springbootimg_003.jpg)
![图片](/images/0157springbootimg_002.jpg)
![图片](/images/0157springbootimg_004.jpg)
