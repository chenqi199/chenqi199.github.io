...
# [ssm035基于JavaWeb的家居商城系统的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
![](/images/0000ssm/ssm035/blog.002.png)

图3-1 管理员用例图
### 3.4.2用户用例
用户注册登录后可进行主页、个人中心、我的收藏管理、订单管理，用户用例如图3-2所示。

![](/images/0000ssm/ssm035/blog.003.png)
...
![](/images/0000ssm/ssm035/blog.007.png)
...
![](/images/0000ssm/ssm035/blog.008.png)

图4-2 登录结构图

这些功能可以充分满足家居商城系统的需求。此系统功能较为全面如下图系统功能结构如图4-4所示。

![图片1](/images/0000ssm/ssm035/blog.009.png)
...
![](/images/0000ssm/ssm035/blog.010.png)

`    `图4.6商品信息E-R图

用户信息E-R图，如图4.7所示。

![](/images/0000ssm/ssm035/blog.011.png)
...
![](/images/0000ssm/ssm035/blog.016.png)
...
![](/images/0000ssm/ssm035/blog.017.png)
...
![](/images/0000ssm/ssm035/blog.018.png)

图5-8个人信息界面图

用户管理：通过列表可以获取用户账号、用户姓名、密码、性别、联系电话、电子邮箱、余额等信息，进行修改或删除操作，如图5-9所示。

![IMG\_256](/images/0000ssm/ssm035/blog.019.png)
...
![IMG\_256](/images/0000ssm/ssm035/blog.020.png)
