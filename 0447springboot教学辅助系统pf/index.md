...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1ULbQeREgz&bvid=BV1ULbQeREgz&cid=500001616875612&p=47)
...
表4.4教学视频表
  ...
  ------ ----------------------- -------------------- ------------------- --------
   序号           列名                 数据类型              说明          允许空
    ...
    2      jiaoxueshipin_name           String           教学视频标题        是

    3      jiaoxueshipin_photo          String           教学视频照片        是

    4      jiaoxueshipin_video          String               视频            是

    5      jiaoxueshipin_file           String             教学资料          是

    6      jiaoxueshipin_types         Integer           教学视频类型        是

    7          jiaoshi_id              Integer               教师            是

    8     jiaoxueshipin_delete         Integer             逻辑删除          是

    9     jiaoxueshipin_content         String           教学视频详情        是
...
表4.9作业提交表
  ...
  ------ ------------------- -------------------- ------------------- --------
   序号         列名               数据类型              说明          允许空
    ...
    4     zuoyetijiao_file          String             作业文件          是

    5     zuoyetijiao_types        Integer             作业评分          是
...
如图5.2显示的就是教学视频管理页面，此页面提供给管理员的功能有：查看已发布的教学视频数据，修改教学视频，教学视频作废，即可删除，还进行了对教学视频名称的模糊查询
教学视频信息的类型查询等等一些条件。
...
通过设计一些数据检验教学辅助系统的功能是否根据预定进行数据输出，以此检验系统功能是否合格。接下来就选取部分功能进行检测。

### 6.1.1 登录功能测试

教学辅助系统提供的服务是给规定的用户使用的，其他无关用户是无法进入的，登录功能就是检验访问者是否是符合要求的用户，及时将不符合要求的用户拒之门外。以此保证系统安全。这里以管理员身份进行检测，测试的内容见下表。
...
教学辅助系统在面对正确的账号，不匹配的密码时，会有相应的反馈，其反馈结果见下图。
...
经过测试，从教学辅助系统功能的角度来看，本系统各个功能在符合用户要求的情况下，也能保持运行正常。从教学辅助系统性能的角度来看，本系统可以保持24小时不间断运行，而且面对用户的误操作行为，有提前设置的错误反馈机制应对，另外，本系统界面布局考虑用户阅读习惯，可以让用户短时间内获取需要的内容。总之，本系统可以投入生产，帮助用户解决实际问题，发挥其应用价值。

# 结 论

采用Java+Mysql的方式设计制作的教学辅助系统，在功能上可以满足管理人员对于信息的管理需求；在界面的设计上，尽最大努力用自身的美工知识做到界面美观简洁。在操作方面上，让系统可以方便操作，同时对用户常见的误操作行为进行分析总结，并尽力在系统中避免同样的由于用户的误操作所带来的错误现象。

作为毕业设计，分配给本系统的设计与制作时间还是不足的，所以，教学辅助系统还有许多需要完善的地方。
...
\[1\]江涛.教学视频网上预订系统的设计与分析\[J\].现代商贸工业,2020,41(22):150.

\[2\]徐微微.晓庄连锁教学视频教学视频预订系统的设计\[J\].企业导报,2016(08):180-181.
...
### 0447springboot教学辅助系统pf 项目图片
![图片](/images/0447springbootimg_001.jpg)
![图片](/images/0447springbootimg_003.jpg)
![图片](/images/0447springbootimg_002.jpg)
![图片](/images/0447springbootimg_006.jpg)
![图片](/images/0447springbootimg_007.jpg)
![图片](/images/0447springbootimg_005.jpg)
![图片](/images/0447springbootimg_010.jpg)
![图片](/images/0447springbootimg_004.jpg)
![图片](/images/0447springbootimg_009.jpg)
![图片](/images/0447springbootimg_008.jpg)
