...
# [ssm617基于协同过滤技术的网上书城的开发与研究+jsp](https://github.com/GraduationProject-springboot/)
...
![22f9](/images/0600ssm/ssm617/blog.001.jpeg "22f9")
...
![](/images/0600ssm/ssm617/blog.002.png)
...
![](/images/0600ssm/ssm617/blog.003.png)
...
![](/images/0600ssm/ssm617/blog.004.png)

图3-1 程序操作流程图

程序处理数据会涉及到数据的录入环节，绘制的添加流程见下图。程序录入数据过程中，始终与数据库保持同步。

![](/images/0600ssm/ssm617/blog.005.png)

图3-2 信息添加流程图

程序里面的数据也会出现错误，因此就有相应的修改数据的功能，绘制的程序修改流程见下图。此过程也是跟后台数据库进行数据同步显示。

![](/images/0600ssm/ssm617/blog.006.png)

图3-3信息修改流程图

程序数据存放于数据仓库，有时也会涉及到数据删除，此过程对应的流程图见下图。数据信息被删除之后，数据库里面也就没有了该数据信息了。

![](/images/0600ssm/ssm617/blog.007.png)
...
![](/images/0600ssm/ssm617/blog.008.png)
...
![](/images/0600ssm/ssm617/blog.009.png)

图4-4 管理员实体属性图

（2）用户实体属性图通过Visio工具绘制，绘制结果展示如下：

![](/images/0600ssm/ssm617/blog.010.png)

图4-5 用户实体属性图

（3）图书分类实体属性图通过Visio工具绘制，绘制结果展示如下：

![](/images/0600ssm/ssm617/blog.011.png)
...
![](/images/0600ssm/ssm617/blog.012.png)

图5-1 用户管理页面
### 5.1.2 图书分类管理
管理员可以对图书分类信息进行添加，修改，删除，查询操作。

![](/images/0600ssm/ssm617/blog.013.png)

图5-2 图书分类管理页面
### 5.1.3 图书信息管理
管理员可以对图书信息进行添加，修改，删除，查询操作。

![](/images/0600ssm/ssm617/blog.014.png)

图5-3 图书信息管理页面
### 5.1.4 订单管理
管理员可以查看已支付订单，可以对订单进行查询。

![](/images/0600ssm/ssm617/blog.015.png)
...
![](/images/0600ssm/ssm617/blog.016.png)

图5-5 图书信息页面
### 5.2.2 购物车
用户把图书加入到购物车里后可以在购物车里对图书数量更改和删除。

![](/images/0600ssm/ssm617/blog.017.png)

图5-6 购物车页面
### 5.2.3 点击购买
用户在购物车里点击点击购买后到以下界面，这个界面可以对收货地址修改，可以进行支付操作。

![](/images/0600ssm/ssm617/blog.018.png)

图5-7 点击购买页面
### 5.2.4 我的收藏
用户收藏过的图书信息可以在我的收藏里查看查询和删除。

![](/images/0600ssm/ssm617/blog.019.png)
