...
# [0053springboot飘香水果购物网站的设计与实现](https://github.com/GraduationProject-springboot/0053springboot)
...
## 3.4系统流程和逻辑
![](/images/0000stringboot/0053springboot/blog.001.png)

图3-3登录流程图

![](/images/0000stringboot/0053springboot/blog.002.png)
...
![](/images/0000stringboot/0053springboot/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的管理员功能结构图如下图所示：

![](/images/0000stringboot/0053springboot/blog.004.png)

图4-2管理员功能结构图

本系统是基于B/S架构的网站系统，设计的用户功能结构图如下图所示：

![](/images/0000stringboot/0053springboot/blog.005.png)
...
![](/images/0000stringboot/0053springboot/blog.006.png)

图4.12  会员信息实体属性图

（2）水果实体属性图如图4.13所示：

![](/images/0000stringboot/0053springboot/blog.007.png)

图4.13  水果实体属性图

（3）积分实体属性图如图4.14所示：

![](/images/0000stringboot/0053springboot/blog.008.png)
...
![](/images/0000stringboot/0053springboot/blog.010.png)

图5.1 水果信息管理界面
### 5.1.2 减积分管理
系统管理员可以对减积分进行添加，修改，删除操作。具体界面如图5.2所示。

![](/images/0000stringboot/0053springboot/blog.011.png)

图5.3 减积分管理界面
### 5.1.3 会员购买订单管理
系统管理员可以对用户提交的订单进行审核以及删除操作。界面如下图所示：

![](/images/0000stringboot/0053springboot/blog.012.png)
...
![](/images/0000stringboot/0053springboot/blog.013.png)

图5.5 首页界面
### 5.2.2 水果
用户登录后，首页点击水果，可以查看水果信息并且可以购买操作。界面如下图所示：

![](/images/0000stringboot/0053springboot/blog.014.png)

图5.6 水果界面
### 5.2.3 购买水果订单管理
用户登录后可以个人后台查看属于自己的购买水果订单管理。界面如下图所示：

![](/images/0000stringboot/0053springboot/blog.015.png)
