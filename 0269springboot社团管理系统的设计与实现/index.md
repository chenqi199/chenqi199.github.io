...
# [0269springboot社团管理系统的设计与实现](https://github.com/GraduationProject-springboot/0269springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1EbH&bvid=BV1jqaLe1EbH&cid=500001610885007&p=35)
...
Since the development of Internet, both its theory and technology have
been mature, and it widely participates in all aspects of society. It
allows information to spread through the network, and can provide
services for people with information management tools. In view of the
problems of chaotic information management, high error rate, poor
information security, high labor intensity, time-consuming and
laborious, the use of community management system can effectively manage
and make information management more scientific and standardized.

In the eclipse environment, the community management system uses Java
language for coding, and uses Mysql to create data tables to save the
data generated by the system. The system can provide information display
and corresponding services. Its administrator can add, delete, modify
and check the club information and club information materials, and
review the club reservation information. In short, the community
management system centrally manages information, which has many
advantages such as strong confidentiality, high efficiency, large
storage space and low cost. It can reduce the cost of information
...
[4.3 数据库设计 12](#__RefHeading___Toc3088)

[4.3.2 数据库物理设计 12](#__RefHeading___Toc29442)

[5.1学生信息管理 16](#学生信息管理)

[5.2 社团信息管理 17](#社团信息管理)

[5.3团长信息管理 18](#团长信息管理)

[5.1公告信息管理 18](#公告信息管理)

[第6章 系统测试 20](#__RefHeading___Toc5911)

[6.1 功能测试 20](#功能测试)

[6.1.1 登录功能测试 20](#登录功能测试)

[6.1.2 修改密码功能测试 21](#修改密码功能测试)

[6.2 测试结果 21](#测试结果)

[结 论 22](#结-论)

[致 谢 23](#__RefHeading___Toc19043)
...
[]{#__RefHeading___Toc29442 .anchor}**4.3 数据库设计**
...
表4.2活动信息表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2     huodong_uuid_unmber         String             活动编号          是

    3        huodong_name             String             活动名称          是

    4        huodong_types           Integer             活动类型          是

    5        huodong_photo            String             活动封面          是

    6         shetuan_id             Integer             发布社团          是

    7       huodong_address           String             活动地点          是

    8       huodong_content           String             活动详情          是
...
表4.3活动审核表
  ...
  ------ ---------------------------- -------------------- ------------------- --------
   序号              列名                   数据类型              说明          允许空
    ...
    4     huodong_shenhe_yesno_types        Integer             审核状态          是

    5            huodong_text                String             审核意见          是
...
表4.5社团信息表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2     shetuan_uuid_unmber         String             社团编号          是

    3        shetuan_name             String             社团名称          是

    4        shetuan_types           Integer             社团类型          是

    5        shetuan_photo            String             社团封面          是

    6        tuanzhang_id            Integer              发布人           是

    7       shetuan_address           String             社团地点          是
...
表4.6社团审核表
  ...
  ------ ---------------------------- -------------------- ------------------- --------
   序号              列名                   数据类型              说明          允许空
    ...
    4     shetuan_shenhe_yesno_types        Integer             审核状态          是

    5            shetuan_text                String             审核意见          是
...
表4.7团长表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2       tuanzhang_name            String             团长姓名          是

    3       tuanzhang_photo           String               头像            是

    4       tuanzhang_phone           String            团长手机号         是

    5     tuanzhang_id_number         String           团长身份证号        是

    6       tuanzhang_email           String               邮箱            是

    7      tuanzhang_delete          Integer               假删            是
...
如图5.2显示的就是社团信息管理页面，此页面提供给管理员的功能有：查看已发布的社团信息数据，修改社团信息，社团信息作废，即可删除，还进行了对社团信息名称的模糊查询
社团信息信息的类型查询等等一些条件。
...
[]{#__RefHeading___Toc5911 .anchor}**6章**
...
![](media/image22.png){width="2.2395833333333335in"
...
采用Java+Mysql的方式设计制作的社团管理系统，在功能上可以满足管理人员对于信息的管理需求；在界面的设计上，尽最大努力用自身的美工知识做到界面美观简洁。在操作方面上，让系统可以方便操作，同时对用户常见的误操作行为进行分析总结，并尽力在系统中避免同样的由于用户的误操作所带来的错误现象。

作为毕业设计，分配给本系统的设计与制作时间还是不足的，所以，社团管理系统还有许多需要完善的地方。
...
[]{#__RefHeading___Toc19043 .anchor}
...
\[1\]江涛.社团信息网上预订系统的设计与分析\[J\].现代商贸工业,2020,41(22):150.

\[2\]徐微微.晓庄连锁社团信息社团信息预订系统的设计\[J\].企业导报,2016(08):180-181.
...
### 0269springboot社团管理系统的设计与实现 项目图片
![图片](/images/0269springbootimg_001.jpg)
![图片](/images/0269springbootimg_003.jpg)
![图片](/images/0269springbootimg_002.jpg)
![图片](/images/0269springbootimg_006.jpg)
![图片](/images/0269springbootimg_007.jpg)
![图片](/images/0269springbootimg_005.jpg)
![图片](/images/0269springbootimg_004.jpg)
![图片](/images/0269springbootimg_008.jpg)
