...
# [ssm687基于Java的众惠商城的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm687/blog.005.png)

图3.5 管理员用例图

图3.6即为用户用例图，用户权限操作的功能包括下单购买商品，在论坛模块参与信息讨论，查看公告，查看浏览记录信息，查看购物订单等。

![](/images/0600ssm/ssm687/blog.006.png)
...
![](/images/0600ssm/ssm687/blog.007.png)

图4.1 管理员功能结构

图4.2即为设计的用户功能结构，用户权限操作的功能包括下单购买商品，在论坛模块参与信息讨论，查看公告，查看浏览记录信息，查看购物订单等。

![](/images/0600ssm/ssm687/blog.008.png)
...
![](/images/0600ssm/ssm687/blog.009.png)

图4.4 商品实体属性图

（2）图4.5即为商品订单这个实体所拥有的属性值。

![](/images/0600ssm/ssm687/blog.010.png)

图4.5 商品订单实体属性图

（3）图4.6即为管理员这个实体所拥有的属性值。

![](/images/0600ssm/ssm687/blog.011.png)

图4.6 管理员实体属性图

4. 图4.7即为用户这个实体所拥有的属性值。

![](/images/0600ssm/ssm687/blog.012.png)

图4.7 用户实体属性图

4. 图4.8即为上面介绍的实体中存在的联系。

![](/images/0600ssm/ssm687/blog.013.png)
...
![](/images/0600ssm/ssm687/blog.014.png)

图5.1 商品管理界面
### 5.1.2 商品评价管理
图5.2 即为编码实现的商品评价管理界面，管理员可以通过用户提交的商品评价来猜测用户的需求，针对用户提交的商品评价，管理员需要回复。

![](/images/0600ssm/ssm687/blog.015.png)
