...
# [ssm701基于JavaWeb的个人健康信息管理系统+jsp](https://github.com/GraduationProject-springboot/)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=99)
...
![](/images/0700ssm/ssm701/blog.001.png)
...
![](/images/0700ssm/ssm701/blog.002.png)
...
![](/images/0700ssm/ssm701/blog.007.png)

图4.2 程序工作的原理图
## 4.3 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.3展示的就是管理员功能结构图，管理员在后台主要管理字典管理、公告管理、健康信息管理、新闻信息管理、用户管理、管理员管理等。
...
删公告删除
![](/images/0700ssm/ssm701/blog.008.png)
...
![C:\Users\Administrator\Desktop\img\gerenjiankang\用户.jpg](/images/0700ssm/ssm701/blog.009.jpeg "C:\Users\Administrator\Desktop\img\gerenjiankang\用户.jpg")
图4.1 用户实体属性图

（2）下图是公告实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenjiankang\公告.jpg](/images/0700ssm/ssm701/blog.010.jpeg "C:\Users\Administrator\Desktop\img\gerenjiankang\公告.jpg")
图4.2 公告实体属性图

（3）下图是健康信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenjiankang\健康信息.jpg](/images/0700ssm/ssm701/blog.011.jpeg "C:\Users\Administrator\Desktop\img\gerenjiankang\健康信息.jpg")
图4.3 健康信息实体属性图

（4）下图是新闻信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenjiankang\新闻信息.jpg](/images/0700ssm/ssm701/blog.012.jpeg "C:\Users\Administrator\Desktop\img\gerenjiankang\新闻信息.jpg")
图4.4 新闻信息实体属性图
### 4.4.2 数据库表结构设计
...
|3|jiankangxinxi\_uuid\_number|String|唯一编号|是|
|4|shengao|String|身高|是|
|5|tizhong|String|体重|是|
|6|jiankang\_types|Integer|健康情况|是|
|7|tiwen\_types|Integer|体温状况|是|
|8|jinritiwen|BigDecimal|今日体温|是|
|9|jiankangxinxi\_yinshixiguan|String|饮食习惯|是|
|10|jiankangxinxi\_yichang|String|异常症状|是|
|11|jiankangxinxi\_content|String|其他信息|是|
|12|insert\_time|Date|录入日期|是|
...
|6|yonghu\_danaawei|String|所属单位|是|
|7|yonghu\_address|String|现住址|是|
|8|age|Integer|年龄|是|
|9|diqu\_types|Integer|所在地区|是|
...
![](/images/0700ssm/ssm701/blog.013.png)

图5.1 健康信息列表页面
### 5.1.2 公告信息管理
公告信息管理页面提供的功能操作有：新增公告，修改公告，删除公告操作。下图就是公告信息管理页面。

![](/images/0700ssm/ssm701/blog.014.png)

图5.3 公告信息管理页面
### 5.1.3公告类型管理
公告类型管理页面显示所有公告类型，在此页面既可以让管理员添加新的公告信息类型，也能对已有的公告类型信息执行编辑更新，失效的公告类型信息也能让管理员快速删除。下图就是公告类型管理页面。

![](/images/0700ssm/ssm701/blog.015.png)
