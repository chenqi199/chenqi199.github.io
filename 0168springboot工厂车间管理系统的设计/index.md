...
# [0168springboot工厂车间管理系统的设计](https://github.com/GraduationProject-springboot/0168springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1jqaLe1ECs&bvid=BV1jqaLe1ECs&cid=500001610830649&p=66)
...
社会发展日新月异，用计算机应用实现数据管理功能已经算是很完善的了，但是随着移动互联网的到来，处理信息不再受制于地理位置的限制，处理信息及时高效，备受人们的喜爱。本次开发一套基于VUE的工厂车间管理系统，有管理员和人员两个角色。管理员功能有个人中心，人员管理，看板信息管理，设备信息管理，生产开立管理，生产工序管理，生产流程管理。注册的人员可以登录和查看管理员发布的所有信息。基于VUE的工厂车间管理系统服务端用Java开发，用Spring
...
time, a VUE-based factory floor management system has been developed,
which has two roles of administrator and personnel. Administrator
functions include personal center, personnel management, Kanban
information management, equipment information management, production
opening management, production process management, and production
process management. Registered people can log in and view all
information posted by the administrator. The server side of the factory
workshop management system based on VUE is developed in Java, and the
backend of the website developed with the Spring Boot framework uses the
...
**Key Words：**VUE-based factory floor management system; Spring Boot
...
[4.1 系统设计的原则 10](#__RefHeading___Toc11599)
...
[5.1.2 看板信息管理 15](#看板信息管理)

[5.1.3 设备信息管理 16](#设备信息管理)

[5.1.4 生产开立管理 17](#生产开立管理)

[5.2 人员功能实现 17](#人员功能实现)

[5.2.1 生产开立管理员 17](#生产开立管理-1)

[5.2.2 生产工序管理 18](#生产工序管理)

[5.2.3 生产流程管理 19](#生产流程管理)

[第6章 系统测试 20](#__RefHeading___Toc30617)

[6.1系统测试方法 20](#系统测试方法)

[6.2 系统测试分析 21](#系统测试分析)
...
[]{#__RefHeading___Toc30617 .anchor}
...
基于VUE的工厂车间管理系统在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的基于VUE的工厂车间管理系统符合用户需求，它投入运行使用带给用户的便利是显而易见的。

# 结 论

基于VUE的工厂车间管理系统的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。这也是我第一次使用Spring
Boot框架语言，开发的这个比较简单的基于VUE的工厂车间管理系统。

基于VUE的工厂车间管理系统开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
基于VUE的工厂车间管理系统现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0168springboot工厂车间管理系统的设计 项目图片
![图片](/images/0168springbootimg_001.jpg)
![图片](/images/0168springbootimg_003.jpg)
![图片](/images/0168springbootimg_002.jpg)
![图片](/images/0168springbootimg_006.jpg)
![图片](/images/0168springbootimg_007.jpg)
![图片](/images/0168springbootimg_005.jpg)
![图片](/images/0168springbootimg_010.jpg)
![图片](/images/0168springbootimg_004.jpg)
![图片](/images/0168springbootimg_009.jpg)
![图片](/images/0168springbootimg_008.jpg)
