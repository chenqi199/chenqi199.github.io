...
# [ssm275宠物医院管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm275/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm275/blog.002.png)
...
![](/images/0200ssm/ssm275/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0200ssm/ssm275/blog.004.png)
...
![](/images/0200ssm/ssm275/blog.005.png)

图4.12  宠物信息实体属性图

（2）医生信息实体属性图如图4.13所示：

![](/images/0200ssm/ssm275/blog.006.png)

图4.13 医生信息实体属性图

（3）管理员实体属性图如图4.14所示：

![](/images/0200ssm/ssm275/blog.007.png)
...
![](/images/0200ssm/ssm275/blog.009.png)

图5.1 用户信息管理界面
### 5.1.2 申请情况管理
系统管理员可以管理申请情况信息，可以对申请情况信息进行添加，修改，删除查询操作，具体界面如图5.2所示。

![](/images/0200ssm/ssm275/blog.010.png)图5.2 申请情况信息管理界面
### 5.1.3医生管理
系统管理员可以管理医生信息，对医生信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm275/blog.011.png)
...
![](/images/0200ssm/ssm275/blog.012.png)

图5.4 系统首页界面
### 5.2.2 医院进驻
用户登录后可以提交医院进驻信息，然后在医院进驻申请里可以看到。界面如下图所示：

![](/images/0200ssm/ssm275/blog.013.png)
