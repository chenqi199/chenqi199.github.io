...
# [ssm642疫情防控管理系统设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm642/blog.001.png)

图3.1 添加信息流程图

很多时候，面对系统中的大量数据，难免会发现一些错误，因此需要及时纠正错误，本系统也提供数据后期的修改功能，其流程见下图。但是更新的数据也需要通过数据有效性检验。能够最终写入数据库则说明修改的数据是符合要求的。

![](/images/0600ssm/ssm642/blog.002.png)

图3.2 修改信息流程图

面对数据库里面大量数据，在系统的前台，要想快速获取需要的信息，就需要使用查询功能。其流程见下图。该功能需要操作者提前输入关键词，当系统的后台数据库保存了与关键词匹配的数据时，就会及时显示出来，整个过程耗时很短。

![](/images/0600ssm/ssm642/blog.003.png)
...
![](/images/0600ssm/ssm642/blog.004.png)
...
![C:\Users\Administrator\Desktop\img\yiqingfangkong\用户.jpg](/images/0600ssm/ssm642/blog.005.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\用户.jpg")
图4.1 用户实体属性图

（2）下图是检测历史实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\检测历史.jpg](/images/0600ssm/ssm642/blog.006.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\检测历史.jpg")
图4.2 检测历史实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\公告信息.jpg](/images/0600ssm/ssm642/blog.007.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\字典表.jpg](/images/0600ssm/ssm642/blog.008.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是患者信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\患者信息.jpg](/images/0600ssm/ssm642/blog.009.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\患者信息.jpg")
图4.5 患者信息实体属性图

（6）下图是自我检测实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\自我检测.jpg](/images/0600ssm/ssm642/blog.010.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\自我检测.jpg")
图4.6 自我检测实体属性图

（7）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\yiqingfangkong\用户表.jpg](/images/0600ssm/ssm642/blog.011.jpeg "C:\Users\Administrator\Desktop\img\yiqingfangkong\用户表.jpg")
图4.7 用户表实体属性图
### 4.3.2 数据库物理设计
...
![](/images/0600ssm/ssm642/blog.012.png)

图5.1 用户信息管理页面
### 5.2 患者信息管理
如图5.2显示的就是患者信息管理页面，此页面提供给管理员的功能有：查看已发布的患者信息数据，修改患者信息，患者信息作废，即可删除，还进行了对患者信息名称的模糊查询 患者信息信息的类型查询等等一些条件。

![](/images/0600ssm/ssm642/blog.013.png)

![](/images/0600ssm/ssm642/blog.014.png)
...
![](/images/0600ssm/ssm642/blog.015.png)
...
![](/images/0600ssm/ssm642/blog.016.png)
