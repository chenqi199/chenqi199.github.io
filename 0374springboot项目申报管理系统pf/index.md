...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T1bpekEK7?p=47)
...
![](/images/0300stringboot/0374springboot/blog.004.png)
...
![](/images/0300stringboot/0374springboot/blog.005.png)

图3.1 系统开发流程图

系统开发完成之后会给用户提供登录入口，在这个界面用户输入的信息会得到验证，通过验证之后才能进去项目申报管理系统的访问主界面，系统登录执行流程如下：

![](/images/0300stringboot/0374springboot/blog.006.png)
...
![结构设计图](/images/0300stringboot/0374springboot/blog.007.jpeg "结构设计图")
...
![C:/Users/Administrator/Desktop/temp111\6.1\img\成果评估.jpg](/images/0300stringboot/0374springboot/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\6.1\img\成果评估.jpg")

成果评估实体属性图

（2）下图是用户实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\6.1\img\用户.jpg](/images/0300stringboot/0374springboot/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\6.1\img\用户.jpg")

用户实体属性图

（3）下图是公告实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\6.1\img\公告.jpg](/images/0300stringboot/0374springboot/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\6.1\img\公告.jpg")

公告实体属性图

（4）下图是项目实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\6.1\img\项目.jpg](/images/0300stringboot/0374springboot/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\6.1\img\项目.jpg")

项目实体属性图

（5）下图是评审专家实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\6.1\img\评审专家.jpg](/images/0300stringboot/0374springboot/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\6.1\img\评审专家.jpg")
...
|3|pingshenzhuanjia\_id|Integer|评审专家|是|
|4|insert\_time|Date|录入时间|是|
|5|chengguopinggu\_content|String|评估意见|是|
|6|pinggu\_defen|BigDecimal|评估得分|是|
|7|chengguopinggu\_types|Integer|评估结果|是|
|8|update\_time|Date|评估时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|pingshenzhuanjia\_name|String|评审专家姓名|是|
|3|pingshenzhuanjia\_phone|String|评审专家手机号|是|
|4|pingshenzhuanjia\_id\_number|String|评审专家身份证号|是|
|5|pingshenzhuanjia\_photo|String|评审专家头像|是|
|6|pingshenzhuanjia\_email|String|电子邮箱|是|
|7|yanjiufangxiang\_types|Integer|研究方向|是|
|8|pingshenzhuanjia\_content|String|专家介绍|是|
|9|create\_time|Date|创建时间|是|
表4.5项目表
...
|5|laiyuan\_types|Integer|课题来源|是|
|6|xiangmu\_types|Integer|项目类型|是|
|7|kaishi\_time|Date|项目开始时间|是|
|8|jieshu\_time|Date|项目结束时间|是|
|9|huafei\_jine|BigDecimal|项目花费|是|
|10|yanjiufangxiang\_types|Integer|所属方向|是|
|11|yanjiufangxiang\_file|String|附件|是|
|12|xiangmu\_content|String|项目内容|是|
|13|xiangmu\_chengguo\_content|String|项目成果|是|
|14|insert\_time|Date|申请时间|是|
|15|xiangmu\_yesno\_types|Integer|申请状态|是|
|16|xiangmu\_yesno\_text|String|审核意见|是|
|17|xiangmu\_shenhe\_time|Date|审核时间|是|
