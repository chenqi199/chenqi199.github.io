...
# [0250springboot基于springboot-vue的毕业论文管理系统](https://github.com/GraduationProject-springboot/0250springboot)
...
[4.3 数据库设计 13](#__RefHeading___Toc3380)

[4.3.1 数据库E-R图设计 13](#__RefHeading___Toc16811)

[4.3.2 数据库表结构设计 14](#__RefHeading___Toc19796)

[5 系统实现 17](#系统实现)

[5.1用户信息管理 17](#用户信息管理)

[5.2 指导教师管理 17](#指导教师管理)

[5.3课题类型管理 18](#课题类型管理)

[5.1公告信息管理 19](#公告信息管理)

[6 系统测试 19](#__RefHeading___Toc24966)
...
[6.2.2 添加类别功能测试 20](#添加类别功能测试)

[6.3 测试结果分析 21](#测试结果分析)

[结 论 22](#结-论)

[致 谢 23](#__RefHeading___Toc27421)
...
[]{#__RefHeading___Toc19796 .anchor}**4.3 数据库设计**
...
表4.1毕业论文表
  ...
  ------ ------------------------- -------------------- ------------------- --------
   序号            列名                  数据类型              说明          允许空
    ...
    2       zhonggaoshenhe_name           String               标题            是

    3       zhonggaoshenhe_file           String             论文文件          是

    4            yonghu_id               Integer               用户            是

    5     biyeluenwen_yesno_types        Integer             打分状态          是

    6         biyeluenwen_num            Integer            现阶段分数         是

    7     biyeluenwen_yesno_text          String               评语            是
...
表4.3课题信息表
  ...
  ------ ------------------ -------------------- ------------------- --------
   序号         列名              数据类型              说明          允许空
    ...
    2        keti_name             String             课题名称          是

    3        keti_types           Integer             课题类型          是

    4        keti_text             String             课题内容          是

    5     zhidaojiaoshi_id        Integer               教师            是

    6     keti_yesno_types        Integer             审核状态          是

    7     keti_yesno_text          String             审核结果          是
...
表4.4课题任务表
  ...
  ------ ----------------------- -------------------- ------------------- --------
   序号           列名                 数据类型              说明          允许空
    ...
    2       zhidaojiaoshi_id           Integer               教师            是

    3       xuantishenqing_id          Integer             选题申请          是

    4        ketirenwu_name             String             课题任务          是

    5        ketirenwu_types           Integer             任务类型          是

    6        ketirenwu_file             String             参考文献          是

    7     ketirenwu_huida_file          String             阶段文档          是

    8     ketirenwu_yesno_types        Integer             审核结果          是

    9     ketirenwu_yesno_text          String             教师打分          是
...
表4.6评阅教师表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    2     pingyuejiaoshi_name          String           评阅教师姓名        是

    3     pingyuejiaoshi_photo         String               头像            是

    4     pingyuejiaoshi_phone         String             联系方式          是

    5     pingyuejiaoshi_email         String               邮箱            是
...
表4.7选题申请表
  ...
  ------ ---------------------------- -------------------- ------------------- --------
   序号              列名                   数据类型              说明          允许空
    ...
    2     xuantishenqing_uuid_number         String             课题编号          是

    3             yonghu_id                 Integer               学生            是

    4              keti_id                  Integer               课题            是

    5     xuantishenqing_yesno_types        Integer             申请状态          是

    6     xuantishenqing_yesno_text          String             申请结果          是
...
表4.9指导教师表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2     zhidaojiaoshi_name          String           指导教师姓名        是

    3     zhidaojiaoshi_photo         String               头像            是

    4     zhidaojiaoshi_phone         String             联系方式          是

    5     zhidaojiaoshi_email         String               邮箱            是
...
[]{#__RefHeading___Toc24966 .anchor}
...
毕业论文管理系统需要管理员添加类别信息，类别名称是程序设置的必填数据，而且添加的类别名称也不能够是数据库里面的存在的数据。对添加类别功能测试时，测试数据在下表展示。
...
第一点，可以确定开发出来的毕业论文管理系统是符合同类型系统的要求；

第二点，用户要求毕业论文管理系统需要具备的功能都已开发完成并能够正常使用；

第三点，毕业论文管理系统界面简洁美观，操作流程清晰明了；

第四点，毕业论文管理系统的安全性，以及运行性能符合开发要求。

至此，毕业论文管理系统可以确保所有功能能够按照预期目标进行运行，可以正式投入生活中运行使用！

# 结 论

通过对毕业论文管理系统的开发，让我深刻明白开发一个程序软件需要经历的流程，当确定要开发一个毕业论文管理系统的程序时，我在开发期间，对其功能进行合理的需求分析，然后才是程序软件的功能的框架设计，数据库的实体与数据表设计，程序软件的功能详细界面实现，以及程序的功能测试等进行全方位的细致考虑，虽然在此过程中，各个环节都遇到了大大小小的困难，但是通过对这些问题进行反复的分析，深入的思考，借助各种相关文献资料提供的方法与解决思路成功解决面临的各个问题，最后成功的让我开发的毕业论文管理系统得以正常运行。

毕业论文管理系统在功能上面是基本可以满足用户对系统的操作，但是这个程序软件也有许多方面是不足的，因此，在下一个时间阶段，有几点需要改进的地方需要提出来，它们分别是：

（1）操作页面可以满足用户简易操作的要求，但是在页面多样化设计层面上需要把一些比较丰富的设计结构考虑进来。

（2）程序软件的总体安全性能需要优化，例如程序的退出安全性，以及程序的并发性等问题都需要进行安全性升级，让开发的毕业论文管理系统与现实中的相关网站更贴合。

（3）需要对程序的数据结构方面，程序的代码方面等进行优化，让运行起来的程序可以保持稳定运行，也让程序能够保证短时间内处理相关事务，节省处理事务的时间，提高事务处理的效率，同时对服务器上资源占用的比例进行降低。

毕业论文管理系统的开发一方面是对自身专业知识技能进行最终考核，另一方面也是让自己学会独立解决程序开发过程中所遇到的问题，掌握将理论知识运用于程序开发实践的方法。毕业论文管理系统的开发最终目标就是让系统更具人性化，同时在逻辑设计上，让系统能够更加的严谨。

[]{#__RefHeading___Toc27421
...
\[1\]宁昭铱,陈静,张立斌.一个毕业论文管理系统平台的设计\[J\].科技经济导刊,2017(01):32+25.

\[2\]李鑫.浅谈信息化毕业论文管理系统的设计与实现\[J\].民营科技,2016(11):74.
...
### 0250springboot基于springboot-vue的毕业论文管理系统 项目图片
