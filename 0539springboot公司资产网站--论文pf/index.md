...
# [0539springboot公司资产网站--论文pf](https://github.com/GraduationProject-springboot/0539springboot)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://player.bilibili.com/player.html?isOutside=true&aid=BV1eMbYemE1U&bvid=BV1eMbYemE1U&cid=500001617128545&p=40)
...
![](media/image6.jpeg){width="6.29375in" height="3.3125in"}
...
表4.4资产表
  ...
  ------ --------------------- -------------------- ------------------- --------
   序号          列名                数据类型              说明          允许空
    ...
    2     zichan_uuid_number          String             资产编号          是

    3         zichan_name             String             资产名称          是

    4        zichan_photo             String             资产照片          是

    5        zichan_danwei            String               单位            是

    6        zichan_types            Integer             资产类型          是

    7     zichan_kucun_number        Integer             资产数量          是

    8        zichan_yuzhi            Integer               阈值            是

    9       zichan_content            String             资产介绍          是
...
表4.5资产报废表
  ...
  ------ ---------------------------- -------------------- ------------------- --------
   序号              列名                   数据类型              说明          允许空
    ...
    3             zichan_id                 Integer               资产            是

    4     zichan_baofei_uuid_number          String           资产报废编号        是

    5        zichan_baofei_types            Integer           资产报废类型        是

    6     zichan_baofei_kucun_number        Integer           资产报废数量        是

    7       zichan_baofei_content            String             报废缘由          是

    8            insert_time                  Date              报废时间          是
...
表4.6资产申请表
  ...
  ------ ------------------------------ -------------------- ------------------- --------
   序号               列名                    数据类型              说明          允许空
    ...
    4     zichan_shenqing_uuid_number          String           资产申请编号        是

    5        zichan_shenqing_types            Integer           资产申请类型        是

    6     zichan_shenqing_kucun_number        Integer           资产申请数量        是

    7       zichan_shenqing_content            String             申请缘由          是

    8             insert_time                   Date              申请时间          是

    9     zichan_shenqing_yesno_types         Integer             申请状态          是

    10     zichan_shenqing_yesno_text          String             审核意见          是

    11    zichan_shenqing_shenhe_time           Date              审核时间          是
...
表4.7资料库表
  ...
  ------ ---------------------- -------------------- ------------------- --------
   序号           列名                数据类型              说明          允许空
    ...
    4        ziliaoku_types           Integer             资料类型          是

    5        ziliaoku_file             String             资料文件          是

    6       ziliaoku_content           String             资料介绍          是
...
公司资产网站在经历了一系列测试步骤之后，可以确定该系统可以交付给使用者进行使用了，在系统的功能主界面上可以清晰展示各个功能，并且各个功能的超链接也是正常跳转，能够实现用户要求的功能。在程序的稳定性，可靠性，验证逻辑以及操作流程方面跟需求文档很贴合。所以，开发完成的公司资产网站符合用户需求，它在用户电脑上运行使用带给用户的便利是显而易见的。

# 结 论

公司资产网站的开发制作，从题目确定到成品完成，自己投入的精力与心血是非常多的。从公司资产网站的前台页面实现，到公司资产网站的后台代码的编辑，我用到的软件包括了数据库软件Mysql，Java开发工具IDEA，办公软件Office，浏览器软件Fireworks，图像处理软件Photoshop等，这也是我第一次使用Java语言，开发的这个比较简单的公司资产网站。

公司资产网站开发过程中，自己之前觉得比较抽象的许多门课程，例如数据库原理，软件工程，动态网站开发等课程开始变得很清晰，只有自己独立开发程序，才会觉得这些开发类的课程在实践中具有的重要作用。为了让自己设计的作品能够顺利的完成，我把所学知识全部运用在程序的开发流程中，包括了程序的需求分析环节，程序的编码环节，程序的测试环节等，让程序软件在开发周期内完成制作，并能够保证程序质量达标，力求程序开发流程规范化，程序对应的配套文档标准化。
...
公司资产网站现已完成了开发，除了基本功能可以符合用户需求外，在页面设计层面上没有融入更多的设计元素，需要从美学角度进行优化，另外在程序的代码层面，也有许多重合部分，需要进行整理归类，让代码变得更加的简洁。
...
### 0539springboot公司资产网站--论文pf 项目图片
![图片](/images/0539springbootimg_001.jpg)
![图片](/images/0539springbootimg_003.jpg)
![图片](/images/0539springbootimg_002.jpg)
![图片](/images/0539springbootimg_006.jpg)
![图片](/images/0539springbootimg_007.jpg)
![图片](/images/0539springbootimg_005.jpg)
![图片](/images/0539springbootimg_004.jpg)
![图片](/images/0539springbootimg_008.jpg)
