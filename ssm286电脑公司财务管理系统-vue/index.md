...
# [ssm286电脑公司财务管理系统+vue](https://github.com/GraduationProject-springboot/)
...
## 3.4系统流程和逻辑
![](/images/0200ssm/ssm286/blog.001.png)

图3-3登录流程图

![](/images/0200ssm/ssm286/blog.002.png)
...
![](/images/0200ssm/ssm286/blog.003.png)

图4-1系统工作原理图
## 4.2系统结构
本系统是基于B/S架构的网站系统，设计的功能结构图如下图所示：

![](/images/0200ssm/ssm286/blog.004.png)
...
![](/images/0200ssm/ssm286/blog.005.png)

图4.12  发票信息实体属性图

（2）供应商实体属性图如图4.13所示：

![](/images/0200ssm/ssm286/blog.006.png)

图4.13 供应商实体属性图

（3）部门分类实体属性图如图4.14所示：

![](/images/0200ssm/ssm286/blog.007.png)
...
![](/images/0200ssm/ssm286/blog.008.png)

图5.1 员工信息管理界面
### 5.1.2 部门分类管理
系统管理员可以管理部门分类信息，可以对部门分类信息进行添加，修改，删除查询操作，具体界面如图5.2所示。

![](/images/0200ssm/ssm286/blog.009.png)图5.3 部门信息管理界面
### 5.1.3 记账凭证管理
系统管理员可以管理记账凭证品信息，对记账凭证信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm286/blog.010.png)
...
![](/images/0200ssm/ssm286/blog.011.png)

图5.5 员工薪酬界面
### 5.2.2 商品库存
员工登录后可以对商品库存进行添加修改删除操作。界面如下图所示：

![](/images/0200ssm/ssm286/blog.012.png)
...
![](/images/0200ssm/ssm286/blog.013.png)
...
![](/images/0200ssm/ssm286/blog.014.png)

图5.8 日记账界面
### 5.3.3 发票信息
员工管理登录后可以对发票信息进行添加，修改，删除操作。界面如下图所示：

![](/images/0200ssm/ssm286/blog.015.png)
