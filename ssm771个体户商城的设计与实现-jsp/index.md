...
# [ssm771个体户商城的设计与实现+jsp](https://github.com/GraduationProject-springboot/)
...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=166)
...
航空售票以前都是电话订票，但是随着互联网发展，越来越多的人坐得起飞机了，当大量的人们都通过电话进行购买航空机票的时候就带来了很大的不便，随着使用互联网的人越来越多，新生代都开始喜欢什么都在网上购买，让新生代能通过互联网进行购买机票，也是解决购买机票问题的一大途径。个体户商城的开发更好地帮助人们，个体户商城有利于提升人们的效率，让人们更加的方便更加的多样化。
## 1.2设计目标
...
在本次毕业设计中，使用了JSP技术，SSM框架，MYSQL数据库进行系统的开发。构建了一个个体户商城软件。

无论哪个系统都应该有自己的设计目标。该个体户商城软件也具有重要的设计目标有如下几个：
...
## 1.3 设计原则
一个成功的网站应明确建设网站的目的，确定网站的具体功能，确定网站规模、投入费用，进行必要的市场分析等。只有经过详细的策划，才能避免在网站建设中出现的很多问题，使网站建设能够顺利进行。同时，一个大型的计算机网站系统，必须有一个正确的设计思想，并且通过合理的选择数据结构、网络结构、操作系统以及系统的开发环境，逐步构成一个完善的网络结构系统，只有这样才能充分使得计算机数据管理的优势发挥到最大。根据现实生活中扶贫的需求，该个体户商城软件的开发按照以下原则进行。
...
4、先进性：采用目前国际上最先进的数据库技术，使用JSP作为开发工具，MVC模式，MYSQL作为网站的数据库。本系统采用的这些技术完全基于微软平台进行开发，从来有效的降低了系统的运营成本，大大提高了该个体户商城软件的稳定性和易维护性。
...
1. # 系统的需求分析
需求分析的任务是通过详细调查个体户商城软件所需的对象，充分了解系统的工作概况，明确功能实现的各种需求，然后在此基础上确定系统的功能。系统必须充分考虑今后可能的扩充和改变。
## 3.1可行性分析
通过对系统实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1 技术可行性
1.硬件可行性分析

个体户商城系统的硬件要求方面不存在特殊的要求，只需要在普通的硬件配置就能够轻松的实现，只是需要确保系统的正常工作即可，以及拥有较高的效率。如果有特别低的硬件，它可以导致系统的低性能以及效率低，从而导致整个网站的运行不顺畅。以目前普遍的个人计算机的配置而言，这是十分容易实现的 。因此，本系统的开发在硬件方面是可行的。
...
存储个体户商城的数据，需要确保数据的安全性，在网站设计时必须要采取安全防范措施，以解决潜在的安全问题。
...
由于这个个体户商城主要针对新闻、公告等，设计出的系统必须能够处理接受变化的能力。
## 3.3流程分析
### 3.3.1 系统开发流程
个体户商城开发中时，首先进行需求分析，进而对系统进行总体的设计规划，设计系统功能模块，数据库的选择等，本系统的开发流程如图3-1所示

![](/images/0700ssm/ssm771/blog.001.png)
...
![](/images/0700ssm/ssm771/blog.002.png)

图3-2系统登录流程图
## 3.4系统设计规则与运行环境
无论哪个系统都应该有自己的设计规则。该系统也具有重要的设计标准有如下几个：

1.简单：在保证个体户商城能够成功实现的前提下，并尽量使个体户商城更容易操作，对于一个平台，这是非常重要的。
...
1. # 系统的概要设计
## 4.1 系统结构设计
个体户商城主要分为管理员和用户两个主要用户角色，本网站采用B/S结构(Browser/Server,浏览器/服务器结构)和基于Web服务两种模式，是一个适用于Internet环境下的模型结构。只要用户能连上Internet,便可以在任何时间、任何地点使用。系统结构图如图4-1所示：
...
![](/images/0700ssm/ssm771/blog.003.png)
...
![](/images/0700ssm/ssm771/blog.004.png)    

图4-2 系统框架图
### 4.2.2系统网络拓扑结构图
本个体户商城采用先进的B/S架构，该架构具有开发简单、共享性强、维护简单方便等诸多优点。本系统的网络拓扑图如图4-3所示：

![](/images/0700ssm/ssm771/blog.005.png)
...
![C:\Users\Administrator\Desktop\img\getihushangcheng\用户.jpg](/images/0700ssm/ssm771/blog.006.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\用户.jpg")
图4.1 用户实体属性图

（2）下图是商品信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\商品信息.jpg](/images/0700ssm/ssm771/blog.007.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\商品信息.jpg")
图4.2 商品信息实体属性图

（3）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\字典表.jpg](/images/0700ssm/ssm771/blog.008.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\字典表.jpg")
图4.3 字典表实体属性图

（4）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\购物车.jpg](/images/0700ssm/ssm771/blog.009.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\购物车.jpg")
图4.4 购物车实体属性图

（5）下图是积分记录实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\积分记录.jpg](/images/0700ssm/ssm771/blog.010.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\积分记录.jpg")
图4.5 积分记录实体属性图

（6）下图是新闻信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\新闻信息.jpg](/images/0700ssm/ssm771/blog.011.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\新闻信息.jpg")
图4.6 新闻信息实体属性图

（7）下图是客服聊天实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\客服聊天.jpg](/images/0700ssm/ssm771/blog.012.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\客服聊天.jpg")
图4.7 客服聊天实体属性图

（8）下图是商品收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\商品收藏.jpg](/images/0700ssm/ssm771/blog.013.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\商品收藏.jpg")
图4.8 商品收藏实体属性图

（9）下图是商品评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\商品评价.jpg](/images/0700ssm/ssm771/blog.014.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\商品评价.jpg")
图4.9 商品评价实体属性图

（10）下图是商品订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\商品订单.jpg](/images/0700ssm/ssm771/blog.015.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\商品订单.jpg")
图4.10 商品订单实体属性图

（11）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\用户表.jpg](/images/0700ssm/ssm771/blog.016.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\用户表.jpg")
图4.11 用户表实体属性图

（12）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\getihushangcheng\收货地址.jpg](/images/0700ssm/ssm771/blog.017.jpeg "C:\Users\Administrator\Desktop\img\getihushangcheng\收货地址.jpg")
图4.12 收货地址实体属性图
### 4.3.4 数据库表
...
|4|shangpin\_kucun\_number|Integer|商品库存|是|
...
|2|shangpin\_id|Integer|商品|是|
|3|yonghu\_id|Integer|用户|是|
|4|shangpin\_commentback\_content|String|评价内容|是|
|5|reply\_content|String|回复内容|是|
...
|9|shouhuo\_types|Integer|收货方式|是|
...
|6|yonghu\_sum\_jifen|BigDecimal|总积分|是|
|7|yonghu\_new\_jifen|BigDecimal|现积分|是|
...
![](/images/0700ssm/ssm771/blog.018.png)

图5.1 用户信息管理页面
### 5.2 商品信息管理
如图5.2显示的就是商品信息管理页面，此页面提供给管理员的功能有：查看已发布的商品信息数据，修改商品信息，商品信息作废，即可删除。

![](/images/0700ssm/ssm771/blog.019.png)

![](/images/0700ssm/ssm771/blog.020.png)

图5.2 商品信息管理页面
### 5.3商品类型管理
如图5.3显示的就是商品类型管理页面，此页面提供给管理员的功能有：根据商品类型进行条件查询，还可以对商品类型进行新增、修改、查询操作等等。

![](/images/0700ssm/ssm771/blog.021.png)
...
![](/images/0700ssm/ssm771/blog.022.png)
