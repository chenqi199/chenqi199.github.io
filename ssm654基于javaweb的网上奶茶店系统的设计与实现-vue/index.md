...
# [ssm654基于Javaweb的网上奶茶店系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0600ssm/ssm654/blog.001.png)
...
![](/images/0600ssm/ssm654/blog.008.png)

图4.4 奶茶实体属性图

（2）管理员包括的属性有密码，角色，用户名等。其属性图如下。

![](/images/0600ssm/ssm654/blog.009.png)

图4.5 管理员实体属性图

（3）奶茶订单包括的属性有收货地址，支付类型，实付价格等。其属性图如下。

![](/images/0600ssm/ssm654/blog.010.png)

图4.6 奶茶订单实体属性图

（4）用户包括的属性有用户姓名，总积分，会员等级等。其属性图如下。

![](/images/0600ssm/ssm654/blog.011.png)

图4.7 用户实体属性图

（5）设计的各实体间关系E-R图如下。

![](/images/0600ssm/ssm654/blog.012.png)
...
![](/images/0600ssm/ssm654/blog.014.png)
...
![](/images/0600ssm/ssm654/blog.015.png)
