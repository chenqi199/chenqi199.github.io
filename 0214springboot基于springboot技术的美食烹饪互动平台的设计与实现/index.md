...
|meishi\_uuid\_number|美食编号 |varchar(200)|是|
|meishi\_name|美食名称 |varchar(200)|是|
|meishi\_photo|美食照片|varchar(200)|是|
|meishi\_video|美食做法|varchar(200)|是|
|zan\_number|赞|int(11)|是|
|cai\_number|踩|int(11)|是|
|meishi\_types|美食类型 |int(11)|是|
|meishi\_clicknum|游览量|int(11)|是|
|meishi\_shicai\_text|相关食材|text|是|
|meishi\_content|美食详情|text|是|
|shangxia\_types|是否上架|int(11)|是|
|meishi\_delete|逻辑删除|int(11)|是|
|create\_time|创建时间 |timestamp|是|
表4.3 美食知识表
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|meishizhishi\_name|美食知识名称 |varchar(200)|是|
|meishizhishi\_photo|美食知识图片|varchar(200)|是|
|meishizhishi\_types|美食知识类型 |int(11)|否|
|insert\_time|美食知识发布时间|timestamp|是|
|meishizhishi\_content|美食知识详情|text|是|
|create\_time|创建时间 |timestamp|是|
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|meishi\_id|美食|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|meishi\_collection\_types|类型|int(11)|是|
...
|meishi\_id|美食|int(11)|是|
|yonghu\_id|用户|int(11)|是|
|meishi\_liuyan\_text|留言内容|text|是|
