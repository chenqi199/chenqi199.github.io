...
# [ssm411基于SSM的个人事务管理系统的设计和实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0400ssm/ssm411/blog.001.png)
...
![](/images/0400ssm/ssm411/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0400ssm/ssm411/blog.006.png)
...
![](/images/0400ssm/ssm411/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是用户实体E-R图

![](/images/0400ssm/ssm411/blog.008.png)

图4.8 用户实体E-R图

（3）下图就是系统帮助信息实体E-R图

![](/images/0400ssm/ssm411/blog.009.png)
...
![](/images/0400ssm/ssm411/blog.011.png)

图5.1 用户信息管理页面
## 5.2 通讯录管理
管理员可以对通讯录信息进行删除，查询和修改操作。下图就是通讯录信息管理页面。

![](/images/0400ssm/ssm411/blog.012.png)

图5.2通讯录信息管理页面
## 5.3 财务信息管理
管理员可以对财务信息进行查询，修改，删除操作。下图就是财务信息管理页面。

![](/images/0400ssm/ssm411/blog.013.png)

图5.3 财务信息管理页面
## 5.4 个人事务管理
管理员可以对用户的个人事务进行查询，修改，删除操作。下图就是个人事务管理页面。

![](/images/0400ssm/ssm411/blog.014.png)
