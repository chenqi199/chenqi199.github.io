...
# [ssm379基于java的供电公司安全生产考试系统的设计与实现+vue](https://github.com/GraduationProject-springboot/)
...
![](/images/0300ssm/ssm379/blog.001.png)
...
![](/images/0300ssm/ssm379/blog.005.png)

图4.1 程序工作的原理图
## 4.2系统功能结构设计
下图就是系统功能结构图。

![](/images/0300ssm/ssm379/blog.006.png)
...
![](/images/0300ssm/ssm379/blog.007.png)

图4.7 管理员实体E-R图

（2）下图就是试卷实体E-R图

![](/images/0300ssm/ssm379/blog.008.png)

图4.8 试卷实体E-R图

（3）下图就是学生信息实体E-R图

![](/images/0300ssm/ssm379/blog.009.png)
...
![](/images/0300ssm/ssm379/blog.011.png)

图5.1 教师信息管理页面
## 5.2 学生信息管理
管理员可以对学生信息进行查询和修改操作。下图就是学生信息管理页面。

![](/images/0300ssm/ssm379/blog.012.png)

图5.2学生信息管理页面
## 5.3 主观题管理
教师可以对主观题进行进行添加，修改，删除操作。下图就是主观题信息管理页面。

![](/images/0300ssm/ssm379/blog.013.png)

图5.3 主观题信息管理页面
## 5.4试题信息管理
教师可以管理试题信息，可以添加，修改，删除试题信息信息。下图就是试题信息管理页面。

![](/images/0300ssm/ssm379/blog.014.png)

图5.4 试题信息管理页面
## 5.5主观题答题
学生可以在主观题信息里进行答题。下图就是主观题信息管理页面。

![](/images/0300ssm/ssm379/blog.015.png)

图5.5 主观题信息管理页面
## 5.6成绩信息统计
教师可以对学生的成绩信息进行统计。下图就是成绩信息管理页面。

![](/images/0300ssm/ssm379/blog.016.png)
